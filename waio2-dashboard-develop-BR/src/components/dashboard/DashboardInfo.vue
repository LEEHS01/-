  ...
  <div class="dashboard-info-container">
    ...
    <div class="top-contents">
      ...
      <div class="left-contents">
        ...
        <!-- 오존 AI 모드 제어 -->
        <!--
          2023.08.14. 보령 정수장 오존 없음으로 인한 주석 처리
        ...
        <!-- GAC여과 AI 모드 제어 -->
        <!--
          2023.08.14 보령 정수장 GAC여과 없음으로 인한 주석 처리
        ...
        <div class="btn-contents" :class="{selected: this.$store.state.selectedBuildingIndex === 7}">
          ...
          <div class="btn-contents__btn">
            <div class="control_box_operation control_box_operation--disinfection">
              ...
              <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7, 1, 'pre')">AI추천</div>
            ...
            <div class="control_box_operation control_box_operation--disinfection">
              <div v-if="$store.state.midDisinfection.latest.peri_ai_opr === 2" class="control_box_operation__btn control_box_operation__btn--on">AI</div>
              <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(8, 2, 'peri')">AI</div>
              <div v-if="$store.state.midDisinfection.latest.peri_ai_opr === 1" class="control_box_operation__btn control_box_operation__btn--on">AI추천</div>
              <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(8, 1, 'peri')">AI추천</div>
              <div v-if="$store.state.midDisinfection.latest.peri_ai_opr === 0" class="control_box_operation__btn control_box_operation__btn--on">AI분석</div>
              <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(8, 0, 'peri')">AI분석</div>
            </div>
            <div class="control_box_operation control_box_operation--disinfection">
              <div v-if="$store.state.postDisinfection.latest.post_ai_opr === 2" class="control_box_operation__btn control_box_operation__btn--on">AI</div>
              <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(9, 2, 'post')">AI</div>
              <div v-if="$store.state.postDisinfection.latest.post_ai_opr === 1" class="control_box_operation__btn control_box_operation__btn--on">AI추천</div>
              <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(9, 1, 'post')">AI추천</div>
              <div v-if="$store.state.postDisinfection.latest.post_ai_opr === 0" class="control_box_operation__btn control_box_operation__btn--on">AI분석</div>
              <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(9, 0, 'post')">AI분석</div>
            </div>
          </div>
        </div>
      </div>
      <!-- 착수 예측 결과 -->
      <Result1 v-if="this.$store.state.selectedBuildingIndex === 0 || this.$store.state.selectedBuildingIndex === 1" :isAiOn="this.$store.state.receiving.latest.ai_opr"/>
      <!-- 약품 예측 결과 -->
      <Result2 v-if="this.$store.state.selectedBuildingIndex === 2" :isAiOn="this.$store.state.coagulants.latest.ai_opr"/>
      <!-- 혼화응집 예측 결과 -->
      <Result3 v-if="this.$store.state.selectedBuildingIndex === 3" :isAiOn="this.$store.state.mixing.latest.ai_opr"/>
      <!-- 침전 예측 결과 -->
      <Result4 v-if="this.$store.state.selectedBuildingIndex === 4" :isAiOn="this.$store.state.sedimentation.latest.ai_opr"/>
      <!-- 여과 예측 결과 -->
      <Result5 v-if="this.$store.state.selectedBuildingIndex === 5" :isAiOn="this.$store.state.filter.latest.ai_opr"/>
      <!-- GAC여과 예측 결과 -->
      <Result6 v-if="this.$store.state.selectedBuildingIndex === 6" :isAiOn="this.$store.state.gac.latest.ai_opr"/>
      <!-- 소독 예측 결과 -->
      <Result7 v-if="this.$store.state.selectedBuildingIndex === 7 || this.$store.state.selectedBuildingIndex === 8 || this.$store.state.selectedBuildingIndex === 9"
       :isAiOn="this.$store.getters['disinfection/isAiOperationMode']"/>
      <!-- 오존 예측 결과 -->
      <Result11 v-if="this.$store.state.selectedBuildingIndex === 11" :isAiOn="this.$store.state.ozone.latest.ai_opr"/>
    </div>
        ...
        <div class="ems_content_container">
          ...
          <div v-if="this.selectedEmsIndex === 0">
            <div class="divider">
              <div class="dashboard-info-ems">
                <div class="dashboard-info-ems-title">
                  <div class="dashboard-info-ems-title__text">보령(정)</div>
              ...
              <div class="ems_contents_info">
                ...
                <div class="ems_contents__td" style="gap:35px">
                  ...
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h1_pm5 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h1_pm6 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                </div>
              </div>
              <!-- AI 분석 -->
              <div class="ems_contents_info">
                ...
                <div class="ems_contents__td" style="gap:35px">
                  ...
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h1_pm5 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h1_pm6 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                </div>
              </div>
            </div>
            <div class="divider" >
              <div class="dashboard-info-ems">
                <div class="dashboard-info-ems-title">
                  <div class="dashboard-info-ems-title__text">청양(가)</div>
                  <div class="btn-contents ems-toggle">
              ...
              <div class="ems_contents_info">
                ...
                <div class="ems_contents__td">
                  ...
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h2_pm3 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.h2_pm_sp3 | numFormat('0.00') }}Hz</span>
                  </div>
                </div>
              </div>
              <!-- AI 분석 -->
              <div class="ems_contents_info">
                ...
                <div class="ems_contents__td">
                  ...
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h2_pm3 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.ai_h2_pm_sp3 | numFormat('0.00') }}Hz</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="divider" >
              <div class="dashboard-info-ems">
                <div class="dashboard-info-ems-title">
                  <div class="dashboard-info-ems-title__text" style="width: 90px;">홍성(가) 서산</div>
                  <div class="btn-contents ems-toggle">
                    <input disabled type="checkbox" class="checkbox" :class="{ 'checked': this.$store.state.ems.latest.pump.h3_operation_mode === 1 }" style="cursor: unset;"/>
                  </div>
                </div>
              </div>
              <!-- 운영 현황 -->
              <div class="ems_contents_info">
                <div class="ems_contents_info__title">운영현황</div>
                <div class="ems_contents__td">
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h3_pm1 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.h3_pm_sp1 | numFormat('0.00') }}Hz</span>
                  </div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h3_pm2 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.h3_pm_sp1 | numFormat('0.00') }}Hz</span>
                  </div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h3_pm3 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h3_pm4 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                </div>
              </div>
              <!-- AI 분석 -->
              <div class="ems_contents_info">
                <div class="ems_contents_info__title">AI분석</div>
                <div class="ems_contents__td">
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h3_pm1 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.ai_h3_pm_sp1 | numFormat('0.00') }}Hz</span>
                  </div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h3_pm2 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.ai_h3_pm_sp2 | numFormat('0.00') }}Hz</span>
                  </div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h3_pm3 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h3_pm4 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                </div>
              </div>
            </div>              
            <div class="divider">
              <div class="dashboard-info-ems">
                <div class="dashboard-info-ems-title">
                  <div class="dashboard-info-ems-title__text" style="width: 90px;">홍성(가) 예산</div>
                  <div class="btn-contents ems-toggle">
                    <input disabled type="checkbox" class="checkbox" :class="{ 'checked': this.$store.state.ems.latest.pump.h4_operation_mode === 1 }" style="cursor: unset;"/>
                  </div>
                </div>
              </div>
              <!-- 운영 현황 -->
              <div class="ems_contents_info">
                <div class="ems_contents_info__title">운영현황</div>
                <div class="ems_contents__td">
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h4_pm1 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.h4_pm_sp1 | numFormat('0.00') }}Hz</span>
                  </div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h4_pm2 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h4_pm3 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h4_pm4 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                </div>
              </div>
              <!-- AI 분석 -->
              <div class="ems_contents_info">
                <div class="ems_contents_info__title">AI분석</div>
                <div class="ems_contents__td">
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h4_pm1 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.ai_h4_pm_sp1 | numFormat('0.00') }}Hz</span>
                  </div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h4_pm2 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h4_pm3 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h4_pm4 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                </div>
              </div>
            </div>   
            <div class="divider">
              <div class="dashboard-info-ems">
                <div class="dashboard-info-ems-title">
                  <div class="dashboard-info-ems-title__text" style="width: 90px;">서산(가) 당진</div>
                  <div class="btn-contents ems-toggle">
                    <input disabled type="checkbox" class="checkbox" :class="{ 'checked': this.$store.state.ems.latest.pump.h5_operation_mode === 1 }" style="cursor: unset;"/>
                  </div>
                </div>
              </div>
              <!-- 운영 현황 -->
              <div class="ems_contents_info">
                <div class="ems_contents_info__title">운영현황</div>
                <div class="ems_contents__td">
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h5_pm1 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.h5_pm_sp1 | numFormat('0.00') }}Hz</span>
                  </div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h5_pm2 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h5_pm3 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.h5_pm_sp3 | numFormat('0.00') }}Hz</span>
                  </div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h5_pm4 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                </div>
              </div>
              <!-- AI 분석 -->
              <div class="ems_contents_info">
                <div class="ems_contents_info__title">AI분석</div>
                <div class="ems_contents__td">
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h5_pm1 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.ai_h5_pm_sp1 | numFormat('0.00') }}Hz</span>
                  </div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h5_pm2 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h5_pm3 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.ai_h5_pm_sp3 | numFormat('0.00') }}Hz</span>
                  </div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h5_pm4 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                </div>
              </div>
            </div>                                                                    
            <div class="divider">
              <div class="dashboard-info-ems">
                <div class="dashboard-info-ems-title">
                  <div class="dashboard-info-ems-title__text" style="width: 90px;">서산(가) 태안</div>
                  <div class="btn-contents ems-toggle">
                    <input disabled type="checkbox" class="checkbox" :class="{ 'checked': this.$store.state.ems.latest.pump.h6_operation_mode === 1 }" style="cursor: unset;"/>
                  </div>
                </div>
              </div>
              <!-- 운영 현황 -->
              <div class="ems_contents_info">
                <div class="ems_contents_info__title">운영현황</div>
                <div class="ems_contents__td">
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h6_pm1 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.h6_pm_sp1 | numFormat('0.00') }}Hz</span>
                  </div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h6_pm2 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h6_pm3 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h6_pm4 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                </div>
              </div>
              <!-- AI 분석 -->
              <div class="ems_contents_info">
                <div class="ems_contents_info__title">AI분석</div>
                <div class="ems_contents__td">
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h6_pm1 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.ai_h6_pm_sp1 | numFormat('0.00') }}Hz</span>
                  </div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h6_pm2 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h6_pm3 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h6_pm4 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]"></div>
                </div>
              </div>
            </div>                                                                    
          </div>              
    ...
    <div class="dashboard_info_content_container">
      ...
      <div class="dashboard_info_content_header_container">
        ...
        <!-- 보령(정) #1, #2, #3, #4, #5, #6 탭 -->
        <div class="dashboard_info_content_tab">
          <div class="tab-pms-title">보령(정)</div>
          ...
          <div class="tab-pms" @click="$store.state.pms.selectedId = '06'" :class="{'selected_ems': this.$store.state.pms.selectedId === '06'}">#6</div>
        </div>
        <!-- 홍성(가) #1, #2, #3, #4 탭 -->
        <div class="dashboard_info_content_tab">
          <div class="tab-pms-title">홍성(가)</div>
          <div class="tab-pms" @click="$store.state.pms.selectedId = '07'" :class="{'selected_ems': this.$store.state.pms.selectedId === '07'}">#1</div>
          <div class="tab-pms" @click="$store.state.pms.selectedId = '08'" :class="{'selected_ems': this.$store.state.pms.selectedId === '08'}">#2</div>
          <div class="tab-pms" @click="$store.state.pms.selectedId = '09'" :class="{'selected_ems': this.$store.state.pms.selectedId === '09'}">#3</div>
          <div class="tab-pms" @click="$store.state.pms.selectedId = '10'" :class="{'selected_ems': this.$store.state.pms.selectedId === '10'}">#4</div>
        </div>
      </div>
      <!-- PMS Content -->
...
.ems_container {
  ...
  .ems_content_container {
    ...
    .divider::after {
      ...
      background-size: 100% 100%;
      margin-top: 15px;
      background-image: url('../../assets/dashboard_img/h-divider.png');
    }
    .divider:nth-of-type(6)::after {
      display: none;
    }
    // EMS Contents
    .ems_contents{
