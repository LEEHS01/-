<template>
  <div class="center-container">
    ...
    <div class="value-contents">
      <!-- <div class="value-contents__title">소수력 발전<br/> 바이패스 밸브 개도</div>
      <div class="box">
      ...
      <div class="box">
        <div class="box__value" v-html="this.$getNumeralWithCommaAndFontFamily(this.$store.state.receiving.latest.b_in_fr)"></div>
    ...
    <div class="img-contents">
      <div class="valve-box three-value-position">
        <div class="valve-box__text">원수 유출 유량</div>
        <div class="box">
    ...
    <div class="last-container">
        ...
        <div class="first-result-contents">
          <div class="result-value">
            <div class="result-text">
              ...
              <div class="result-text__value">{{ this.$store.state.receiving.latest.b_in_fr | numFormat('0,0') }}</div>
            ...
            <div class="result-text">
              <div class="result-text__text">· 가이드 베인 개도</div>
              <div class="result-text__value">{{ this.$store.state.receiving.latest.b1_gv_vv_po | numFormat('0.00') }}</div>
              <div class="result-text__unit">%</div>
            </div>
            <div class="result-text">
              <div class="result-text__text">· 바이패스 개도</div>
              <div class="result-text__value">{{ this.$store.state.receiving.latest.b1_vv_po | numFormat('0.00') }}</div>
              <div class="result-text__unit">%</div>
            </div>
          </div>
        </div>
      ...
      <div class="first">
        ...
        <div class="second-result-contents paddingtop">
          ...
          <div class="contents-title" style="margin-top: 90px;">
          </div>
          <div class="value-box">
            <div class="value-box__value" v-html="this.$getNumeralWithCommaAndFontFamily(this.$store.state.receiving.latest.ai_b_in_fr)"></div>
      ...
      <div class="first">
        ...
        <div class="last-result-contents paddingtop">
          <div class="top-title">AI 가이드 베인 밸브 개도</div>
          <div class="contents-title">
            <div class="real-box real-one">
              <div class="real-text">현재개도</div>
              <div class="real-value">{{ this.$store.state.receiving.latest.b1_gv_vv_po | numFormat('0.00') }}</div>
            </div>
          </div>
          <div class="value-box">
            <div class="value-box__value">{{ this.$store.state.receiving.latest.ai_b_vv_po_guidevane | numFormat('0') }}</div>
            <div class="value-box__unit marginleft">%</div>
          </div>
          <div class="value-bottom-img"></div>
          <div class="top-title">AI 바이패스 밸브 개도</div>
          <div class="contents-title">
          ...
          <div class="value-box">
            <div class="value-box__value">{{ this.$store.state.receiving.latest.ai_b_vv_po_bypass | numFormat('0') }}</div>
            <div class="value-box__unit marginleft">%</div>
          </div>
          <div class="value-bottom-img"></div>
        </div>
...
.center-container{
  ...
  .img-contents{
    width: 435px;
    height: 200px;
    background-image: url('../../assets/br_images/sub_01.png');
    // 1계열 수평 물 흐름
