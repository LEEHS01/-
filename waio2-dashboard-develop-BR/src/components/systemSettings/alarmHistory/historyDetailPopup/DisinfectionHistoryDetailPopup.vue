<template>
  <div v-if="this.$store.state.alarm.visible && this.$store.state.alarm.alarmsDetail.procCd == 'G'" class="popup-wrap">
        ...
        <div class="one-contents">
          ...
          <div class="big-contents">
            <div class="contents-value" v-if="this.$store.state.alarm.selectedDisinfectionIndex == 1">
              ...
              <div class="value-container">
                <div class="value-container__one">· 착수정 수온</div>
              ...
              <div class="value-container">
                ...
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.d1_cl | numFormat('0.00') }}</div>
                <div class="value-container__three">ppm</div>
              </div>
              <div class="value-container">
                <div class="value-container__one">· 침전지 잔류 염소</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.e1_cl | numFormat('0.00') }}</div>
                <div class="value-container__three">ppm</div>
              </div>
              <div class="value-container">
            ...
            <div class="contents-value" v-else-if="this.$store.state.alarm.selectedDisinfectionIndex == 2">
              ...
              <div class="value-container">
                <div class="value-container__one">· 여과지 유출 잔류 염소</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.g_f_out_residual_cl | numFormat('0.00') }}</div>
                <div class="value-container__three">ppm</div>
              </div>
              <div class="value-container">
                <div class="value-container__one">· 현재 주입률</div>
            ...
            <div class="contents-value" v-else-if="this.$store.state.alarm.selectedDisinfectionIndex == 3">
              <div class="value-container">
                ...
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.h_in_cl | numFormat('0.00') }}</div>
                <div class="value-container__three">ppm</div>
              </div>
              <div class="value-container">
                <div class="value-container__one">· 현재 주입률</div>
