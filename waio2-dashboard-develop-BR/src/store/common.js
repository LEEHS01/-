    ...
    Vue.prototype.$routingByIndex = function (index){
      switch (index) {
        ...
        case 7:
          ...
          break
        case 8:
          this.$store.state.midDisinfection.selectedDisinfectionIndex = 2
          this.$store.state.drawer.selectedMainMenuIndex = 2
          if(this.$route.path!=='/midDisinfectionAlgorithm') router.push('/midDisinfectionAlgorithm')
          break
        case 9:
          this.$store.state.postDisinfection.selectedDisinfectionIndex = 3
          this.$store.state.drawer.selectedMainMenuIndex = 2
