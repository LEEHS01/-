  ...
  <div class="main">
    <div class="top-contents">
      ...
      <div class="one-contents">
        <div class="one-contents__title">주요인자 2단계 중차염</div>
      ...
      <div class="three-contents">
        ...
        <div class="three-small-contents">
          ...
          <div class="real-box real-two">
            ...
            <div class="real-value">{{ this.$store.state.sndDisinfection.latest.g_peri_chol_rate | numFormat('0.00') }}</div>
          </div> 
    ...
    <div class="bottom-contents">
      <div class="contents">
        <div class="contents__title">생활차염 주입률 예측</div>
