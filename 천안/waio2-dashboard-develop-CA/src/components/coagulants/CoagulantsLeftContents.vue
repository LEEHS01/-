...
export default {
  computed: {
    selectedCoagulant: {
      get() {
        return this.$store.state.coagulants.latestModify.c2_cf_coagulant
      },
      set(value) {
        this.$store.state.coagulants.latestModify.c2_cf_coagulant = value
      }
    },
  ...
  methods: {
    updateControl: function() {
      let obj = {}
      obj.c2_cf_coagulant = this.$store.state.coagulants.latestModify.c2_cf_coagulant
