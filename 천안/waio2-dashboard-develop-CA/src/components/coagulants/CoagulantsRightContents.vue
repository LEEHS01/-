      ...
      <div class="two-contents">
        ...
        <div class="small-contents">
          ...
          <div class="real-box">
            ...
            <div class="real-value">{{ this.$store.state.coagulants.latest.c_cf | numFormat('0.00') }}</div>
          </div>
          <div class="small-contents-value">
            <div class="small-contents-value__title"><span>{{ getInjector }}</span> {{ this.$store.state.coagulants.latest.c2_cf_coagulant }}</div>
            <div class="value">
      ...
      <div class="three-contents">
        ...
        <div class="three-small-contents">
          <div class="three-small-contents-value">
            <div class="three-small-contents-value__title"><span>{{ getInjector }}</span> {{ this.$store.state.coagulants.latest.c2_cf_coagulant }}</div>
        ...
        <div class="three-small-contents">
          <div class="top-info">* 침전지 탁도 1NTU이하로 운영</div>
            <div class="real-box real-one">
              ...
              <div class="real-value">{{ getInjector == '1호기' ? this.$store.state.coagulants.latest.c1_cf : this.$store.state.coagulants.latest.c2_cf | numFormat('0.00') }}</div>
            </div>          
            <div class="three-small-contents-value">
            <div class="three-small-contents-value__title"><span>{{ getInjector }}</span> {{ this.$store.state.coagulants.latestModify.c2_cf_coagulant }}</div>
            <div class="three-value">          
              <div class="three-value__num">{{ this.$store.state.coagulants.latest.ai_c_cf | numFormat('0.00') }}</div>
              <div class="three-value__unit">ppm</div>
            </div>
