  ...
  <div class="main">
    <div class="top-contents">
      ...
      <div class="one-contents">
        <div class="one-contents__title">주요인자 3단계 중차염</div>
        <div class="big-contents">
          <div class="contents-value">
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.trdDisinfection.latest.g_peri_chol_rate | numFormat('0.00') }}</div>
      ...
      <div class="three-contents">
        ...
        <div class="three-small-contents">
          ...
          <div class="real-box real-two">
            ...
            <div class="real-value">{{ this.$store.state.trdDisinfection.latest.g_peri_chol_rate | numFormat('0.00') }}</div>
          </div> 
    ...
    <div class="bottom-contents">
      <div class="contents">
        <div class="contents__title">차염 주입률 예측</div>
...
export default {
  ...
  computed: {
    ...
    ChartOptionCholRate: function () {
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_중차염 주입률 예측'
      return chart
    },
...
.top-contents{
  ...
  .three-contents{
    ...
    .three-small-contents{
      ...
      height: 356px;
      margin-top: 10px;
      background-image: url('../../assets/ca_images/three_background.png');
      .three-small-contents-value{
        ...
        .three-contents-value-underbar{
          width: 100%;
          height: 36px;
          background-image: url('../../assets/ca_images/contents_value_underbar.png');
