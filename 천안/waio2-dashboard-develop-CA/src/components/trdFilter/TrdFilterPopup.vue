<template>
    <div v-if="this.$store.state.trdFilter.popup.visible" class="main">
      <div class="popup-main">
        <div class="popup-contents">
          ...
          <div class="information">
            ...
            <div class="top-title">여과 {{ this.$store.state.trdFilter.popup.numJi }}지</div>
            <div class="contents-value">
            <div class="contents-value__text">원수 유입 유량</div>
              <div class="contents-value__box">
                <div class="box-text width50" v-html="this.$getNumeralWithCommaAndFontFamily(this.$store.state.trdFilter.popup.location.b_in_fr)"></div>
                <div class="box-unit">m<sup>3</sup>/h</div>
              </div>
              <!-- <div class="contents-value__text">2계열 혼화지 유입 유량</div>
              <div class="contents-value__box">
                <div class="box-text width50" v-html="this.$getNumeralWithCommaAndFontFamily(this.$store.state.trdFilter.popup.location.d_ser_in_fr)"></div>
                <div class="box-unit">m<sup>3</sup>/h</div>
              </div> -->
            </div>
            <!-- 여과 공정 세부 이미지 -->
            <div class="contents-center">
              <div class="line two">
                <div class="line-value">
                  <div class="line-value__num two-value-color">{{ this.$store.getters['trdFilter/getAiLocationWaterLevelLater10Minutes'] }}</div>
              ...
              <div class="line three">
                <div class="line-value">
                  <div class="line-value__num three-value-color">{{ this.$store.state.trdFilter.popup.location.f_loc_le | numFormat('0.00') }}</div>
              ...
              <div class="box-value">
                ...
                <div class="box-value__box">
                  <div class="box-text width50" v-html="this.$getNumeralWithCommaAndFontFamily(this.$store.state.trdFilter.popup.location.f_out_fr)"></div>
                  <div class="box-unit">m<sup>3</sup>/h</div>
                </div>
              </div>
            </div>
            ...
            <div class="contents-right">
              <div class="contents-text-box">
                ...
                <div class="contents-text-box__value">{{ this.$store.getters['trdFilter/getPopupFilterStartTime'] }}</div>
                <div class="contents-text-box__unit"></div>
              </div>
              <div class="contents-text-box">
                <div class="contents-text-box__title">· 여과 종료 시점</div>
                <div class="contents-text-box__value">{{ this.$store.getters['trdFilter/getPopupFilterEndTime'] }}</div>
                <div class="contents-text-box__unit"></div>
              </div>
              <div class="contents-text-box">
                <div class="contents-text-box__title">· 역세 시작 시점</div>
                <div class="contents-text-box__value">{{ this.$store.getters['trdFilter/getPopupBWStartTime'] }}</div>
                <div class="contents-text-box__unit"></div>
              </div>
              <div class="contents-liner"></div>
              <div class="contents-text-box">
                <div class="contents-text-box__title">· 현재 수위</div>
                <div class="contents-text-box__value">{{ this.$store.state.trdFilter.popup.location.f_loc_le | numFormat('0.00') }}</div>
                <div class="contents-text-box__unit">m</div>
              </div>
              <div class="contents-text-box">
                <div class="contents-text-box__title">· 10분 후 수위</div>
                <div class="contents-text-box__value">{{ this.$store.getters['trdFilter/getAiLocationWaterLevelLater10Minutes'] }}</div>
                <div class="contents-text-box__unit">m</div>
              </div>
              <div class="contents-text-box">
                <div class="contents-text-box__title">· 24시간 후 수위</div>
                <div class="contents-text-box__value">{{ this.$store.getters['trdFilter/getAiLocationWaterLevelLater24Hours'] }}</div>
                <div class="contents-text-box__unit">m</div>
              </div>
              <div class="contents-liner"></div>
              <div class="contents-text-box">
                <div class="contents-text-box__title">· 탁도</div>
                <div class="contents-text-box__value">{{ this.$store.state.trdFilter.popup.location.f_loc_tb | numFormat('0.00') }}</div>
                <div class="contents-text-box__unit">NTU</div>
              </div>
              <div class="contents-text-box">
                <div class="contents-text-box__title">· 여과 지속시간(현재/예측)</div>
                <div class="contents-text-box__value">{{ this.$store.state.trdFilter.popup.location.f_loc_ti / 60 | numFormat('0') }} / {{ this.$store.state.trdFilter.popup.location.ai_f_loc_ti / 60 | numFormat('0') }}</div>
                <div class="contents-text-box__unit">시간</div>
              </div>
              <div class="contents-text-box">
                <div class="contents-text-box__title">· 역세 대기시간</div>
                <div class="contents-text-box__value">{{ this.$store.state.trdFilter.popup.location.ai_f_location_bw_wait_ti / 60 | numFormat('0') }}</div>
                <div class="contents-text-box__unit">시간</div>
              </div>
              <div class="contents-text-box">
                <div class="contents-text-box__title">· 여과 속도</div>
                <div class="contents-text-box__value">{{ this.$store.state.trdFilter.popup.location.f_sp | numFormat('0.00') }}</div>
                <div class="contents-text-box__unit">m/day</div>
              </div>
            </div>
          </div>
          <!-- 하단 차트 컨테이너 -->
          <div class="chart-container">
            <div class="chart-container__title">{{ this.$store.state.trdFilter.popup.numJi }}지 운영 예측</div>
...
<script>
import { CLOSE_POPUP } from '@/store/modules/trdFilter'
import { GET_FILTER_LOCATION_BY_JI } from '@/store/modules/trdFilter'
export default {
  name: 'TrdFilterPopup',
  data: () => ({
  ...
  computed: {
    ...
    ChartMeter: function () {
      ...
      if (this.$store.state.trdFilter.popup.location.ai_f_loc_le !== null && Object.keys(this.$store.state.trdFilter.popup.location.ai_f_loc_le).length > 0) {
        let dataSeries = []
        for (let key in this.$store.state.trdFilter.popup.location.ai_f_loc_le) {
          let value = this.$store.state.trdFilter.popup.location.ai_f_loc_le[key] > 4.0 ? 4.0 : this.$store.state.trdFilter.popup.location.ai_f_loc_le[key]
        ...
        chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_운영 예측 차트 ' + this.$store.state.trdFilter.popup.numJi + '지'
        return chart
      }
      return chart
    }
  ...
  methods: {
    ...
    closePopup: function () {
      ...
      this.$store.commit('trdFilter/' + CLOSE_POPUP)
    },
  ...
  watch: {
    // 팝업 열림/닫힘 값 변화 감지
    '$store.state.trdFilter.popup.visible': function (newVal) {
      if (newVal) {
        this.timer = setInterval( () => {
          Promise.all([
            this.$store.dispatch(GET_FILTER_LOCATION_BY_JI, { numJi: this.$store.state.trdFilter.popup.numJi }),
          ])
        }, 1000 * 60)
      }
    }
