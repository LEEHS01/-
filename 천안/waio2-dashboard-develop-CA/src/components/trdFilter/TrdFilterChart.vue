  ...
  <div class="main">
      ...
      <div class="box-container">
        ...
        <div class="box-contents">
          <div class="box-value">
            ...
            <div class="box-value__value">{{ this.$store.state.trdFilter.latest.b_in_fr | numFormat('0,0')}}</div>
            <div class="box-value__unit">m<sup>3</sup>/h</div>
          </div>
          <div class="box-value">
            <div class="box-value__text">· 침전수 탁도</div>
            <div class="box-value__value">{{ this.$store.state.trdFilter.latest.e1_tb_b | numFormat('0.00')}}</div>
            <div class="box-value__unit">NTU</div>
          </div>
          <div class="box-value">
            <div class="box-value__text">· 여과속도</div>
            <div class="box-value__value">{{ this.$store.state.trdFilter.latest.f_sp | numFormat('0.00')}}</div>
            <div class="box-value__unit">m/day</div>
          </div>
          <div class="box-value">
            <div class="box-value__text">· 여과 유출 유량</div>
            <div class="box-value__value">{{ this.$store.state.trdFilter.latest.f_out_fr | numFormat('0,0')}}</div>
            <div class="box-value__unit">m<sup>3</sup>/h</div>
          </div>
        </div>
      </div>
    ...
    <div class="bottom-two">
      ...
      <div class="bottom-box">
        ...
        <div class="bottom-box__title">운영지수 <span>{{ this.$store.state.trdFilter.latest.ai_f_num_fil }}</span> 지</div>
    ...
    <div class="bottom-chart">
      <div class="bottom-chart__title">
        ...
        <div class="bottom-chart__timerbox-outter">
          <div class="timerbox">
            {{ this.$store.state.trdFilter.latest.upd_ti | moment('YYYY-MM-DD HH:mm:ss') }}
          </div>
        </div>
      </div>
      <div class="chart-box">
        <div class="chart-box-top">
          <div class="chart-box-top__title" @click="$store.state.dialog.aiTrdFilterNGACSchedule.visible = true">AI 운영스케줄</div>
        ...
        <div class="chart-box__chart">
          <TrdAILocationChart :selectedLine="this.selectedLine"/>
        </div>
      </div>
    </div>
    <!-- 여과 세부 현황 팝업  -->
    <TrdFilterAndGACSchedulePopup/>
  </div>  
</template>
<script>
...
import TrdFilterAndGACSchedulePopup from '@/components/dialog/TrdFilterAndGACSchedulePopup'
import TrdAILocationChart from '@/components/trdFilter/chart/TrdAILocationChart'
...
export default {
  ...
  data: () => ({
    selectedLine: 1, // AI 운영 스케줄 차트의 페이지
  }),
}
</script>
