...
export const GET_TRDDISINFECTION_LATEST = 'trdDisinfection/latest/get'
export const PUT_DISINFECTION_HISTORY_EVAPORATION = 'trdDisinfection/history/evaporation/put'
export const PUT_DISINFECTION_HISTORY_CHOLRATE = 'trdDisinfection/history/cholrate/put'
export const PUT_TRDDISINFECTION_CONTROL_OPERATION_PRE = 'trdDisinfection/control/operation/pre/put'
export const PUT_TRDDISINFECTION_CONTROL_OPERATION_PERI = 'trdDisinfection/control/operation/peri/put'
export const PUT_TRDDISINFECTION_CONTROL_OPERATION_POST = 'trdDisinfection/control/operation/post/put'
export const PUT_DISINFECTION_CONTROL_PRE = 'trdDisinfection/control/pre/put'
export const PUT_DISINFECTION_CONTROL_PERI = 'trdDisinfection/control/peri/put'
export const PUT_DISINFECTION_CONTROL_POST = 'trdDisinfection/control/post/put'
const GET_LATEST = GET_TRDDISINFECTION_LATEST.substr(GET_TRDDISINFECTION_LATEST.indexOf('/') + 1)
...
const PUT_CONTROL_OPERATION_PRE = PUT_TRDDISINFECTION_CONTROL_OPERATION_PRE.substr(PUT_TRDDISINFECTION_CONTROL_OPERATION_PRE.indexOf('/') + 1)
const PUT_CONTROL_OPERATION_PERI = PUT_TRDDISINFECTION_CONTROL_OPERATION_PERI.substr(PUT_TRDDISINFECTION_CONTROL_OPERATION_PERI.indexOf('/') + 1)
const PUT_CONTROL_OPERATION_POST = PUT_TRDDISINFECTION_CONTROL_OPERATION_POST.substr(PUT_TRDDISINFECTION_CONTROL_OPERATION_POST.indexOf('/') + 1)
...
const PROCESS_STEP = 3  // 2단계공업/2단계생활/3단계
...
export default {
  ...
  actions: {
    ...
    [PUT_CONTROL_POST]: async function ({ commit }, { disinfectionStep, g_post_set_max, g_post_set_min, g_post_chg_limit_for_onetime, g_post_calib_cycle, g_h_in_obj_residual_cl, g_post_calib_num, g_h_in_residual_cl_holding }) { // eslint-disable-line no-unused-vars
      await axios.put(`${DEV_SERVER}/${URL.DISINFECTION_CONTROL_POST}/` + PROCESS_STEP + `/` + disinfectionStep, { g_post_set_max, g_post_set_min, g_post_chg_limit_for_onetime, g_post_calib_cycle, g_h_in_obj_residual_cl, g_post_calib_num, g_h_in_residual_cl_holding })
      .then(() => {
