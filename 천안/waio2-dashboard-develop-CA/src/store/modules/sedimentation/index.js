...
export default {
  ...
  getters: {
    ...
    isOpenInBalValve6: function (state) {
      if (state.latest.e_drawing_vv6_1 === 1 || state.latest.e_drawing_vv6_2 === 1 || state.latest.e_drawing_vv6_3 === 1 || state.latest.e_drawing_vv6_4 === 1 || state.latest.e_drawing_vv6_5 || state.latest.e_drawing_vv6_6) {
        return true
      } else {
        return false
      }
    ...
    isOpenInBalValve7: function (state) {
      if (state.latest.e_drawing_vv7_1 === 1 || state.latest.e_drawing_vv7_2 === 1 || state.latest.e_drawing_vv7_3 === 1 || state.latest.e_drawing_vv7_4 === 1 || state.latest.e_drawing_vv7_5 || state.latest.e_drawing_vv7_6) {
        return true
      } else {
        return false
      }
    ...
    isOpenInBalValve8: function (state) {
      if (state.latest.e_drawing_vv8_1 === 1 || state.latest.e_drawing_vv8_2 === 1 || state.latest.e_drawing_vv8_3 === 1 || state.latest.e_drawing_vv8_4 === 1 || state.latest.e_drawing_vv8_5 || state.latest.e_drawing_vv8_6) {
        return true
      } else {
        return false
      }
    ...
    isOperateJi6: function (state) {
      if (state.latest.e_operation_mode_6 === 1) {
        return true
      } else {
        return false
      }
    },
    isOperateJi7: function (state) {
      if (state.latest.e_operation_mode_7 === 1) {
        return true
      } else {
        return false
      }
    },
    isOperateJi8: function (state) {
      if (state.latest.e_operation_mode_8 === 1) {
        return true
      } else {
        return false
      }
  ...
  actions: {
    ...
    [PUT_HISTORY_CL]: async function ({ commit }, {disinfectionStep}) {
      ...
      // await axios.put(`${DEV_SERVER}/${URL.SEDIMENTATION_HISTORY_CL}/` + PROCESS_STEP + `/` + disinfectionStep, { 'start_time': new Date('2023-8-21 00:00:00.000').toISOString(), 'end_time': new Date('2023-8-21 23:59:10.000').toISOString() })
        .then(({ data }) => {
