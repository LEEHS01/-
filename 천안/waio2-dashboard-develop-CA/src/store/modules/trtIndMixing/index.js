...
export const GET_TRTINDMIXING_LATEST = 'trtIndMixing/latest/get'
export const PUT_MIXING_HISTORY_FC_SP = 'trtIndMixing/history/fc/sp/put'
export const PUT_TRTINDMIXING_CONTROL_OPERATION = 'trtIndMixing/control/operation/put'
export const PUT_MIXING_CONTROL_AI = 'trtIndMixing/control/ai/put'
export const PUT_MIXING_G_LIMIT_CONTROL_AI = 'trtIndMixing/glimit/control/ai/put'
export const PUT_TRTINDMIXING_G_CRT_CONTROL_AI = 'trtIndMixing/gcrt/control/ai' + '/put'
const GET_LATEST = GET_TRTINDMIXING_LATEST.substr(GET_TRTINDMIXING_LATEST.indexOf('/') + 1)
const PUT_HISTORY_FC_SP = PUT_MIXING_HISTORY_FC_SP.substr(PUT_MIXING_HISTORY_FC_SP.indexOf('/') + 1)
const PUT_CONTROL_OPERATION = PUT_TRTINDMIXING_CONTROL_OPERATION.substr(PUT_TRTINDMIXING_CONTROL_OPERATION.indexOf('/') + 1)
...
const PUT_G_CRT_CONTROL_AI = PUT_TRTINDMIXING_G_CRT_CONTROL_AI.substr(PUT_TRTINDMIXING_G_CRT_CONTROL_AI.indexOf('/') + 1)
...
export default {
  ...
  actions: {
    [GET_LATEST]: async function ({ commit }) {
      await axios.get(`${DEV_SERVER}/${URL.MIXING_LATEST}` + '/' + PROCESS_STEP) // processStep 1 : 공업, 2 : 생활, 3 : 공업3차
        .then(({ data }) => {
    ...
    [PUT_HISTORY_FC_SP]: async function ({ commit }) {
      ...
      // nowTimestamp = Date.parse("2013-09-04 20:00:00"); // FIXME 현재 날짜 수정
