...
export const GET_TRDFILTER_LATEST = 'trdFilter/latest/get'
export const GET_FILTER_LOCATION_BY_JI = 'trdFilter/latest/numJi/get'
export const PUT_TRDFILTER_CONTROL_OPERATION = 'trdFilter/control/operation/put'
export const GET_FILTER_SCHEDULE = 'trdFilter/schedule/get'
export const PUT_FILTER_CONTROL_TI = 'trdFilter/control/ti/put'
export const PUT_FILTER_CONTROL_LOCATION = 'trdFilter/control/location/put'
const GET_LATEST = GET_TRDFILTER_LATEST.substr(GET_TRDFILTER_LATEST.indexOf('/') + 1)
const GET_LOCATION_BY_JI = GET_FILTER_LOCATION_BY_JI.substr(GET_FILTER_LOCATION_BY_JI.indexOf('/') + 1)
const PUT_CONTROL_OPERATION = PUT_TRDFILTER_CONTROL_OPERATION.substr(PUT_TRDFILTER_CONTROL_OPERATION.indexOf('/') + 1)
...
import { CLOSE_TRD_FILTER_OPERATION_OF_JI_DIALOG } from '@/store/modules/dialog'
...
export default {
  ...
  mutations: {
    [GET_LATEST]: function (state, data) {
      ...
      const fixed_f_h_le3 = data.f_h_le3.toFixed(2)
      const fixed_f_h_le4 = data.f_h_le4.toFixed(2)
      const Fixed = {
        ...
        f_h_le3: fixed_f_h_le3,
        f_h_le4: fixed_f_h_le4,
      }
  ...
  actions: {
    ...
    [PUT_CONTROL_TI]: async function ({ commit }, { f_location_ti_set_max, f_location_wl_max, f_h_le1, f_h_le2, f_h_le3, f_h_le4 }) {
      await axios.put(`${DEV_SERVER}/${URL.FILTER_CONTROL_TI}/` + PROCESS_STEP, { f_location_ti_set_max, f_location_wl_max, f_h_le1, f_h_le2, f_h_le3, f_h_le4 })
      .then(() => {
        let _data = {
          visible: true,
          title: '설정 성공',
    ...
    [PUT_CONTROL_LOCATION]: async function ({ commit }, { numJi, ai }) {
      ...
      .then(() => {
        ...
        commit('dialog/'+ CLOSE_TRD_FILTER_OPERATION_OF_JI_DIALOG, null, { root: true })
        let _data = {
          visible: true,
          title: '설정 성공',
          text1: '설정값이 변경되었습니다'
