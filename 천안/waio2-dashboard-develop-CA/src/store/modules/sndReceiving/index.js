...
export const GET_SNDRECEIVING_LATEST = 'sndReceiving/latest/get'
export const PUT_SNDRECEIVING_HISTORY_FLOW_OUT = 'sndReceiving/latest/put'
export const PUT_SNDRECEIVING_CONTROL_OPERATION = 'sndReceiving/control/operation/put'
export const PUT_SNDRECEIVING_CONTROL_LEVEL = 'sndReceiving/control/le/put'
const GET_LATEST = GET_SNDRECEIVING_LATEST.substr(GET_SNDRECEIVING_LATEST.indexOf('/') + 1)
const PUT_HISTORY_FLOW_OUT = PUT_SNDRECEIVING_HISTORY_FLOW_OUT.substr(PUT_SNDRECEIVING_HISTORY_FLOW_OUT.indexOf('/') + 1)
const PUT_CONTROL_OPERATION = PUT_SNDRECEIVING_CONTROL_OPERATION.substr(PUT_SNDRECEIVING_CONTROL_OPERATION.indexOf('/') + 1)
const PUT_CONTROL_LEVEL = PUT_SNDRECEIVING_CONTROL_LEVEL.substr(PUT_SNDRECEIVING_CONTROL_LEVEL.indexOf('/') + 1)
