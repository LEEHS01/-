...
public class AiFilterRealtimeDTO
{
	...
	private Integer ai_opr;
	private Date upd_ti;
	private Float f_sp;
	private String f_fri_in;
	private String ai_f_num_fil;
	private String f_tb;
	private String f_wl;
	private String ai_f_wl;
	private String f_time;
	private String ai_f_time;
	private String ai_f_bw_start_time;
	private String ai_f_bw_wait_time;
    ...
    private int ai_f_opr_cnt;        // AI 운영지 수 예측
    ...
    private String ai_f_location_schedule; //각 지별 예측 스케줄 (JSON)
    private String ai_f_schedule;
