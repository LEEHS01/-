...
public class CommonValue
{
    ...
    // Alarm ID
    public static int ALARM_RECEIVING_AI_CONTROL        = 131001;
//    public static int ALARM_RECEIVING_AI_MODULE_ERROR   = 131100;
    public static int ALARM_COAGULANT_AI_CONTROL        = 132001;
//    public static int ALARM_COAGULANT_AI_MODULE_ERROR   = 132100;
    public static int ALARM_MIXING_AI_CONTROL           = 133001;
//    public static int ALARM_MIXING_AI_MODULE_ERROR      = 133100;
    public static int ALARM_SEDIMENTATION_AI_CONTROL    = 134001;
//    public static int ALARM_SEDIMENTATION_AI_MODULE_ERROR = 134100;
    public static int ALARM_FILTER_AI_CONTROL           = 135001;
...
//    public static int ALARM_GAC_AI_MODULE_ERROR         = 136100;
    public static int ALARM_DISINFECTION_AI_CONTROL_PRE      = 137011;
    public static int ALARM_DISINFECTION_AI_CONTROL_PERI     = 137021;
    public static int ALARM_DISINFECTION_AI_CONTROL_POST     = 137031;
...
//    public static int ALARM_OZONE_AI_MODULE_ERROR       = 138100;
    ...
    //public static String B_OPERATION_MODE           = "b_operation_mode_a";
    //public static String C_OPERATION_MODE           = "c_operation_mode_a";
    //public static String D_OPERATION_MODE           = "d_operation_mode_a";
    //public static String E_OPERATION_MODE           = "e_operation_mode_a";
    //public static String F_OPERATION_MODE           = "f_operation_mode_a";
    //public static String G_OPERATION_MODE           = "g_operation_mode";
    //public static String G_PRE_OPERATION_MODE       = "g_pre_operation_mode_a";
    //public static String G_PERI_OPERATION_MODE      = "g_peri_operation_mode_a";
    //public static String G_POST_OPERATION_MODE      = "g_post_operation_mode_a";
    ...
    // KAFKA GROUPID
    public static final String KAFKA_GROUP_ID = "operation";	// FIXME 운영반영은 숫자 제거
    ...
    public static int[] PROCESS_STEP_ARRAY = {1}; //보령정수장은 PROCESS_STEP이 단일로 존재
