...
//    List<AlarmNotifyDTO> getAlarmNotifyFromAckState(boolean ackState);    // 알람 네비게이터 삭제
    ...
    List<TagManageDTO> getTagManageFromType(int type, String process);
...
//    List<AiClearOperationBandDTO> getAiClearWideOperationBandFromTimeIndex(InterfaceDateSearchDTO dto);
    ...
    int modAiFilterInitTi(float value, int processStep, String itm);
    ...
    List<AiProcessAlarmDTO> getAllAiDisinfectionAlarm(Date alarm_time, int kafka_flag, int disinfectionStep);
    int modAiDisinfectionAlarmKafkaFlag(AiProcessAlarmDTO dto, int disinfectionStep);
    ...
    void insertAlarmControlHistory(AlmCtrHisDTO alarmControl);
    ...
    int modAiOprRealTime(String process, String disinfectionStep, int value);
