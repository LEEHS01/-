...
exports.disCharge = (data) => {
  /*
  VCB반("부분방전 크기 조회", disCharge)
  */
  logger.info('VcbMapper::disCharge > ', data);
  let query = `
  SELECT 
    vcb_id, 
    dbm_avg, 
...
exports.detailInfo = (data) => {
  /*
  VCB반("상세 조회", detailInfo)
  */
  logger.info('VcbMapper::detailInfo > ', data);
  let query = `
  SELECT 
    vcb_id, 
    dbm, 
