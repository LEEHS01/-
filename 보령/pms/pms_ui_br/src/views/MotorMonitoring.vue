                        ...
                        <div class="motors">
                           ...
                           <div class="select-motor">
                                <div v-show="store.state.monitor1.tabIndex === 1"
                                    class="motor-box"
                                    v-for="(motor, index) 
                                    in store.state.monitor1.modelList.slice(0, 6)" 
                                    :key="motor.id"
                                ...
                                <div v-show="store.state.monitor1.tabIndex === 2"
                                    class="motor-box"
                                    v-for="(motor, index) 
                                    in store.state.monitor1.modelList.slice(6, 10)" 
                                    :key="motor.id"
                                    @click="selectedMotor(motor.id)"
                                    style="width: calc(100% / 4); padding: 20px;"
                                >
                                    <div
                                        class="motor-img"
                                        :class="{
    ...
    setup() {
        ...
        const tab = (idx) => {
            ...
            if (idx === 1) {
                ...
                store.state.monitor1.id = 'motor_07'
