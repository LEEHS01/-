                        ...
                        <div class="chart-area">
                            <div class="alert-icon">
                                <div class="state-area">
                                    <div
                                        class="alarm-icon"
                                        :class="{ error: list.status.eq_open }"
                                    >
                                        <img
                                            class="icon"
...
import Scatter from '@/components/chart/monitoring/Scatter_comp.vue';
...
export default {
    ...
    setup() {
        ...
        const clickParam = (value) => {
            store.state.monitor11.selectModel = value.title;
            store.state.monitor11.id = value.id;
            router.push('BackWashBlowerDetail');
        };
        ...
        onMounted(() => {
            ...
            store.dispatch('monitor11/handleGraphData');
        });
