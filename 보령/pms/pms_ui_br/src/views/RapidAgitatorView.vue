    ...
    <div class="monitor-7">
        ...
        <div class="content">
            <div class="content-left">
                ...
                <div class="headerTitle">급속분사교반기</div>
                <div class="content-container two">
                    <div
                        class="content-container-row"
                        v-for="(list, i) in store.state.monitor7.modelList"
                        :key="i"
                    >
                        <div
                            class="icon-area"
                ...
                <div class="content-panel">
                    ...
                    <div class="panel-content">
                        <div class="value-box">
                            ...
                            <div class="value">
                                {{ store.state.monitor7.equipCount
                                }}<span>대 </span>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            store.dispatch('monitor7/handleGraphData');
        });

        const clickParam = (value) => {
            store.state.monitor7.selectModel = value.title;
            store.state.monitor7.modelList.filter((list) => {
                if (list.title === value.title)
                    store.state.monitor7.id = list.id;
            });
            router.push('RapidAgitatorDetail');
        };
