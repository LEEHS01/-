...
export default {
    ...
    setup(props) {
        ...
        watch(state, () => {
            // console.log('state:::');
            option.series[1].data = state.current1 ? state.current1 : [];
            option.series[2].data = state.current2 ? state.current2 : [];
            option.series[3].data = state.current3 ? state.current3 : [];
            option.series[4].data = state.current4 ? state.current4 : [];
        });
