...
export default {
    props: ['title', 'detailData', 'name1', 'maxLine', 'minLine'],
    setup(props) {
        ...
        const state = reactive({
            ...
            maxLine: computed(() =>props.maxLine),
            minLine: computed(() =>props.minLine)
        });

        watch(state, () => {
            // console.log('state:::');
            option.series[2].data = state.current ? state.current : [];
        });
        ...
        const option = reactive({
            ...
            series: [
                ...
                },
                {
                    ...
                    markLine: state.minLine !== "0" ? { // minLine이 0이 아닐 때만 표시
                        symbol: 'none',
                        silent: true,
                        label: {
                            show: true,
                    ...
                    } : null, // minLine이 0일 경우 markLine이 없도록 설정
                },
                {
                    name: state.name1,
                    type: 'line',
