<template>
  <div class="dashboard-container">
    ...
    <div class="map-contents">
      ...
      >
        ...
        <img
          ...
          src="@/assets/br_images/br_splashdown.png"
        />
        <img
          class="up"
          :class="[store.state.selectedBuildingIndex === 1 ? 'building-visible': 'building-unvisible']"
          src="@/assets/br_images/br_over_splashdown.png"
        />
        <!-- <img
      ...
      >
        ...
        <img
          ...
          src="@/assets/br_images/br_percolation.png"
        />
        <img
          class="up"
          :class="[store.state.selectedBuildingIndex === 5 ? 'building-visible': 'building-unvisible']"
          src="@/assets/br_images/br_over_percolation.png"
        />
        <!-- <img
      ...
      >
        ...
        <img
          ...
          src="@/assets/br_images/br_disinfection.png"
        />
        <img
          class="up"
          :class="[store.state.selectedBuildingIndex === 6 ? 'building-visible': 'building-unvisible']"
          src="@/assets/br_images/br_over_disinfection.png"
        />
        <!-- <img
    ...
    <Popup7 v-if="store.state.selectedBuildingIndex === 6" /> -->
  </div>
</template>
...
.dashboard-container {
  background: url("~@/assets/br_images/bg_boryeong.png") no-repeat;
