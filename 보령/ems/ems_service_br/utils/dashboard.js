...
exports.nowElecQuery = () => {
  let query = `
    ...
    WHERE tagname IN ( '600-359-PAI-1408'
                ,'600-359-PAI-1508'
                ,'600-359-PAI-1608'
                ,'600-359-PAI-1708'
                ,'600-359-PAI-1808'
    ...
    (
      ...
      (
        ...
        WHERE ts LIKE CONCAT(CURDATE() - INTERVAL 1 DAY,'%')
          AND tagname IN ('600-359-PAI-1408','600-359-PAI-1508','600-359-PAI-1608','600-359-PAI-1708','600-359-PAI-1808','600-359-PAI-1908') /* 보령(정) 고압반 유효전력 */
      )a
    )a,
    (
