...
exports.getSelectFacSunsi = async (req, res) => {
  let conn;
  // ksw(기존것) let { search} = req.query;
  let { search, search2, search3, search4, search5 } = req.query;
  logger.info(search)
  try{
    logger.info('getSelectFacSunsi ---',search, search2, search3, search4, search5)
    //sw let result = queries.selectFacSunsi({ search });
    let result = queries.selectFacSunsi({ search, search2, search3, search4, search5 });
