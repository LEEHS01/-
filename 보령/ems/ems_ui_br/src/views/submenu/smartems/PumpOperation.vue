          ...
          <div class="div_content2">
            ...
            <div class="fL" style="width: calc(80% - 35px); height: 100%;">
              <div class="div_content2_right_col fL">
                <div class="div_content2_right_category div_box_title_border fL">보령(정) #1</div>
              ...
              <div class="div_content2_right_col fL">
                <div class="div_content2_right_category div_box_title_border fL">보령(정) #2</div>
              ...
              <div class="div_content2_right_col fL">
                <div class="div_content2_right_category div_box_title_border fL">보령(정) #3</div>
              ...
              <div class="div_content2_right_col fL">
                <div class="div_content2_right_category div_box_title_border fL">보령(정) #4</div>
              ...
              <div class="div_content2_right_col fL">
                <div class="div_content2_right_category div_box_title_border fL">보령(정) #5</div>
              ...
              <div class="div_content2_right_col fL">
                <div class="div_content2_right_category div_box_title_border fL">보령(정) #6</div>
                <input class="div_content2_right_category div_box_border fL" v-model="operatorAssignment[5]"/>
                <input class="div_content2_right_category div_box_border fL" v-model="priorityAnalysis[5]" />
                <div class="div_content2_right_category div_box_border fL">
                  <select class="drop-down-pump" v-model="selectedPumpUse[5]">
                    <option v-for="(item, idx) in pumpUseList[5]" :key="idx" :value="item">
                      {{item}}
                    </option>
                  </select>
                </div>
                <div class="div_content2_right_category div_box_border fL">{{ resultValue[5] }}</div>
              </div>
            </div>
          </div>
        </div>
      ...
      try {
        ...
        if (confirmFlag) {
          ...
          for (let i = 0; i < 6; i++) {
            ...
            if (!validateNum(num, num2, 6, '해당 숫자만 입력해주세요. (보령(정):1~6)')) {
              return
            }
            list.push(num)
            list2.push(num2)
          }
          if (new Set(list).size !== 6 || new Set(list2).size !== 6) {
            alert('우선순위가 겹치지 않도록 입력해주세요. (보령(정))')
            return
          }
