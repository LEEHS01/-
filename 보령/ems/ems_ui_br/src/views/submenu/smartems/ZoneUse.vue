  ...
  <div class="contents">
    <div class="main">
      ...
      <div class="contents-container">
        <div class="left_box" style="width: 40%">
          ...
          <div class="fR contents-box paddingfix" style="width: 55%; height: 100%;">
            <div class="box">
              <div class="box-contents-title img-position-top">수변전실<!--착수--></div>
              <div class="box-value-contents" style="margin-top: 20px;">
                <!-- <div class="box-value-contents__value" style="color: yellow">{{ boxData.착수_순시전력 }}</div> -->
                <div class="box-value-contents__value" style="color: yellow">{{ boxData.수변전실_순시전력 }}</div>
                <div class="box-value-contents__unit">kW</div>
                <!-- <div class="chart-icon" @click="sunsiChart('착수')"></div> -->
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value">{{ boxData.수변전실_전력량 }}</div>
                <div class="box-value-contents__unit">kWh</div>
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value">{{ boxData.수변전실_최대전력 }}</div>
                <div class="box-value-contents__unit">kW</div>
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value date_text" style="width: 100%; text-align: center;">{{ boxData.수변전실_최대전력시간 }}</div>
              </div>
            </div>
            <div class="box box_bottom">
              <div class="box-value-contents" style="margin-top: 21px;">
                <div class="box-value-contents__value" style="color: yellow">{{ boxData.송수펌프동_순시전력 }}</div>
                <div class="box-value-contents__unit">kW</div>
                <!-- <div class="chart-icon" @click="sunsiChart('침전')"></div> -->
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value">{{ boxData.송수펌프동_전력량 }}</div>
                <div class="box-value-contents__unit">kWh</div>
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value">{{ boxData.송수펌프동_최대전력 }}</div>
                <div class="box-value-contents__unit">kW</div>
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value date_text" style="width: 100%; text-align: center;">{{ boxData.송수펌프동_최대전력시간 }}</div>
              </div>
              <div class="box-contents-title img-position-bottom" style="margin: 20px 0 0 0;">송수펌프동<!--침전--></div>
            </div>
          </div>
        </div>
        <div class="middle_box" style="width: 20%">
          <div class="contents-box">
            <div class="box">
              <div class="box-contents-title img-position-top"><!--약품-->약품동</div>
              <div class="box-value-contents" style="margin-top: 20px;">
                <div class="box-value-contents__value" :style="{ color: 'yellow' }">{{ boxData.약품동_순시전력 }}</div>
                <div class="box-value-contents__unit">kW</div>
                <!-- <div class="chart-icon" @click="sunsiChart('약품')"></div> -->
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value">{{ boxData.약품동_전력량 }}</div>
                <div class="box-value-contents__unit">kWh</div>
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value">{{ boxData.약품동_최대전력 }}</div>
                <div class="box-value-contents__unit">kW</div>
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value date_text" style="width: 100%; text-align: center;">{{ boxData.약품동_최대전력시간 }}</div>
              </div>
            </div>
            <div class="box box_bottom">
              <div class="box-value-contents" style="margin-top: 21px;">
                <div class="box-value-contents__value" :style="{ color: 'yellow' }">{{ boxData.배출수동_순시전력 }}</div>
                <div class="box-value-contents__unit">kW</div>
                <!-- <div class="chart-icon" @click="sunsiChart('여과')"></div> -->
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value">{{ boxData.배출수동_전력량 }}</div>
                <div class="box-value-contents__unit">kWh</div>
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value">{{ boxData.배출수동_최대전력 }}</div>
                <div class="box-value-contents__unit">kW</div>
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value date_text" style="width: 100%; text-align: center;">{{ boxData.배출수동_최대전력시간 }}</div>
              </div>
              <div class="box-contents-title img-position-bottom" style="margin: 20px 0 0 0;"><!--여과-->배출수동</div>
            </div>
          </div>
        </div>
        <div class="right_box" style="width: 40%">
          <div class="fL contents-box" style="width: 55%; height: 100%;">
            <div class="box">
              <div class="box-contents-title img-position-top">회수펌프동</div>
              <div class="box-value-contents" style="margin-top: 20px;">
                <div class="box-value-contents__value" style="color: yellow">{{ boxData.회수펌프동_순시전력 }}</div>
                <div class="box-value-contents__unit">kW</div>
                <!-- <div class="chart-icon" @click="sunsiChart('혼화응집')"></div> -->
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value">{{ boxData.회수펌프동_전력량 }}</div>
                <div class="box-value-contents__unit">kWh</div>
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value">{{ boxData.회수펌프동_최대전력 }}</div>
                <div class="box-value-contents__unit">kW</div>
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value date_text" style="width: 100%; text-align: center;">{{ boxData.회수펌프동_최대전력시간 }}</div>
              </div>
            </div>
            <div class="box box_bottom">
              <div class="box-value-contents" style="margin-top: 21px;">
                <div class="box-value-contents__value" :style="{ color: 'yellow' }">{{ boxData.기타분전반_순시전력 }}</div>
                <div class="box-value-contents__unit">kW</div>
                <!-- <div class="chart-icon" @click="sunsiChart('소독')"></div> -->
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value">{{ boxData.기타분전반_전력량 }}</div>
                <div class="box-value-contents__unit">kWh</div>
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value">{{ boxData.기타분전반_최대전력 }}</div>
                <div class="box-value-contents__unit">kW</div>
              </div>
              <div class="box-value-contents">
                <div class="box-value-contents__value date_text" style="width: 100%; text-align: center;">{{ boxData.기타분전반_최대전력시간 }}</div>
              </div>
              <div class="box-contents-title img-position-bottom" style="margin: 20px 0 0 0;"><!--소독-->기타분전반</div>
            </div>
          </div>
    ...
    const htmlMapping = (data, data2) => {
      try {
        ...
        for (const i in groupedData1) {
          ...
          boxData[`${i}_전력량`] = comma(Number(groupedData2[i][0].y).toFixed(0)) // 전력량
          boxData[`${i}_최대전력`] = comma(Number(yMax[i]).toFixed(0)) // 시간당 최대전력
          sum += groupedData2[i][0].y

          const maxItem = groupedData1[i].find(item => item.y === maxValue)
          if (maxItem) {
            boxData[`${i}_최대전력시간`] = maxItem.x // 최대 전력 시간대
          }
        }
    ...
    const getSunsiData = async () => {
      try {
        ...
        if (sunsiData.value && sunsiData.value.length > 0) {
          ...
          // 현재 순시전력 연동
          result.forEach((item) => {
            const zoneName = `${item.zone_name}_순시전력`
