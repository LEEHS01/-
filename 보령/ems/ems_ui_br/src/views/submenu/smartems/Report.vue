...
export default ({
  ...
  setup (props, { emit }) {
    ...
    const pumpOperationDefs = ref([
      { headerName: '구분', field: 'ROW', width: 185, suppressMovable: true },
      {
        ...
        children: [ // 추후 정수장에 맞게 field명 수정 필요
          ...
          { headerName: '4호기', field: 'p_4', width: cellWidth, suppressMovable: true },
          { headerName: '5호기', field: 's_1', width: cellWidth, suppressMovable: true },
          { headerName: '6호기', field: 's_2', width: cellWidth, suppressMovable: true }
        ],
        suppressMovable: true
      },
    ...
    const excelBtn = () => {
      ...
      newWorksheet3.B1 = { t: 's', v: '보령 송수펌프 전력사용량 (kWh)' }
      ...
      newWorksheet3['!cols'] = Array(10).fill({ wpx: colWidth })

      // 4. 주요 배수지 수위 그리드
      const newWorksheet4 = getWorksheet(waterLevelData.value, gridColumnApi.waterLevel, 2)
      newWorksheet4.B1 = { t: 's', v: '서천' }
      newWorksheet4.D1 = { t: 's', v: '광천' }
      newWorksheet4.F1 = { t: 's', v: '대천' }
      newWorksheet4.H1 = { t: 's', v: '주산' }
