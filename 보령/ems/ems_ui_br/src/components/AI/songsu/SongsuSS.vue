  ...
  <div class="fL songsuLeftBox">
    <div style="height: calc(95%); width: 100%;">
        ...
        <div class="ai_pump_start">
          <div class="ai_pump_start2 fL">
            <div class="ai_pump_start2_2 fL">
              <div class="top_name img_circle fL">당진</div>
            ...
            <div class="fL" style="height: calc(100% - 105px); width: calc(100% - 15px ); margin-left: 15px; ">
              <div class="pump_area_h4_top pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(pumpStatusA[0]) }">#1</div>
              ...
              <div class="pump_area_h4_top pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(pumpStatusA[1]) }">#2</div>
              <div class="pump_area_h4_top pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(pumpStatusA[2]) }">#3</div>
              <div class="fL" style="background-size: 80%; width: 100%; display: flex; align-items: center; justify-content: center; font-size: 18px;">
                <span class="input_design" style="margin-right: 10px; height: 50%;">{{ freqA2 }}</span>Hz
              </div>
              <div class="pump_area_h4_top pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(pumpStatusA[3]) }">#4</div>
            </div>
            <!-- 장치 이미지 구역 끝-->
          </div>
          <div class="ai_pump_start_bottom fL">
            <div class="bottom_area fL">
              <div class="top_name img_circle fL">태안</div>
              <div class=" fL" style="width: 70%; height: 100%; display: flex; flex-direction: column;justify-content: center;">
                <div class="detail_textWrap" style="margin: 0 0 5px 0;">
                  <div class="detail_text" style="width: 30%;">예상 전력</div>
                  <span class="detail_value" style="text-align: right;">{{ pwrPrdctB }}</span>
                  <span class="detail_text" style="margin-left: 10px;width: initial;font-size:14px">kW</span>
                </div>
                <div class="detail_textWrap" style="margin: 0 0 5px 0;">
                  <div class="detail_text" style="width: 30%;">예상 관압</div>
                  <span class="detail_value" style="text-align: right;">{{ tubePrsrPrdctB }}</span>
                  <span class="detail_text" style="margin-left: 10px;width: initial;font-size:14px">kg/cm2</span>
                </div>
                <div class="detail_textWrap" style="margin: 0;">
                  <div class="detail_text" style="width: 30%;">예상 유량</div>
                  <span class="detail_value" style="text-align: right;">{{ flowPrdctB }}</span>
                  <span class="detail_text" style="margin-left: 10px;width: initial;font-size:14px">m3</span>
                </div>
              </div>
            </div>
            ...
            <div class="fL" style="height: calc(100% - 80px); width: calc(100% - 15px);  margin-left: 15px;">
              <div class="pump_area_h4_bottom pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(pumpStatusB[0]) }">#1</div>
              <div class="fL" style="background-size: 80%; width: 100%; display: flex; align-items: center; justify-content: center; font-size: 18px;">
                <span class="input_design" style="margin-right: 10px; height: 50%;">{{ freqB1 }}</span>Hz
              </div>
              <div class="pump_area_h4_bottom pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(pumpStatusB[1]) }">#2</div>
              <div class="pump_area_h4_bottom pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(pumpStatusB[2]) }">#3</div>
              <div class="pump_area_h4_bottom pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(pumpStatusB[3]) }">#4</div>
            </div>
            <!-- 펌프 이미지 끝 -->
          </div>
        </div>
        ...
        <div style="width: 100%; height:60%;margin-left:-52px">
          ...
          <div class="arrow_info">
            ...
            <div id="autoban_area" ref= "autoBanArea" style="opacity: 0.2; margin-top: 30px;">
							<input type="radio" ref="aiAuto" id="ai_auto" name="fav_language" value="ai_auto" @change="handleAutoChange1">
							<label for="ai_auto" class="detail_text" style="font-size: 18px;">AI</label><br>
							<input type="radio" ref="aiBanAuto" id="ai_banauto" name="fav_language" value="ai_banauto" @change="handleBanAutoChange1">
        ...
        <div style="width: 100%; height:40%;margin-left:-52px">
          ...
          <div style="position: absolute;width: 5%;height: 33%;display: flex;justify-content: center;align-items: center;flex-direction: column;">
            ...
            <div @click="handleToggleClick2" class="toggleBG_BIG" style="  margin-top: 10px;">
              <button ref="toggleButton2" class="toggleFG_BIG" style="left: 0;">{{ toggleState2 }}</button>
            </div>
      ...
      <div class="fL" style="width: 30%;height: 100%;">
        <div class="" style="width: 100%; height:100%; text-align: center; font-size: 20px; color: white;">
          <div class="pump_area fL">
            ...
            <!-- 상자 중간 부분 시작 -->
            <div class="middle fL">
              <div class="pump_area_h4_top pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(nowPumpStatusA[0]) }">#1</div>
              <div v-show="nowPumpStatusA[0] === 'on'" class="fL" style="background-size: 80%; width: 100%; display: flex; align-items: center; justify-content: center; font-size: 18px;">
                <span class="input_design" style="margin-right: 10px; height: 50%;">{{ aiFreqA1 }}</span>Hz
              </div>
              <div v-show="nowPumpStatusA[0] === 'off'" class="fL" style="background-size: 80%; width: 100%; display: flex; align-items: center; justify-content: center; font-size: 18px;">
                <span class="input_design" style="margin-right: 10px; height: 50%;">0.00</span>Hz
              </div>
              <div class="pump_area_h4_top pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(nowPumpStatusA[1]) }">#2</div>
              <div class="pump_area_h4_top pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(nowPumpStatusA[2]) }">#3</div>
              <div v-show="nowPumpStatusA[2] === 'on'" class="fL" style="background-size: 80%; width: 100%; display: flex; align-items: center; justify-content: center; font-size: 18px;">
                <span class="input_design" style="margin-right: 10px; height: 50%;">{{ aiFreqA2 }}</span>Hz
              </div>
              <div v-show="nowPumpStatusA[2] === 'off'" class="fL" style="background-size: 80%; width: 100%; display: flex; align-items: center; justify-content: center; font-size: 18px;">
                <span class="input_design" style="margin-right: 10px; height: 50%;">0.00</span>Hz
              </div>
              <div class="pump_area_h4_top pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(nowPumpStatusA[3]) }">#4</div>
            </div>
            <!-- 상자 중간 부분 끝 -->
          </div>
          <!-- 상자 하단 부분 시작 -->
          <div class="pump_area_bottom fL">
            <div class=" fL" style="height: 70px; width: 100%;display: flex;align-items: center;padding: 10px 0 10px 0;">
              ...
              <div class=" fL" style="width: 70%;height: 100%; display: flex;flex-direction: column;justify-content: center;">
                <div class="detail_textWrap" style="margin: 0 0 5px 0;">
                  <div class="detail_text" style="width: 30%;">전력</div>
                  <span class="detail_value" style="text-align: right;">{{ aiPwrB }}</span>
                  <span class="detail_text" style="margin-left: 10px;width: initial;font-size:14px">kW</span>
                </div>
                <div class="detail_textWrap" style="margin: 0 0 5px 0;">
                  <div class="detail_text" style="width: 30%;">관압</div>
                  <span class="detail_value" style="text-align: right;">{{ aiTubePrsrB }}</span>
                  <span class="detail_text" style="margin-left: 10px;width: initial;font-size:14px">kg/cm2</span>
                </div>
                <div class="detail_textWrap" style="margin: 0;">
                  <div class="detail_text" style="width: 30%;">유량</div>
                  <span class="detail_value" style="text-align: right;">{{ aiFlowB }}</span>
                  <span class="detail_text" style="margin-left: 10px;width: initial;font-size:14px">m3</span>
                </div>
              </div>
            </div>
            ...
            <div class="bottom_image_area fL">
              <div class="pump_area_h4_bottom pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(nowPumpStatusB[0]) }">#1</div>
              <div v-show="nowPumpStatusB[0] === 'on'" class="fL" style="background-size: 80%; width: 100%; display: flex; align-items: center; justify-content: center; font-size: 18px;">
                <span class="input_design" style="margin-right: 10px; height: 50%;">{{ aiFreqB1 }}</span>Hz
              </div>
              ...
              <div class="pump_area_h4_bottom pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(nowPumpStatusB[1]) }">#2</div>
              <div class="pump_area_h4_bottom pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(nowPumpStatusB[2]) }">#3</div>
              <div class="pump_area_h4_bottom pump_img fL" :style="{ backgroundSize: '25%', opacity: getOpacityValue(nowPumpStatusB[3]) }">#4</div>
            </div>
            <!-- bottom 이미지 끝 -->
          </div>
          <!-- 상자 하단 부분 끝 -->
        ...
        <div class="fL" style="width:60%;">
          <div class="pipe_right_box fL">
            ...
            <div style="width: 100%; height: 100px;">
              <div class="sub_content_middle_value fL sub_content_font" style="font-size: 18px">당진 분기점 현황</div>
              <div class="sub_content_middle_value fL">
                <div class="detail_text" style="font-size: 14px; text-align: center;">당진관말(분) 압력</div>
      ...
      <div class="fL" style="width: 30%; height: 25%; margin-top: 10%;">
        ...
        <div class="fL" style="width:60%; height: 85%;">
          <div class="pipe_right_box fL">
            <div style="width: 100%; height: 3%;"></div>
            <div style="width: 100%; height: 100px;">
              <div class="sub_content_middle_value fL sub_content_font" style="font-size: 18px">태안 분기점 현황</div>
              <div class="sub_content_middle_value fL">
                <div class="detail_text" style="font-size: 14px; text-align: center;">팔봉(분) 유출유량</div>
                <div class="sub_input_box" style="width: 23%; height: 40%;">{{ divergeInfo[1] }}</div>
                <span class="sub_content_font" style="width: 24%;">m³/h</span>
              </div>
              <div class="sub_content_middle_value fL">
                <div class="detail_text" style="font-size: 14px; text-align: center;">태안관말(분) 유량</div>
                <div class="sub_input_box" style="width: 23%; height: 40%;">{{ divergeInfo[2] }}</div>
                <span class="sub_content_font" style="width: 24%;">m³/h</span>
              </div>
              <div class="sub_content_middle_value fL">
                <div class="detail_text" style="font-size: 14px; text-align: center;">태안관말(분) 압력</div>
          ...
          <div class="k-window" style="padding-top: 0px;min-width: 90px; min-height: 50px;width: 1100px;height: 650px;">
            <div style="padding: 60px 45px; height: 100%; width: 100%; box-sizing: border-box;">
              <div style="height: 85%; width: 100%; ">
                <div class="popup__title" style="font-size: 18px;">현재 운영 <div class="detail_text" style="width: 14%;margin-left: 11%">제어순서</div>
                ...
                <div class="fL" style="width: 100%;height: 30%;">
                  <div class="" style="width: 100%;height:100%;text-align: center;font-size: 20px;color: #fff;">
                    <div class=" fL" style="height: 100%; width: 50%;">
                      <div class="fL" style="height: 100%; width: calc(100% - 30px ); margin-left: 4px; display: flex;">
                    ...
                    <div class=" fL" style="height: 100%;width: 50%;">
                      <div class="fL" style="height: 100%; width: calc(100% - 20px);  margin-left: 10px; display: flex;">
                        <div class="pump_area_w50 pop_pump_img" :style="{ backgroundSize: '70%', opacity: getOpacityValue(pumpStatusB[0]) }"> #1 </div>
                        <div class="pump_area_w50 pop_pump_img" :style="{ backgroundSize: '70%', opacity: getOpacityValue(pumpStatusB[1]) }"> #2 </div>
                        <div class="pump_area_w50 pop_pump_img" :style="{ backgroundSize: '70%', opacity: getOpacityValue(pumpStatusB[2]) }"> #3 </div>
                        <div class="pump_area_w50 pop_pump_img" :style="{ backgroundSize: '70%', opacity: getOpacityValue(pumpStatusB[3]) }"> #4 </div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="popup__title" style="font-size: 18px;">AI 분석</div>
                <!-- AI 펌프 영역 시작 -->
                <div class="fL" style="width: 100%;height: 30%;">
                  <div class="" style="width: 100%;height:100%;text-align: center;font-size: 20px;color: #fff;">
                    <div class=" fL" style="height: 100%; width: 50%;">
...
import SongsuWaterBox from '@/components/AI/songsu/SongsuWaterBoxSS.vue'
...
export default {
  ...
  setup (props, { emit }) {
    ...
    const divergeInfo = reactive([0, 0, 0, 0])
    ...
    const handleToggleClick = async () => {
      ...
      try {
        ...
        if (toggleState.value === 'OFF') {
          confirmMessage = '당진 AI 운영을 AI 추천 모드로 하시겠습니까?'
          if (confirm(confirmMessage)) {
            // insertAIonOff DB 연동
            const actions = [
              { search: '600-457-EMS-1001', search2: '0' },
              { search: '600-457-EMS-1002', search2: '0' },
              { search: '600-457-EMS-1003', search2: '1' }
            ]
          ...
          confirmMessage = '당진 AI 운영을 off 하시겠습니까?'
          if (confirm(confirmMessage)) {
            // insertAIonOff DB 연동
            const actions = [
              { search: '600-457-EMS-1001', search2: '1' },
              { search: '600-457-EMS-1002', search2: '0' },
              { search: '600-457-EMS-1003', search2: '0' }
            ]
            const result = await actionInsertAIonOff(actions)
            if (result) {
    ...
    const handleToggleClick2 = async () => {
      ...
      try {
        ...
        if (toggleState2.value === 'OFF') {
          confirmMessage = '태안 AI 운영을 AI 추천 모드로 하시겠습니까?'
          if (confirm(confirmMessage)) {
            // insertAIonOff DB 연동
            const actions = [
              { search: '600-457-EMS-2001', search2: '0' },
              { search: '600-457-EMS-2002', search2: '0' },
              { search: '600-457-EMS-2003', search2: '1' }
            ]
            const result = await actionInsertAIonOff(actions)
            if (result) {
          ...
          confirmMessage = '태안 AI 운영을 off 하시겠습니까?'
          if (confirm(confirmMessage)) {
            // insertAIonOff DB 연동
            const actions = [
              { search: '600-457-EMS-2001', search2: '1' },
              { search: '600-457-EMS-2002', search2: '0' },
              { search: '600-457-EMS-2003', search2: '0' }
            ]
            const result = await actionInsertAIonOff(actions)
            if (result) {
              // // AI 운영 off 후 insertPopup3 DB 연동
    ...
    const handleAutoChange1 = async () => {
      // AI 자동 선택
      try {
        if (confirm('당진 AI 운영을 AI 모드로 하시겠습니까?')) {
          // insertAIonOff DB 연동
          const actions = [
            { search: '600-457-EMS-1001', search2: '0' },
            { search: '600-457-EMS-1002', search2: '1' },
            { search: '600-457-EMS-1003', search2: '0' }
          ]
          const result = await actionInsertAIonOff(actions)
          if (result) {
    ...
    const handleBanAutoChange1 = async () => {
      // AI 반자동 선택
      try {
        if (confirm('당진 AI 운영을 AI 추천 모드로 하시겠습니까?')) {
          // insertAIonOff DB 연동
          const actions = [
            { search: '600-457-EMS-1001', search2: '0' },
            { search: '600-457-EMS-1002', search2: '0' },
    ...
    const handleAutoChange2 = async () => {
      // AI 자동 선택
      try {
        if (confirm(' 태안 AI 운영을 AI 모드로 하시겠습니까?')) {
          // insertAIonOff DB 연동
          const actions = [
            { search: '600-457-EMS-2001', search2: '0' },
            { search: '600-457-EMS-2002', search2: '1' },
            { search: '600-457-EMS-2003', search2: '0' }
          ]
          const result = await actionInsertAIonOff(actions)
          if (result) {
    ...
    const handleBanAutoChange2 = async () => {
      // AI 반자동 선택
      try {
        if (confirm('태안 AI 운영을 AI 추천 모드로 하시겠습니까?')) {
          // insertAIonOff DB 연동
          const actions = [
            { search: '600-457-EMS-2001', search2: '0' },
            { search: '600-457-EMS-2002', search2: '0' },
    ...
    const aiOnoffStatus = (data) => {
      ...
      try {
        ...
        if (data[0].ta_ai_onoff === 1 || data[0].ta_ai_onoff === '1.0000') {
          //ai미사용
          toggleButton2.value.style.background = '#b4dffa'
          ...
          if (data[0].ta_ai_onoff_auto === 0 || data[0].ta_ai_onoff_auto === '0.0000') {  
            //AI반자동
            aiAuto2.value.checked = false
            aiAuto2.value.nextElementSibling.style.opacity = '0.3'
            aiBanAuto2.value.checked = true
    ...
    const leftmappingHtml = (data2) => {
      try {
        if (data2[0].펌프1가동상태운영_서산 === null || data2[0].펌프1가동상태운영_태안 === null) {
          console.log('data empty pass')
        } else {
          // 당진
          insertPumpVal(aiPwrA, Number(data2[0].당진전력).toFixed(2))
          insertPumpVal(aiTubePrsrA, Number(data2[0].당진관압).toFixed(2))
          insertPumpVal(aiFlowA, Number(data2[0].당진유량).toFixed(2))
          nowPumpStatusA[0] = (data2[0].펌프1가동상태운영_당진 === '1.0' || data2[0].펌프1가동상태운영_당진 === '1.0000' || data2[0].펌프1가동상태운영_당진 === '1' || data2[0].펌프1가동상태운영_당진 === 1) ? 'on' : 'off'
          nowPumpStatusA[1] = (data2[0].펌프2가동상태운영_당진 === '1.0' || data2[0].펌프2가동상태운영_당진 === '1.0000' || data2[0].펌프2가동상태운영_당진 === '1' || data2[0].펌프2가동상태운영_당진 === 1) ? 'on' : 'off'
          nowPumpStatusA[2] = (data2[0].펌프3가동상태운영_당진 === '1.0' || data2[0].펌프3가동상태운영_당진 === '1.0000' || data2[0].펌프3가동상태운영_당진 === '1' || data2[0].펌프3가동상태운영_당진 === 1) ? 'on' : 'off'
          nowPumpStatusA[3] = (data2[0].펌프4가동상태운영_당진 === '1.0' || data2[0].펌프4가동상태운영_당진 === '1.0000' || data2[0].펌프4가동상태운영_당진 === '1' || data2[0].펌프4가동상태운영_당진 === 1) ? 'on' : 'off'
          insertPumpVal(aiFreqA1, Number(data2[0].펌프1주파수_당진).toFixed(2))
          insertPumpVal(aiFreqA2, Number(data2[0].펌프3주파수_당진).toFixed(2))
          // 태안
          insertPumpVal(aiPwrB, Number(data2[0].태안전력).toFixed(2))
          insertPumpVal(aiTubePrsrB, Number(data2[0].태안관압).toFixed(2))
          insertPumpVal(aiFlowB, Number(data2[0].태안유량).toFixed(2))
          nowPumpStatusB[0] = (data2[0].펌프1가동상태운영_태안 === '1.0' || data2[0].펌프1가동상태운영_태안 === '1.0000' || data2[0].펌프1가동상태운영_태안 === '1' || data2[0].펌프1가동상태운영_태안 === 1) ? 'on' : 'off'
          nowPumpStatusB[1] = (data2[0].펌프2가동상태운영_태안 === '1.0' || data2[0].펌프2가동상태운영_태안 === '1.0000' || data2[0].펌프2가동상태운영_태안 === '1' || data2[0].펌프2가동상태운영_태안 === 1) ? 'on' : 'off'
          nowPumpStatusB[2] = (data2[0].펌프3가동상태운영_태안 === '1.0' || data2[0].펌프3가동상태운영_태안 === '1.0000' || data2[0].펌프3가동상태운영_태안 === '1' || data2[0].펌프3가동상태운영_태안 === 1) ? 'on' : 'off'
          nowPumpStatusB[3] = (data2[0].펌프4가동상태운영_태안 === '1.0' || data2[0].펌프4가동상태운영_태안 === '1.0000' || data2[0].펌프4가동상태운영_태안 === '1' || data2[0].펌프4가동상태운영_태안 === 1) ? 'on' : 'off'
          insertPumpVal(aiFreqB1, Number(data2[0].펌프1주파수_태안).toFixed(2))
        }
      } catch (err) {
        console.log(err)
      }
      ...
      try {
        ...
        if (pumpSelect.value) {
          ...
          if (data3 && data3.length > 0) {
            // 당진
            pumpStatusA[0] = (data3[0].펌프1가동상태운영_당진 === '1.0' || data3[0].펌프1가동상태운영_당진 === '1.0000' || data3[0].펌프1가동상태운영_당진 === '1' || data3[0].펌프1가동상태운영_당진 === 1) ? 'on' : 'off'
            pumpStatusA[1] = (data3[0].펌프2가동상태운영_당진 === '1.0' || data3[0].펌프2가동상태운영_당진 === '1.0000' || data3[0].펌프2가동상태운영_당진 === '1' || data3[0].펌프2가동상태운영_당진 === 1) ? 'on' : 'off'
            pumpStatusA[2] = (data3[0].펌프3가동상태운영_당진 === '1.0' || data3[0].펌프3가동상태운영_당진 === '1.0000' || data3[0].펌프3가동상태운영_당진 === '1' || data3[0].펌프3가동상태운영_당진 === 1) ? 'on' : 'off'
            pumpStatusA[3] = (data3[0].펌프4가동상태운영_당진 === '1.0' || data3[0].펌프4가동상태운영_당진 === '1.0000' || data3[0].펌프4가동상태운영_당진 === '1' || data3[0].펌프4가동상태운영_당진 === 1) ? 'on' : 'off'
            insertPumpVal(pwrPrdctA, Number(data3[0].당진분석결과예상전력).toFixed(2))
            insertPumpVal(tubePrsrPrdctA, Number(data3[0].당진분석결과예상관압).toFixed(2))
            insertPumpVal(flowPrdctA, Number(data3[0].당진분석결과예상유량).toFixed(2))
            insertPumpVal(freqA1, Number(data3[0].펌프1주파수_당진).toFixed(2))
            insertPumpVal(freqA2, Number(data3[0].펌프3주파수_당진).toFixed(2))
            // 태안
            pumpStatusB[0] = (data3[0].펌프1가동상태운영_태안 === '1.0' || data3[0].펌프1가동상태운영_태안 === '1.0000' || data3[0].펌프1가동상태운영_태안 === '1' || data3[0].펌프1가동상태운영_태안 === 1) ? 'on' : 'off'
            pumpStatusB[1] = (data3[0].펌프2가동상태운영_태안 === '1.0' || data3[0].펌프2가동상태운영_태안 === '1.0000' || data3[0].펌프2가동상태운영_태안 === '1' || data3[0].펌프2가동상태운영_태안 === 1) ? 'on' : 'off'
            pumpStatusB[2] = (data3[0].펌프3가동상태운영_태안 === '1.0' || data3[0].펌프3가동상태운영_태안 === '1.0000' || data3[0].펌프3가동상태운영_태안 === '1' || data3[0].펌프3가동상태운영_태안 === 1) ? 'on' : 'off'
            pumpStatusB[3] = (data3[0].펌프4가동상태운영_태안 === '1.0' || data3[0].펌프4가동상태운영_태안 === '1.0000' || data3[0].펌프4가동상태운영_태안 === '1' || data3[0].펌프4가동상태운영_태안 === 1) ? 'on' : 'off'
            insertPumpVal(pwrPrdctB, Number(data3[0].태안분석결과예상전력).toFixed(2))
            insertPumpVal(tubePrsrPrdctB, Number(data3[0].태안분석결과예상관압).toFixed(2))
            insertPumpVal(flowPrdctB, Number(data3[0].태안분석결과예상유량).toFixed(2))
            insertPumpVal(freqB1, Number(data3[0].펌프1주파수_태안).toFixed(2))
            // 제어순서, 운영모드
            ...
            // 분기점 현황 업데이트
            // insertPumpVal(divergeInfo[0], Number(data3[0].당진관말압력).toFixed(2))
            // insertPumpVal(divergeInfo[1], Number(data3[0].팔봉유출유량).toFixed(2))
            // insertPumpVal(divergeInfo[2], Number(data3[0].태안관말유량).toFixed(2))
            // insertPumpVal(divergeInfo[3], Number(data3[0].태안관말압력).toFixed(2))
            // 물통 높이 추후 구현 필요
            gaugeHeight[0] = '0%'
            gaugeHeight[1] = '0%'
            waterPercent[0] = '0'
    ...
    const getAiPopup = async () => {
      ...
      try {
        ...
        if (ptrCtrInf.value) {
          ...
          console.log('ptrCtrInf: ', arr)
          let confirmFlag = '0'
          let targetTime = '0'
          let count = 0
          if (arr.data && arr.data.length > 0) {
            if (arr.data[0].value === '1' || arr.data[0].value === 1) {
              confirmFlag = '1'
              targetTime = arr.data[0].diff.split(':')
              count = 60 - Number(targetTime[2])
              console.log('targetTime: ', targetTime, ' count: ', count)
            }
            if (confirmFlag === '1' && count > 10) {
            ...
            console.log('getAiPopup data is empty')
          }
        }
      } catch (err) {
        console.log(err)
    ...
    const cancelPTR = async () => {
      // insertPopup2 DB 연동
      try {
        await store.dispatch('songsu/fetchInsertPopup2', { search: '0' })
