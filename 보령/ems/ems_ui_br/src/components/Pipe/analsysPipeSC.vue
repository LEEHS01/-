<template>
    ...
    <div class="cheongyang">
      ...
      <div class="pipe_first_wrap fL">
        <div style="display: flex; flex-direction: row; align-items: center; height: 50%;">
        ...
        <div style="display: flex; flex-direction: row; align-items: center; height: 50%;">
          <div class="pipe_first_wrap2">
            유입 유량
            <div class="input_box fL"><span class="input_value" >{{ dataList.pipeValueIn1 }}</span>m3/h</div>
          </div>
          <div class="pipe_first fL"></div>
        </div>
      </div>
      ...
      <div class="pipe_center_wrap fL" style="padding-top: 12px;">
        ...
        <div class="pipe_center_top fL" style="padding-bottom: 1px;">
      ...
      <div class="tank_wrap fL">
          ...
          <div class="pipe_last_wrap  fL">
            <div class="water_wrap" >
              <div class="input_box input_water_top fL" ><span class="input_value" >{{ dataList.waterLevel2 }}</span>m</div>
          ...
          <div class="pipe_last_wrap  fL">
            <div class="water_wrap" >
              ...
              <div class="input_box input_water_bottom fL" ><span class="input_value" >{{ dataList.waterLevel5 }}</span> m</div>
            </div>
          </div>
      </div>
      ...
      <div class="valve_out_wrap fL"  >
        ...
        <div class="valve_out_wrap2" >
          유출유량
          <div class="input_box bm10 fL" ><span class="input_value">{{ dataList.pipeValueOut2 }}</span> m3/h</div>
          <div class=" pipe_last fL">
            <div class="pipe_last_arrow blinking"></div>
          </div>
        </div>
...
export default ({
  ...
  setup (props) {
    ...
    const updateData = (data) => {
      ...
      dataList.pipeValueIn1 = data[1].유입유량 !== null ? fixed(data[1].유입유량) : 0.00
      dataList.pipeValueOut = data[0].유출유량 !== null ? fixed(data[0].유출유량) : 0.00
      dataList.pipeValueOut1 = data[1].유출유량 !== null ? fixed(data[1].유출유량) : 0.00
      dataList.pipeValueOut2 = data[2].유출유량 !== null ? fixed(data[2].유출유량) : 0.00
