<template>
    <!-- pipe -->
    <div class="cheongso" style="height: 75%;">
      <div class="fL" style="display: flex; flex-direction: column; width: 11%; height: 65%; justify-content: center; align-items: center; margin-right: 2%; ">
        ...
        <!-- pipe -->
      <div class="fL" style="height: 150%; width: 20%; display: flex; flex-direction: column;">
      ...
      <div class="pipe_center_wrap fL" style="padding-top: 50px;">
        ...
        <div class="pipe_center_top fL" style="padding-top: 10px;">
          <div v-if="dataList.openRateDC0" class="valve_on fL"></div>
          <div v-else class="valve_off fL"></div>
          <div class="input_box input_box_rate fL" ><span class="input_value_rate" >{{dataList.openRate1}}</span>%</div>
          <div class="pipe_line fL" >
            <div v-if="dataList.openRateDC0" class="pipe_line_arrow blinking" ></div>
          </div>
        </div>
      </div>
      <!-- -->
      ...
      <div class="valve_out_wrap fL"  >
        <div class="valve_out_wrap2 fL" style="height: 30%; padding-top: 155px;">
          유출유량
