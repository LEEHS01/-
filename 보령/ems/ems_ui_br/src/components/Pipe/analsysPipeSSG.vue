<template>
  <!-- pipe -->
  <div class="cheongyang" style="height: 60%; margin-top: 0px;">
    <div class="pipe_name fL" style="height: 43%;">
      <span>{{ name }}</span>
    ...
    <div class="pipe_wrap fL">
        <div class="pipe_con fL" style="padding-top: 3px;">
    ...
    <div class="pipe_center_wrap fL" style="padding-top: 5px;">
      <div class="pipe_center_top fL">
        <div v-if="dataList.openRate0" class="valve_on fL" style="padding-top: 15px;"></div>
        ...
        <div class="pipe_line fL" style="padding-top: 15px;">
          <div v-if="dataList.openRate0" class="pipe_line_arrow blinking" style="height: 60%;" ></div>
        </div>
      </div>
      ...
      <div class="pipe_center_top fL">
        <div v-if="dataList.openRate2" class="valve_on fL"></div>
        ...
        <div class="pipe_line fL" >
          <div v-if="dataList.openRate2" class="pipe_line_arrow blinking" ></div>
        </div>
      </div>
      <div class="pipe_center_top fL">
    ...
    <div class="tank_wrap fL">
        ...
        <div class="pipe_last_wrap  fL">
          <div class="water_wrap" >
            ...
            <div style="height: 20%"></div>
            <!-- <div class="input_box input_water_bottom fL" ><span class="input_value" >{{ dataList.waterLevel3 }}</span> m</div> -->
          </div>
        </div>
        <!-- <div class="pipe_last_wrap  fL">
          <div class="water_wrap" style="justify-content: center;" >
            <div class="input_box input_water_top fL" ><span class="input_value" >{{ dataList.waterLevel4 }}</span>m</div>
          </div>
        </div> -->
    </div>
...
.valve_out_wrap {
  ...
  .valve_out_wrap2 {
    width: 87%; height: 20%;margin-left: -3%;
  }
  .pipe_last {
    width: 130%;
    margin: 0 0 0 -12%;
