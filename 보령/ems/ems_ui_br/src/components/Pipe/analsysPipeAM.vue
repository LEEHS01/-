<template>
    <!-- pipe -->
    <div class="bongdam">
      <div class="pipe_name fL" style="text-align: center; height: 142%;">
        <span>{{ name }}</span>
        <!-- <span class="input_value_rate" style="margin: 0;">{{dataList.minPipePressure }}</span> -->
      </div>

        <!-- pipe -->
      <div class="pipe_first_wrap fL" style="height: 142%;">
      ...
      <div class="pipe_wrap fL">
          <div class="pipe_con fL">
            <div class="pipe_first fL" ></div>
            <div class="pipeline_un_y" style="margin-top: 105px;"></div>
      ...
      <div class="pipe_center_wrap fL">
        <div class="pipe_center_top fL" style="padding-top: 52px;">
        ...
        <div class="pipe_center_bottom fL" style="padding-top: 55px;">
      ...
      <div class="pipe_last_wrap fL" style=" width: 20%; height: 140%;" >
...
export default {
  ...
  .pipe_last_wrap {
    ...
    .pipe_last_wrap2 {
      width: 87%; height: 0%;margin-left: -3%;
    }
    .pipe_last {
      width: 130%;
      margin: 0 0 0 -12%;
