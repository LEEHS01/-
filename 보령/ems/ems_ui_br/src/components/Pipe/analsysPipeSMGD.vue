<template>
    ...
    <div class="bongdam">
      ...
      <div class="pipe_center_wrap fL">
        ...
        <div class="pipe_center_top fL" style="padding-top: 30px;">
      ...
      <div class="tank_wrap fL">
          ...
          <div class="pipe_last_wrap  fL">
            <div class="water_wrap" style="background-position:top; justify-content:center;" >
              <div class="input_box input_water_top fL" ><span class="input_value">{{ dataList.waterLevel2 }}</span>m</div>
            </div>
          </div>
      </div>

      <div class="pipe_last_wrap fL" style=" width: 20%; height: 120%;" >
