<template>
  <!-- pipe -->
  <div class="cheongyang" style="height: 75%; margin-top: 100px;">
    <div class="pipe_name fL" style="height: 80%;">
      <span>{{ name }}</span>
      <!-- <span class="input_value_rate" style="margin: 0;">{{ dataList.minPipePressure }}</span> -->
    </div>

      <!-- pipe -->
    <div class="pipe_first_wrap fL" style="height: 80%;">
    ...
    <div class="valve_wrap">

    </div>

    <div class="pipe_center_wrap fL" style="padding-top: 5px;">
      <div class="pipe_center_top fL">
        <div v-if="dataList.openRate1" class="valve_on fL" style="padding-top: 15px;"></div>
        <div v-else class="valve_off fL" style="padding-top: 15px;"></div>
        <div class="input_box input_box_rate fL" ><span class="input_value_rate" >{{dataList.openRate1}}</span>%</div>
        <div class="pipe_line fL" style="padding-top: 15px;">
          <div v-if="dataList.openRate1" class="pipe_line_arrow blinking" style="height: 60%;" ></div>
        </div>
      </div>
      <!-- <ValveComponent :openRate="OpenRates"/> -->
      <div class="pipe_center_top fL">
        <div v-if="dataList.openRate2" class="valve_on fL" style="padding-top: 15px;"></div>
        <div v-else class="valve_off fL" style="padding-top: 15px;"></div>
        <div class="input_box input_box_rate fL" ><span class="input_value_rate" >{{dataList.openRate2}}</span>%</div>
        <div class="pipe_line fL" style="padding-top: 15px;" >
          <div v-if="dataList.openRate2" class="pipe_line_arrow blinking" style="height: 60%;"></div>
        </div>
      </div>
      <div class="pipe_center_top fL">
        <div v-if="dataList.openRate3" class="valve_on fL"></div>
        <div v-else class="valve_off fL"></div>
        <div class="input_box input_box_rate fL" ><span class="input_value_rate" >{{dataList.openRate3}}</span>%</div>
        <div class="pipe_line fL" >
          <div v-if="dataList.openRate3" class="pipe_line_arrow blinking" ></div>
        </div>
      </div>
      <div class="pipe_center_top fL">
        <div v-if="dataList.openRate4" class="valve_on fL"></div>
        <div v-else class="valve_off fL"></div>
        <div class="input_box input_box_rate fL" ><span class="input_value_rate" >{{dataList.openRate4}}</span>%</div>
        <div class="pipe_line fL" >
          <div v-if="dataList.openRate4" class="pipe_line_arrow blinking" ></div>
        </div>
      </div>
      <div class="pipe_center_top fL">
      ...
      <!-- <div class="pipe_center_top fL">
        <div v-if="dataList.openRate5" class="valve_on fL"></div>
        <div v-else class="valve_off fL" ></div>
        <div class="input_box input_box_rate fL" ><span class="input_value_rate" >{{dataList.openRate5}}</span>%</div>
        <div class="pipe_line fL" >
          <div v-if="dataList.openRate5" class="pipe_line_arrow blinking" ></div>
        </div>
      </div> -->
    </div>
    <!-- -->
    <div class="tank_wrap fL">
        <div class="pipe_last_wrap  fL">
          <div class="water_wrap" >
            <div class="input_box input_water_top fL" ><span class="input_value" >{{ dataList.waterLevel1 }}</span>m</div>
            <div class="input_box input_water_bottom fL" ><span class="input_value" >{{ dataList.waterLevel2 }}</span> m</div>
          </div>
        </div>
        <div class="pipe_last_wrap  fL">
          <div class="water_wrap" >
            <div class="input_box input_water_top fL" ><span class="input_value" >{{ dataList.waterLevel3 }}</span>m</div>
            <div class="input_box input_water_bottom fL" ><span class="input_value" >{{ dataList.waterLevel4 }}</span> m</div>
          </div>
        </div>
        <div class="pipe_last_wrap  fL">
          <div class="water_wrap" style="justify-content: center;" >
    ...
    <div class="valve_out_wrap fL"  >
      <div class="valve_out_wrap2"  style="margin-top: 200px;">
        유출유량1
      ...
      <div class="valve_out_wrap2" >
        유출유량2
        <div class="input_box bm10 fL" ><span class="input_value">{{ dataList.pipeValueOut1 }}</span> m3/h</div>
        <div class=" pipe_last fL">
          <div class="pipe_last_arrow blinking"></div>
        </div>
      </div>
...
export default ({
  ...
  setup (props) {
    ...
    const updateData = (data) => {
      ...
      dataList.pipeValueOut1 = data[2].유출유량 !== null ? fixed(data[2].유출유량) : 0.00
...
/* 벨브 색상 */
.valve_on {
  width: 50%; height: 100%; text-align: center; background: url("@/assets/img/analysis/03_2_valve_active.png") no-repeat; background-position: center; background-size: 100%; margin-left: 0%;
}
.valve_off {
  width: 50%; height: 100%; text-align: center; background: url("@/assets/img/analysis/03_2_valve_active.png") no-repeat; background-position: center; background-size: 100%; margin-left: 0%;
}
