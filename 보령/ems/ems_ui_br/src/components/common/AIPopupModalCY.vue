          ...
          <div class="k-window" style="padding-top: 0px;min-width: 90px; min-height: 50px;width: 1100px;height: 650px;">
            <div style="padding: 60px 45px; height: 100%; width: 100%; box-sizing: border-box;">
              <div style="height: 85%; width: 100%; ">
                <div class="popup__title" style="font-size: 18px;">청양 현재 운영</div>
                <!--  운영 펌프 영역 시작 -->
                <div class="fL" style="width: 100%;height: 30%;">
                  <div class="" style="width: 100%;height:100%;text-align: center;font-size: 20px;color: #fff;">
                    <div class=" fL" style="height: 100%; width: 100%;">
                      <div class="fL" style="height: 100%; width: 100%; margin-left: 4px; display: flex; justify-content: center;">
                        <div class="fL pump_area_w4" style="display: flex; flex-direction: column;">
                            <div class="pop_pump_img flex_center fL" :style="{ backgroundSize: '50%', opacity: getOpacityValue(nowPumpStatusA[0]), width:'100%' , height:'100%' }"> #1</div>
                            <div class="fL" style="background-size: 80%; width: 100%; display: flex; align-items: center; justify-content: center; font-size: 18px;">
								              <span v-show="getOpacityValue(nowPumpStatusA[0]) === 1" class="input_design" id="aiFreqA1" style="margin-right: 10px; height: 100%;">{{ aiFreqA1 }}</span>
                              <span v-show="getOpacityValue(nowPumpStatusA[0]) === 0.25" class="input_design" id="aiFreqA1" style="margin-right: 10px; height: 100%;">0.00</span>Hz
							              </div>
                        </div>
                        <div class="fL pump_area_w4" style="display: flex; flex-direction: column;">
                            <div class="pop_pump_img flex_center fL" :style="{ backgroundSize: '50%', opacity: getOpacityValue(nowPumpStatusA[1]), width:'100%' , height:'100%' }"> #2</div>
                            <div class="fL" style="background-size: 80%; width: 100%; display: flex; align-items: center; justify-content: center; font-size: 18px;">
								              <span v-show="getOpacityValue(nowPumpStatusA[1]) === 1" class="input_design" id="aiFreqA2" style="margin-right: 10px; height: 100%;">{{ aiFreqA2 }}</span>
                              <span v-show="getOpacityValue(nowPumpStatusA[1]) === 0.25" class="input_design" id="aiFreqA3" style="margin-right: 10px; height: 100%;">0.00</span>Hz
							              </div>
                        </div>
                        <div class="fL pump_area_w4" style="display: flex; flex-direction: column;">
                            <div class="pop_pump_img flex_center fL" :style="{ backgroundSize: '50%', opacity: getOpacityValue(nowPumpStatusA[2]), width:'100%' , height:'100%' }"> #3</div>
                            <div class="fL" style="background-size: 80%; width: 100%; display: flex; align-items: center; justify-content: center; font-size: 18px;">
								              <span v-show="getOpacityValue(nowPumpStatusA[2]) === 1" class="input_design" id="aiFreqA3" style="margin-right: 10px; height: 100%;">{{ aiFreqA3 }}</span>
                              <span v-show="getOpacityValue(nowPumpStatusA[2]) === 0.25" class="input_design" id="aiFreqA3" style="margin-right: 10px; height: 100%;">0.00</span>Hz
							              </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="popup__title" style="font-size: 18px;">청양 AI 분석</div>
                <!-- AI 펌프 영역 시작 -->
                <div class="fL" style="width: 100%;height: 30%;">
                  <div class="" style="width: 100%;height:100%;text-align: center;font-size: 20px;color: #fff;">
                    <div class=" fL" style="height: 100%; width: 100%;">
                      <div class="fL" style="height: 100%; width: 100%; margin-left: 4px; display: flex; justify-content: center;">
                        <div class="fL pump_area_w4" style="display: flex; flex-direction: column;">
                            <div class="pop_pump_img flex_center fL" :style="{ backgroundSize: '50%', opacity: getOpacityValue(pumpStatusA[0]), width:'100%' , height:'100%' }"> #1</div>
                            <div class="fL" style="background-size: 80%; width: 100%; display: flex; align-items: center; justify-content: center; font-size: 18px;">
								              <span class="input_design" id="freqA1" style="margin-right: 10px; height: 100%;">{{ freqA1 }}</span>Hz
							              </div>
                        </div>
                        <div class="fL pump_area_w4" style="display: flex; flex-direction: column;">
                            <div class="pop_pump_img flex_center fL" :style="{ backgroundSize: '50%', opacity: getOpacityValue(pumpStatusA[1]), width:'100%' , height:'100%' }"> #2</div>
                            <div class="fL" style="background-size: 80%; width: 100%; display: flex; align-items: center; justify-content: center; font-size: 18px;">
								              <span class="input_design" id="freqA2" style="margin-right: 10px; height: 100%;">{{ freqA2 }}</span>Hz
							              </div>
                        </div>
                        <div class="fL pump_area_w4" style="display: flex; flex-direction: column;">
                            <div class="pop_pump_img flex_center fL" :style="{ backgroundSize: '50%', opacity: getOpacityValue(pumpStatusA[2]), width:'100%' , height:'100%' }"> #3</div>
                            <div class="fL" style="background-size: 80%; width: 100%; display: flex; align-items: center; justify-content: center; font-size: 18px;">
								              <span class="input_design" id="freqA3" style="margin-right: 10px; height: 100%;">{{ freqA3 }}</span>Hz
							              </div>
                        </div>
                      </div>
                    </div>
  ...
  setup () {
    ...
    const getData = async () => {
      try {
        ...
        if (songsuSelect.value) {
          ...
          if (arr.data2 && arr.data2.length > 0) {
            if (arr.data2[0].펌프1가동상태운영_청양 === null) {
    ...
    const leftmappingHtml = (data2) => {
      try {
        ...
        insertPumpVal(aiFlowA, Number(data2[0].청양관압).toFixed(2))
    ...
    const getAiPopup = async () => {
      ...
      try {
        ...
        // 현재 시간과의 차이 계산
        const diffTime1 = convertDiffTimeToMinutes(arr.data['606-459-EMS-1901'].DIFF_TIME)
        // 청양 AI 추천(반자동) 모드
        if (arr.data['606-459-EMS-1001'].value && arr.data['606-459-EMS-1003'].value) {
          if (parseInt(arr.data['606-459-EMS-1901'].UPDT_TIME_MINUTES) % 15 === 2 && diffTime1 < 10 && arr.data['606-459-EMS-1901'].value) {
            clearInterval(timer)
            let count = 60
        ...
        // 청양 AI (자동)모드
        else if (arr.data['606-459-EMS-1001'].value && arr.data['606-459-EMS-1002'].value) {
          if (parseInt(arr.data['606-459-EMS-1901'].UPDT_TIME_MINUTES) % 15 === 2 && diffTime1 < 10 && arr.data['606-459-EMS-1901'].value) {
            console.log('청양 AI 자동 모드')
            autoPTR()
          } else {
            console.log('time issue!!!!')
          }
    ...
    const autoPTR = async () => {
      ...
      try {
        ...
        await store.dispatch('songsu/fetchInsertPopupAuto2', {
          search: '0',
          local: 'Cheongyang',
          updt_time: ptrCtrInf.value.data['606-459-EMS-1901'].UPDT_TIME,
          ai_info: [
            { tag: '606-459-EMS-1001', value: '1' },
            { tag: '606-459-EMS-1002', value: '1' },
            { tag: '606-459-EMS-1003', value: '0' },
            { tag: '606-459-EMS-1004', value: '0' }
          ],
          flag: '3'
        }
        )
    ...
    const cancelPTR = async () => {
      ...
      try {
        ...
        await store.dispatch('songsu/fetchInsertPopup2', {
          ...
          ai_info: [
            { tag: '606-459-EMS-1001', value: '1' },
            { tag: '606-459-EMS-1002', value: '0' },
            { tag: '606-459-EMS-1003', value: '1' },
            { tag: '606-459-EMS-1004', value: '0' }
          ],
          flag: '1'
        }
    ...
    const updatePTR = async () => {
      ...
      try {
        ...
        await store.dispatch('songsu/fetchInsertPopup2', {
          search: '1',
          local: 'Cheongyang',
          updt_time: arr.data['606-459-EMS-1901'].UPDT_TIME,
          ai_info: [
            { tag: '606-459-EMS-1001', value: '1' },
            { tag: '606-459-EMS-1002', value: '0' },
            { tag: '606-459-EMS-1003', value: '1' },
            { tag: '606-459-EMS-1004', value: '1' }
          ],
          flag: '2'
        }
        )
