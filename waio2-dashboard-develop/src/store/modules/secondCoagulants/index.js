...
export const GET_COAGULANTS_CLUSTER = 'secondCoagulants/cluster/get'
export const GET_COAGULANTS_RAWWATER = 'secondCoagulants/rawwater/get'
export const PUT_COAGULANTS_RAWWATER = 'secondCoagulants/rawwater/put'
export const PUT_SECONDCOAGULANTS_CONTROL_OPERATION = 'secondCoagulants/control/operation' + '/put'
export const GET_COAGULANT_LATEST = 'secondCoagulants/get'
...
export const PUT_COAGULANT_CONTROL_AI = 'secondCoagulants/control/ai/put'
export const PUT_COAGULANT_CONTROL_USER_CORRECT = 'secondCoagulants/control/userCorrect' + '/put'
...
const PUT_CONTROL_OPERATION = PUT_SECONDCOAGULANTS_CONTROL_OPERATION.substr(PUT_SECONDCOAGULANTS_CONTROL_OPERATION.indexOf('/') + 1)
