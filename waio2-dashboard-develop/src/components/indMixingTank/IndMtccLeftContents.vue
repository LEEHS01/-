  ...
  <div class="main">
    ...
    <div class="contents-img">
      ...
      <div class="select-box">
          <div v-for="index in [1,2,3,4,5,6,7,8]" :key="index" class="select-box__element" @click="$store.state.indMixing.selectedFCLocation = index" :class="{ 'select-box__element--focused': $store.state.indMixing.selectedFCLocation === index}"><span>{{ index }}지</span></div>
      </div>
      ...
      <div class="contents-img-box three">
        <div class="contents-img-box__num">{{ this.getFCLocationSpeed(this.$store.state.indMixing.selectedFCLocation).step3['1'] | numFormat('0') }}</div>
        <div class="contents-img-box__text">Hz</div>
      </div>
    </div>
    <!-- 계열별 지 운영 상태 -->
...
.main{
  ...
  .contents-img{
    width: 600px;
    height: 310px;
    background-image: url('../../assets/cj_images/sub_03.png');
