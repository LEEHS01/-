    ...
    <div class="popup-main">
      <div class="popup-contents">
        ...
        <div class="top">
          ...
          <div class="top__title">2단계 침전 세부 현황</div>
        ...
        <div class="contents">
          <div class="contents-value">
            ...
            <div class="contents-value__box">
              <div class="box-text">{{ this.$store.state.sedimentation.latest.c_cf_coagulant }}</div>
            </div>
            <div class="contents-value__text">약품 사용량</div>
            <div class="contents-value__box">
              <div class="box-text width50">{{ this.$store.state.sedimentation.popup.location.c_mm_fr | numFormat('0.00') }}</div>
          ...
          <div class="contents-img">
            ...
            <div class="line two">
              ...
              <div class="line__status" :class="[ this.$store.state.sedimentation.popup.location.e_drawing_vv_5 === 1 ? 'on' : 'off']"></div>
            </div>
            <div class="line one">
              <div class="line__num">#6</div>
              <div class="line__status" :class="[ this.$store.state.sedimentation.popup.location.e_drawing_vv_6 === 1 ? 'on' : 'off']"></div>
            </div>
...
methods: {
  getFVal: function(){
    let calculate = (70 + (this.$store.state.sedimentation.popup.location.e_sc_f * this.popupScDividedValue))
    if(calculate > 500){
      calculate = 500
  ...
  getBVal: function(){
    let calculate = (this.$store.state.sedimentation.popup.location.e_sc_b * this.popupScDividedValue)
    if(calculate > 430){
      calculate = 430
    }else if(calculate < 0){
      calculate = 0
