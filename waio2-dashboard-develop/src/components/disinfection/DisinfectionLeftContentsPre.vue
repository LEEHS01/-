<template>
  <div class="main">
    ...
    <div class="btn-tab">
      <div :class="[this.$store.state.selectedBuildingIndex == 24 ? 'btn-tab__box-abled' : 'btn-tab__box-disabled']" @click="$routingByIndex(24)">1단계공업</div>
    ...
    <div class="contents-wrap">
      <div class="contents-value">
        ...
        <div class="contents-value__row">
          <div class="contents-value__title" style="width: 160px;">목표 침전지 잔류염소 대비<br/>잔류염소 허용 편차</div>
