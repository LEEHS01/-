<template>
  <div class="main">
      ...
      <div class="one-contents">
        ...
        <div class="big-contents">
          <div class="contents-value">
            ...
            <div class="value-container">
              <div class="value-container__one">· 여과지 유출유량(m<sup>3</sup>/h)</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.f1_out_fr | numFormat('0,0') }}</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.f2_out_fr | numFormat('0,0') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 정수지 유입 잔류염소(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_h_in_1_residual_cl | numFormat('0.00') }}</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_h_in_2_residual_cl | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 여과지 유출 잔류염소(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_f_out_1_residual_cl | numFormat('0.00') }}</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_f_out_2_residual_cl | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_post_1_chol_rate | numFormat('0.00') }}</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_post_2_chol_rate | numFormat('0.00') }}</div>
            </div>
          </div>
        </div>
      </div>
       <div class="two-contents">
        ...
        <div class="small-contents">
          ...
          <div class="small-contents-value">
            <div class="small-contents-value__title">1계열 {{ getPumpRun1 }}</div>
            <div class="value">
              <div class="value__num">{{ this.$store.state.disinfection.latest.ai_g_1_correct_degree | numFormat('0.00') }}</div>
              <div class="value__unit">ppm</div>
            </div>
            <div class="contents-value-underbar"></div>
            <div class="small-contents-value__title margintop">2계열 {{ getPumpRun2 }}</div>
            <div class="value">
              <div class="value__num">{{ this.$store.state.disinfection.latest.ai_g_2_correct_degree | numFormat('0.00') }}</div>
              <div class="value__unit">ppm</div>
            </div>
            <div class="contents-value-underbar"></div>
          </div>
      ...
      <div class="three-contents">
        ...
        <div class="three-small-contents">
          ...
          <div class="three-small-contents-value">
            <div class="three-small-contents-value__title">1계열 {{ getPumpRun1 }}</div>
            <div class="real-box real-one">
              <div class="real-text">현재 주입률</div>
              <div class="real-value">{{ this.$store.state.disinfection.latest.g_post_1_chol_rate | numFormat('0.00') }}</div>
            </div> 
            <div class="three-value">
              <div class="three-value__num">{{ this.$store.state.disinfection.latest.ai_g_1_chol_rate | numFormat('0.00') }}</div>
              <div class="three-value__unit">ppm</div>
            </div>
            <div class="three-contents-value-underbar"></div>
            <div class="three-small-contents-value__title margintop">2계열 {{ getPumpRun2 }}</div>
            <div class="real-box real-two">
              <div class="real-text">현재 주입률</div>
              <div class="real-value">{{ this.$store.state.disinfection.latest.g_post_2_chol_rate | numFormat('0.00') }}</div>
            </div> 
            <div class="three-value">
              <div class="three-value__num">{{ this.$store.state.disinfection.latest.ai_g_2_chol_rate | numFormat('0.00') }}</div>
              <div class="three-value__unit">ppm</div>
            </div>
            <div class="three-contents-value-underbar"></div>
          </div>
    ...
    <div class="bottom-contents">
      <div class="contents">
        <div class="contents__title">후차염 주입률 보정값 예측
        </div>
      ...
      <div class="contents paddingleft">
        <div class="contents__title">정수지 유입 잔류염소</div>        
        <div class="real-box real-three">
          <div class="real-text">현재 잔류염소</div>
          <div class="real-text__title">1계열 : </div>
          <div class="real-value">{{ this.$store.state.disinfection.latest.g_h_in_1_residual_cl | numFormat('0.00') }}</div>
          <div class="real-text__title">2계열 : </div>
          <div class="real-value">{{ this.$store.state.disinfection.latest.g_h_in_2_residual_cl | numFormat('0.00') }}</div>
        </div>  
        <div class="contents-gragh">
...
export default {
  ...
  computed: {
    getPumpRun1: function() {
      let pumpRun = ''
      if(this.$store.state.disinfection.latest.g_1_pump_1_run == 1) pumpRun += '펌프1'
      if(this.$store.state.disinfection.latest.g_1_pump_2_run == 1) pumpRun += '펌프2'
      return pumpRun
    },
    getPumpRun2: function() {
      let pumpRun = ''
      if(this.$store.state.disinfection.latest.g_2_pump_1_run == 1) pumpRun += '펌프1'
      if(this.$store.state.disinfection.latest.g_2_pump_2_run == 1) pumpRun += '펌프2'
      return pumpRun
    },
    ChartOptionCholRate: function () {
      ...
      chart.series = []
      if(this.$store.state.disinfection.cholrateTrend.series1 !== undefined) {
        if (this.$store.state.disinfection.cholrateTrend.series1 !== null && Object.keys(this.$store.state.disinfection.cholrateTrend.series1).length > 0) {
          let dataSeries = []
          for (let key in this.$store.state.disinfection.cholrateTrend.series1) {
            dataSeries.push([new Date(key).getTime(), this.$store.state.disinfection.cholrateTrend.series1[key]])
          }
          chart.series.push({
            name: '1계열',
            data: dataSeries,
      ...
      if(this.$store.state.disinfection.cholrateTrend.series2 !== undefined) {
        if (this.$store.state.disinfection.cholrateTrend.series2 !== null && Object.keys(this.$store.state.disinfection.cholrateTrend.series2).length > 0) {
          let dataSeries = []
          for (let key in this.$store.state.disinfection.cholrateTrend.series2) {
            dataSeries.push([new Date(key).getTime(), this.$store.state.disinfection.cholrateTrend.series2[key]])
          }
          chart.series.push({
            name: '2계열',
            data: dataSeries,
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_후차염 주입률 보정값 예측 트렌드'
      return chart
    },
    ...
    ChartOptionCl: function () {
      ...
      chart.series = []
      if (this.$store.state.disinfection.residualTrend.series1 !== null && Object.keys(this.$store.state.disinfection.residualTrend.series1).length > 0) {
        let dataSeries = []
        for (let key in this.$store.state.disinfection.residualTrend.series1) {
          dataSeries.push([new Date(key).getTime(), this.$store.state.disinfection.residualTrend.series1[key]])
        }
        chart.series.push({
          name: '1계열',
          data: dataSeries,
      ...
      if (this.$store.state.disinfection.residualTrend.series2 !== null && Object.keys(this.$store.state.disinfection.residualTrend.series2).length > 0) {
        let dataSeries = []
        for (let key in this.$store.state.disinfection.residualTrend.series2) {
          dataSeries.push([new Date(key).getTime(), this.$store.state.disinfection.residualTrend.series2[key]])
        }
        chart.series.push({
          name: '2계열',
          data: dataSeries,
      ...
      // chart.yAxis.min = 0.7
      // chart.yAxis.max = 1.3
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_정수지 유입 잔류염소 트렌드'
      return chart
    }
  },
  ...
  methods: {
    downloadExcel: function() {
      ...
      for (let i = 0; i < Object.keys(eva).length; i++) {
        ...
        excelLogs.주입률 = eva['series' + (i + 1)][eva_obj]
      ...
      XLSX.writeFile(wb, `${this.$moment().format('YYYYMMDDHHmmss')}_차염 주입률 예측 비교 트렌드.xlsx`);
    }
  },
