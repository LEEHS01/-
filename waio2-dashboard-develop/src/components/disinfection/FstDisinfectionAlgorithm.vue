  ...
  <div class="main">
        ...
        <div class="right-contents">
          ...
          <div class="right-contents__btn-first">
            <div v-if="this.$store.state.disinfection.selectedDisinfectionIndex === 1" class="control_box_operation">
              ...
              <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7.1, 2, 'pre')">AI</div>
              ...
              <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7.1, 1, 'pre')">AI추천</div>
              ...
              <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7.1, 0, 'pre')">AI분석</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="contents">
      <div class="contents__left">
        <DisinfectionLeftContentsPre :processTitle="this.processTitle" />
      </div>
      <div class="contents__right">
        <DisinfectionRightContentsPre :processTitle="this.processTitle" />
      </div>
    </div>
  </div>  
</template>
...
export default {
  ...
  methods: {
    ...
    dataDetail: function() {
      ...
      this.processTitle = '생활'
      let obj = { selectedDisinfectionIndex : 1, processStep : 2 }
