        ...
        <div class="big-contents">
          <div class="contents-value">
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_e_1_residual_cl | numFormat('0.00') }}</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_e_2_residual_cl | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
      ...
      <div class="three-contents">
        ...
        <div class="three-small-contents">
          ...
          <div class="real-box real-two">
            ...
            <div class="real-value">{{ this.$store.state.disinfection.latest.g_pre1_chlorination | numFormat('0.00') }}</div>
          </div> 
    ...
    <div class="bottom-contents">
      ...
      <div class="contents paddingleft">
        ...
        <div class="real-box real-three">
          ...
          <div class="real-value">{{ this.$store.state.disinfection.latest.g_e_1_residual_cl | numFormat('0.00') }}</div>
          <div class="real-text__title">2계열 : </div>
          <div class="real-value">{{ this.$store.state.disinfection.latest.g_e_2_residual_cl | numFormat('0.00') }}</div>
        </div>   
        <div class="contents-gragh">
...
export default {
  ...
  computed: {
    ...
    ChartOptionEvaporation: function () {
      ...
      // console.log(this.$store.state.disinfection.pre_evaporation)
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_차염 증발량 예측 비교'
