          ...
          <div class="one-contents">
            ...
            <div class="big-contents">
              <div class="contents-value">
                ...
                <!-- <div class="value-container">
                  <div class="value-container__one">· 동점성 계수</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.d_ki_dv }}</div>
                  <div class="value-container__three">m2/sec</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 패들면적</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.d_anr | numFormat('0.00') }}</div>
                  <div class="value-container__three">m<sup>2</sup></div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 조 체적</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.d_v | numFormat('0.00') }}</div>
                  <div class="value-container__three">m<sup>3</sup></div>
                </div> -->
                <div class="value-container">
                  <div class="value-container__one">· 침전지 탁도</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.d_tb_e | numFormat('0.00') }}</div>
