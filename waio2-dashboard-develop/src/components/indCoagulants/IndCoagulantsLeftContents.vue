<template>
  <div class="main">
    <div class="btn-tab">
        <div class="btn-tab__box-abled box-center-margin">1단계공업</div>
        <div class="btn-tab__box-disabled box-center-margin" @click="$routingByIndex(19)">2단계생활</div>
    </div>
    ...
    <p class="unit-title unit-one">1호기</p>
      ...
      <!-- <div v-if="this.$store.state.indCoagulants.latest.c1_mm_fr < 1">
      </div> -->
      <div class="one-line-v3">
        <div class="buble-v delay1"></div>
        <div class="buble-v delay2"></div>
      </div>
      <!-- <div v-if="this.$store.state.indCoagulants.latest.c2_mm_fr < 1">
      </div> -->
      ...
      <div class="line-box-top">
        ...
        :items="this.$store.state.indCoagulants.coagulantType" v-model="$store.state.indCoagulants.latestModify.c_cf_coagulant" :disabled="this.$store.state.login.user.tkn == null">
        </v-select>
...
<script>
import { PUT_COAGULANT_CONTROL_AI } from '@/store/modules/indCoagulants'
export default {
  computed: {
  ...
  methods: {
    updateCfControl: function(){
      this.$store.dispatch(PUT_COAGULANT_CONTROL_AI, this.$store.state.indCoagulants.latestModify.c_cf_coagulant)
    }
  }
}
</script>
