  ...
  <div class="chart-container">
    ...
    <div class="chart-contents marginleft10">
      <div class="chart-title">
        <div class="chart-title__text">필요원수 유입유량</div>
      </div>
      <div class="chart">
    ...
    <div class="chart-contents marginleft10">
      <div class="chart-title">
        <div class="chart-title__text">원형수조 수위 밴드</div>
...
export default {
  ...
  computed: {
    ...
    ChartReceivingWaterFlow: function () {
      ...
      chart.series = []
      if (this.$store.state.trtIndReceiving.latest.ai_b_out_fr_rtd !== null) {
        let dataSeries1 = []
        for (let key in this.$store.state.trtIndReceiving.latest.ai_b_out_fr_rtd) {
          dataSeries1.push([new Date(key).getTime(), parseInt(this.$store.state.trtIndReceiving.latest.ai_b_out_fr_rtd[key])])
        }
        chart.series.push({
          name: '정수지 유출 유량',
          data: dataSeries1,
      ...
      // if (this.$store.state.indReceiving.out_fr.series1 !== null) {
      //   let dataSeries1 = []
      //   for (let key in this.$store.state.indReceiving.out_fr.series1) {
      //     dataSeries1.push([new Date(key).getTime(), this.$store.state.indReceiving.out_fr.series1[key]])
      //   }
      //   chart.series.push({
      //     name: '착수정 유출 유량',
      //     data: dataSeries1,
      ...
      //   })
      // }
      /*if (this.$store.state.indReceiving.out_fr.series2 !== null) {
        let dataSeries2 = []
        for (let key in this.$store.state.indReceiving.out_fr.series1) {
          dataSeries2.push([new Date(key).getTime(), this.$store.state.indReceiving.out_fr.series2[key]])
        }
        chart.series.push({
          name: '2계열',
          data: dataSeries2,
    ...
    ChartClearWaterLevel: function () {
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_원형수조 수위 밴드'
    ...
    ChartDataClearLevelFromLocation: function () {
      ...
      && Object.keys(this.$store.state.clear.le['location' + this.selectedLocation]).length > 0) {
        for (let key in this.$store.state.clear.le['location' + this.selectedLocation]) {
          // data.push([new Date(key).getTime(), parseFloat(this.$store.state.clear.le['location' + this.selectedLocation][key])])
    ...
    ChartRawWaterFlow: function () {
      ...
      chart.series = []
      if (this.$store.state.trtIndReceiving.latest.ai_b_in_fr_rtd !== null && Object.keys(this.$store.state.trtIndReceiving.latest.ai_b_in_fr_rtd).length > 0) {
        let dataSeries1 = []
        for (let key in this.$store.state.trtIndReceiving.latest.ai_b_in_fr_rtd) {
          dataSeries1.push([new Date(key).getTime(), parseInt(this.$store.state.trtIndReceiving.latest.ai_b_in_fr_rtd[key])])
        }
        chart.series.push({
          name: '필요원수 유입 유량',
          data: dataSeries1,
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_필요원수 유입 유량 예측'
