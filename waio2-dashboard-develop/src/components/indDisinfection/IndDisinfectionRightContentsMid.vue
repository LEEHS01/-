        ...
        <div class="big-contents">
          <div class="contents-value">
            ...
            <!-- <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.e_ser_cl | numFormat('0.00') }}</div>
            </div> -->
            <div class="value-container">
      ...
      <div class="three-contents">
        ...
        <div class="three-small-contents">
          ...
          <div class="three-small-contents-value">
            <div class="three-small-contents-value__title">{{ this.processTitle }}차염</div>
    ...
    <div class="bottom-contents">
      <div class="contents">
        <div class="contents__title">
          {{this.processTitle}}차염 주입률 예측 비교 트렌드
        </div>
      ...
      <div class="contents paddingleft">
        <div class="contents__title">여과지 유출 잔류염소 트렌드</div>
        <div class="contents-gragh">
...
export default {
  ...
  computed: {
    ChartOptionCholRate: function () {
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_차염 주입률 예측 트렌드'
      return chart
    },
    ChartOptionCl: function () {
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '여과지 유출 잔류염소 트렌드'
      return chart
    }
  },
  methods: {
    ...
    //     this.chartOptionCorrected.title.text = '차염 주입률 보정값 예측 트렌드'
