<template>
  <div class="main">
    ...
    <!-- Top 제목, 운전모드 -->
    <div class="top">
      <div class="title">2단계혼화응집 <p>세부 현황</p></div>
      <div class="right">
       ...
       <!-- g값 상/하한 -->
        <div class="g-value">
          ...
          <div class="g-value__num">
            ...
            <div class="g-value__input-box">
              <input v-if="this.$store.state.mixing.isGLimitModifyMode" type="text" :value="this.$store.state.mixing.latestModify.d_g_step3_max" v-on:input="updateInput($event, 'd_g_step3_max')">
              <span v-else class="g-value__text-num">{{ this.$store.state.mixing.latestModify.d_g_step3_max | numFormat('0.0')}}</span>
            </div>
            <div class="g-value__input-box">
              <input v-if="this.$store.state.mixing.isGLimitModifyMode" type="text" :value="this.$store.state.mixing.latestModify.d_g_step3_min" v-on:input="updateInput($event, 'd_g_step3_min')">
...
export default {
  ...
  mounted: function() {
    ...
    if(this.$store.state.mixing.latest.d_g_value_ctr_flag === 1) {
