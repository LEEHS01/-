<template>
  <div v-if="this.$store.state.indFilter.popup.visible" class="main">
    <div class="popup-main">
      <div class="popup-contents">
        ...
        <div class="information">
          ...
          <div class="top-title">여과 {{ this.$store.state.indFilter.popup.numJi }}지</div>
          <div class="contents-value">
            <div class="contents-value__text">원수 유입 유량</div>
            <div class="contents-value__box">
              <div class="box-text width50" v-html="this.$getNumeralWithCommaAndFontFamily(this.$store.state.indFilter.popup.location.d1_in_fr)"></div>
          ...
          <div class="contents-center">
            <div class="line two">
              <div class="line-value">
                <div class="line-value__num two-value-color">{{ this.$store.getters['indFilter/getAiLocationWaterLevelLater10Minutes'] | numFormat('0.00') }}</div>
            ...
            <div class="line three">
              <div class="line-value">
                <div class="line-value__num three-value-color">{{ this.$store.state.indFilter.popup.location.f_loc_le | numFormat('0.00') }}</div>
            ...
            <div class="box-value">
              ...
              <div class="box-value__box">
                <div class="box-text width50" v-html="this.$getNumeralWithCommaAndFontFamily(this.$store.state.indFilter.popup.location.f_out_fr)"></div>
                <div class="box-unit">m<sup>3</sup>/h</div>
              </div>
            </div>
          </div>
          ...
          <div class="contents-right">
            <div class="contents-text-box">
              ...
              <div class="contents-text-box__value">{{ this.$store.getters['indFilter/getPopupFilterStartTime'] }}</div>
              <div class="contents-text-box__unit"></div>
            </div>
            <div class="contents-text-box">
              <div class="contents-text-box__title">· 여과 종료 시점</div>
              <div class="contents-text-box__value">{{ this.$store.getters['indFilter/getPopupFilterEndTime'] }}</div>
              <div class="contents-text-box__unit"></div>
            </div>
            <div class="contents-text-box">
              <div class="contents-text-box__title">· 역세 시작 시점</div>
              <div class="contents-text-box__value">{{ this.$store.getters['indFilter/getPopupBWStartTime'] }}</div>
              <div class="contents-text-box__unit"></div>
            </div>
            <div class="contents-liner"></div>
            <div class="contents-text-box">
              <div class="contents-text-box__title">· 현재 수위</div>
              <div class="contents-text-box__value">{{ this.$store.state.indFilter.popup.location.f_loc_le | numFormat('0.00') }}</div>
              <div class="contents-text-box__unit">m</div>
            </div>
            <div class="contents-text-box">
              <div class="contents-text-box__title">· 10분 후 수위</div>
              <div class="contents-text-box__value">{{ this.$store.getters['indFilter/getAiLocationWaterLevelLater10Minutes'] }}</div>
              <div class="contents-text-box__unit">m</div>
            </div>
            <div class="contents-text-box">
              <div class="contents-text-box__title">· 24시간 후 수위</div>
              <div class="contents-text-box__value">{{ this.$store.getters['indFilter/getAiLocationWaterLevelLater24Hours'] }}</div>
              <div class="contents-text-box__unit">m</div>
            </div>
            <div class="contents-liner"></div>
            <div class="contents-text-box">
              <div class="contents-text-box__title">· 탁도</div>
              <div class="contents-text-box__value">{{ this.$store.state.indFilter.popup.location.f_loc_tb | numFormat('0.00') }}</div>
              <div class="contents-text-box__unit">NTU</div>
            </div>
            <div class="contents-text-box">
              <div class="contents-text-box__title">· 여과 지속시간(현재/예측)</div>
              <div class="contents-text-box__value">{{ this.$store.state.indFilter.popup.location.f_loc_ti / 60 | numFormat('0') }} / {{ this.$store.state.indFilter.popup.location.ai_f_loc_ti / 60 | numFormat('0') }}</div>
              <div class="contents-text-box__unit">시간</div>
            </div>
            <div class="contents-text-box">
              <div class="contents-text-box__title">· 역세 대기시간</div>
              <div class="contents-text-box__value">{{ this.$store.state.indFilter.popup.location.f_time_bw_per / 60 | numFormat('0') }}</div>
              <div class="contents-text-box__unit">시간</div>
            </div>
            <div class="contents-text-box">
              <div class="contents-text-box__title">· 여과 속도</div>
              <div class="contents-text-box__value">{{ this.$store.state.indFilter.popup.location.f_sp | numFormat('0.00') }}</div>
        ...
        <div class="chart-container">
          <div class="chart-container__title">{{ this.$store.state.indFilter.popup.numJi }}지 운영 예측</div>
...
<script>
import { CLOSE_POPUP_IND } from '@/store/modules/indFilter'
import { GET_INDFILTER_LOCATION_BY_JI } from '@/store/modules/indFilter'
export default {
name: 'FilterPopup',
data: () => ({
...
computed: {
  ...
  ChartMeter: function () {
    ...
    if (this.$store.state.indFilter.popup.location.ai_f_loc_le !== null && Object.keys(this.$store.state.indFilter.popup.location.ai_f_loc_le).length > 0) {
      let dataSeries = []
      for (let key in this.$store.state.indFilter.popup.location.ai_f_loc_le) {
        let value = this.$store.state.indFilter.popup.location.ai_f_loc_le[key] > 4.0 ? 4.0 : this.$store.state.indFilter.popup.location.ai_f_loc_le[key]
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_운영 예측 차트 ' + this.$store.state.indFilter.popup.numJi + '지'
      return chart
    }
    return chart
  }
...
methods: {
  ...
  closePopup: function () {
    ...
    this.$store.commit('indFilter/' + CLOSE_POPUP_IND)
  },
},
destroyed: function () {
  clearInterval(this.timer)
...
watch: {
  // 팝업 열림/닫힘 값 변화 감지
  '$store.state.indFilter.popup.visible': function (newVal) {
    if (newVal) {
      this.timer = setInterval( () => {
        Promise.all([
          this.$store.dispatch(GET_INDFILTER_LOCATION_BY_JI, { numJi: this.$store.state.indFilter.popup.numJi }),
        ])
      }, 1000 * 60)
    }
  }
