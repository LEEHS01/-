  ...
  <div class="main">
      ...
      <div class="box-container">
        ...
        <div class="box-contents">
          <div class="box-value">
            ...
            <div class="box-value__value">{{ this.$store.state.indFilter.latest.d1_in_fr | numFormat('0,0')}}</div>
            <div class="box-value__unit">m<sup>3</sup>/h</div>
          </div>
          <div class="box-value">
            <div class="box-value__text">· 침전수 탁도</div>
            <div class="box-value__value">{{ this.$store.state.indFilter.latest.e1_tb_b | numFormat('0.00')}}</div>
            <div class="box-value__unit">NTU</div>
          </div>
          <div class="box-value">
            <div class="box-value__text">· 여과속도</div>
            <div class="box-value__value">{{ this.$store.state.indFilter.latest.f_sp | numFormat('0.00')}}</div>
            <div class="box-value__unit">m/day</div>
          </div>
          <div class="box-value">
            <div class="box-value__text">· 여과 유출 유량</div>
            <div class="box-value__value">{{ this.$store.state.indFilter.latest.f_out_fr | numFormat('0,0')}}</div>
            <div class="box-value__unit">m<sup>3</sup>/h</div>
          </div>
        </div>
      </div>
    ...
    <div class="bottom-two">
      ...
      <div class="bottom-box">
        ...
        <div class="bottom-box__title">운영지수<span> {{ this.$store.state.indFilter.latest.ai_f_opr_cnt }}</span> 지</div>
    ...
    <div class="bottom-chart">
      <div class="bottom-chart__title">
        ...
        <div class="bottom-chart__timerbox-outter">
          <div class="timerbox">
            {{ this.$store.state.indFilter.latest.upd_ti | moment('YYYY-MM-DD HH:mm:ss') }}
          </div>
        </div>
      </div>
      <div class="chart-box">
        ...
        <div class="chart-box__chart">
          <IndAILocationChart :selectedLine="this.selectedLine"/>
        </div>
      </div>
    </div>
    <!-- 여과 세부 현황 팝업  -->
...
import FilterSchedulePopup from '@/components/dialog/FilterSchedulePopup'
import IndAILocationChart from '@/components/indFilter/chart/IndAILocationChart'
