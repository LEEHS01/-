  ...
  <div class="main">
    ...
    <div class="bottom-two">
      ...
      <div class="bottom-box">
        ...
        <div class="bottom-box__title">운영지수<span> {{ this.$store.state.filter.latest.ai_f_opr_cnt }}</span> 지</div>
      ...
      <div class="chart-box">
        <div class="chart-box-top">
          ...
          <div class="legend-box">
            ...
            <div class="legend-box__legend legend-box__legend--load-mid">부하시간</div>
