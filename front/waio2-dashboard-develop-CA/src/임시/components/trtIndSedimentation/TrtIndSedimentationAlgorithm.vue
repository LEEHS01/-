...
<script>
import SedimentationContents from '@/components/trtIndSedimentation/TrtIndSedimentationContents' 
import SedimentationHighchart from '@/components/trtIndSedimentation/TrtIndSedimentationHighchart' 
