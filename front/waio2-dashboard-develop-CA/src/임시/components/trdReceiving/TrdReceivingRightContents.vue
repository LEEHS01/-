  ...
  <div class="center-container">
    ...
    <div class="img-contents">
      ...
      <div class="valve-box one-value-position">
        ...
        <div class="box">
          <div class="box__value">{{ this.$store.state.trdReceiving.latest.b1_vv_po | numFormat('0.00') }}</div>
          <div class="box__unit">%</div>
        </div>
      </div>
      <div class="valve-box three-value-position">
        <div class="valve-box__text">여과지 유출 유량</div>
        <div class="box">
          <div class="box__value" v-html="this.$getNumeralWithCommaAndFontFamily(this.$store.state.trdReceiving.latest.b1_out_fr)"></div>
    ...
    <div class="last-container">
        ...
        <div class="first-result-contents">
          <div class="result-value">
            <div class="result-text">
              ...
              <div class="result-text__value">{{ this.$store.state.trdReceiving.latest.b_in_fr | numFormat('0,0') }}</div>
              <div class="result-text__unit">m<sup>3</sup>/h</div>
            </div>
            <!-- <div class="result-text">
              <div class="result-text__text">· 원수 유입 압력</div>
              <div class="result-text__value">{{ this.$store.state.trdReceiving.latest.b_in_pr | numFormat('0.00') }}</div>
              <div class="result-text__unit">kgf/cm<sup>2</sup></div>
            </div> -->
            <div class="result-text">
              <div class="result-text__text">· 정수지#1 수위</div>
              <div class="result-text__value">{{ this.$store.state.trdReceiving.latest.h_location_le1 | numFormat('0.00') }}</div>
              <div class="result-text__unit">m</div>
            </div>
            <div class="result-text">
              <div class="result-text__text">· 정수지#2 수위</div>
              <div class="result-text__value">{{ this.$store.state.trdReceiving.latest.h_location_le2 | numFormat('0.00') }}</div>
              <div class="result-text__unit">m</div>
            </div>
            <div class="result-text">
              <div class="result-text__text">· 정수지#3 수위</div>
              <div class="result-text__value">{{ this.$store.state.trdReceiving.latest.h_location_le3 | numFormat('0.00') }}</div>
              <div class="result-text__unit">m</div>
            </div>
            <div class="result-text">
              <div class="result-text__text">· 정수지#4 수위</div>
              <div class="result-text__value">{{ this.$store.state.trdReceiving.latest.h_location_le4 | numFormat('0.00') }}</div>
              <div class="result-text__unit">m</div>
            </div>
            <div class="result-text">
              <div class="result-text__text">· 정수지 총 유출 유량</div>
              <div class="result-text__value">{{ this.$store.state.trdReceiving.latest.h_out_fr | numFormat('0,0') }}</div>
              <div class="result-text__unit">m<sup>3</sup>/h</div>
            </div>
          </div>
        </div>
      ...
      <div class="first">
        ...
        <div class="second-result-contents paddingtop">
          ...
          <div class="value-box">
            <div class="value-box__value" v-html="this.$getNumeralWithCommaAndFontFamily(this.$store.state.trdReceiving.latest.ai_b_in_fri)"></div>
      ...
      <div class="first">
        <div class="first__title">
          ...
          <div class="first__timerbox-outter">
            <div class="timerbox">
              {{ this.$store.state.trdReceiving.latest.upd_ti | moment('YYYY-MM-DD HH:mm:ss') }}
            </div>
          </div>
        </div>
        <div class="last-result-contents paddingtop">
          ...
          <div class="contents-title">
            ...
            <div class="real-box real-one">
              ...
              <div class="real-value">{{ this.$store.state.trdReceiving.latest.b1_vv_po | numFormat('0.00') }}</div>
            </div>
          </div>
          <div class="value-box">
            <div class="value-box__value">{{ this.$store.state.trdReceiving.latest.ai_b_vv_po | numFormat('0') }}</div>
...
<script>
export default {
name: 'TrdReceivingRightContents',
data: () => ({
