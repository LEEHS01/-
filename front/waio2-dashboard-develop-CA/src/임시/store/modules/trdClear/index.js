...
export const PUT_CLEAR_HISTORY_LEVEL = 'trdClear/history/le/put'
export const PUT_CLEAR_HISTORY_CL = 'trdClear/history/cl/put'
...
export default {
  ...
  actions: {
    ...
    [PUT_HISTORY_LEVEL]: async function ({ commit }) {
      ...
      // await axios.put(`${DEV_SERVER}/${URL.CLEAR_HISTORY_LEVEL}/` + PROCESS_STEP, { 'start_time': new Date(2012, 8, 3, 0, 0, 0).toISOString(), 'end_time': new Date(2012, 8, 4, 23, 59, 59).toISOString() })
          .then(({ data }) => {
