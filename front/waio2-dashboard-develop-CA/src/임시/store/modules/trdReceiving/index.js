...
export const GET_TRDRECEIVING_LATEST = 'trdReceiving/latest/get'
export const PUT_TRDRECEIVING_HISTORY_FLOW_OUT = 'trdReceiving/latest/put'
export const PUT_TRDRECEIVING_CONTROL_OPERATION = 'trdReceiving/control/operation/put'
export const PUT_TRDRECEIVING_CONTROL_LEVEL = 'trdReceiving/control/le/put'
const GET_LATEST = GET_TRDRECEIVING_LATEST.substr(GET_TRDRECEIVING_LATEST.indexOf('/') + 1)
const PUT_HISTORY_FLOW_OUT = PUT_TRDRECEIVING_HISTORY_FLOW_OUT.substr(PUT_TRDRECEIVING_HISTORY_FLOW_OUT.indexOf('/') + 1)
const PUT_CONTROL_OPERATION = PUT_TRDRECEIVING_CONTROL_OPERATION.substr(PUT_TRDRECEIVING_CONTROL_OPERATION.indexOf('/') + 1)
const PUT_CONTROL_LEVEL = PUT_TRDRECEIVING_CONTROL_LEVEL.substr(PUT_TRDRECEIVING_CONTROL_LEVEL.indexOf('/') + 1)
