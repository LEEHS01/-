...
export const GET_SNDDISINFECTION_LATEST = 'sndDisinfection/latest/get'
export const PUT_DISINFECTION_HISTORY_EVAPORATION = 'sndDisinfection/history/evaporation/put'
export const PUT_DISINFECTION_HISTORY_CHOLRATE = 'sndDisinfection/history/cholrate/put'
export const PUT_SNDDISINFECTION_CONTROL_OPERATION_PRE = 'sndDisinfection/control/operation/pre/put'
export const PUT_SNDDISINFECTION_CONTROL_OPERATION_PERI = 'sndDisinfection/control/operation/peri/put'
export const PUT_SNDDISINFECTION_CONTROL_OPERATION_POST = 'sndDisinfection/control/operation/post/put'
export const PUT_DISINFECTION_CONTROL_PRE = 'sndDisinfection/control/pre/put'
export const PUT_DISINFECTION_CONTROL_PERI = 'sndDisinfection/control/peri/put'
export const PUT_DISINFECTION_CONTROL_POST = 'sndDisinfection/control/post/put'
const GET_LATEST = GET_SNDDISINFECTION_LATEST.substr(GET_SNDDISINFECTION_LATEST.indexOf('/') + 1)
...
const PUT_CONTROL_OPERATION_PRE = PUT_SNDDISINFECTION_CONTROL_OPERATION_PRE.substr(PUT_SNDDISINFECTION_CONTROL_OPERATION_PRE.indexOf('/') + 1)
const PUT_CONTROL_OPERATION_PERI = PUT_SNDDISINFECTION_CONTROL_OPERATION_PERI.substr(PUT_SNDDISINFECTION_CONTROL_OPERATION_PERI.indexOf('/') + 1)
const PUT_CONTROL_OPERATION_POST = PUT_SNDDISINFECTION_CONTROL_OPERATION_POST.substr(PUT_SNDDISINFECTION_CONTROL_OPERATION_POST.indexOf('/') + 1)
...
const PROCESS_STEP = 2  // 2단계공업/2단계생활/3단계
...
export default {
  ...
  state: {
    ...
    disinfectionStep: 1,          // 전차염/중차염/후차염
    title: '전차염',
    latest: {
      upd_ti: null,
      pre_ai_opr: null,
  ...
  actions: {
    ...
    [PUT_CONTROL_PRE]: async function ({ commit }, { disinfectionStep, g_pre_set_max, g_pre_set_min, g_pre_chg_limit_for_onetime, g_pre_calib_cycle, g_e_obj_residual_cl, g_e_residual_cl_holding }) { // eslint-disable-line no-unused-vars
      await axios.put(`${DEV_SERVER}/${URL.DISINFECTION_CONTROL_PRE}/` + PROCESS_STEP + `/` + disinfectionStep, { g_pre_set_max, g_pre_set_min, g_pre_chg_limit_for_onetime, g_pre_calib_cycle, g_e_obj_residual_cl, g_e_residual_cl_holding })
      .then(() => {
        let _data = {
          visible: true,
          title: '설정 성공',
    ...
    [PUT_CONTROL_PERI]: async function ({ commit }, { disinfectionStep, g_peri_set_max, g_peri_set_min, g_peri_chg_limit_for_onetime, g_peri_calib_cycle, g_e_obj_residual_cl, g_e_residual_cl_holding }) { // eslint-disable-line no-unused-vars
      await axios.put(`${DEV_SERVER}/${URL.DISINFECTION_CONTROL_RERI}/` + PROCESS_STEP + `/` + disinfectionStep, { g_peri_set_max, g_peri_set_min, g_peri_chg_limit_for_onetime, g_peri_calib_cycle, g_e_obj_residual_cl, g_e_residual_cl_holding })
      .then(() => {
        let _data = {
          visible: true,
          title: '설정 성공',
    ...
    [PUT_CONTROL_POST]: async function ({ commit }, { disinfectionStep, g_post_set_max, g_post_set_min, g_post_chg_limit_for_onetime, g_post_calib_cycle, g_h_in_obj_residual_cl, g_post_calib_num, g_h_in_residual_cl_holding }) { // eslint-disable-line no-unused-vars
      await axios.put(`${DEV_SERVER}/${URL.DISINFECTION_CONTROL_POST}/` + PROCESS_STEP + `/` + disinfectionStep, { disinfectionStep, g_post_set_max, g_post_set_min, g_post_chg_limit_for_onetime, g_post_calib_cycle, g_h_in_obj_residual_cl, g_post_calib_num, g_h_in_residual_cl_holding })
      .then(() => {
