<template>
  <div v-if="this.$store.state.alarm.visible && this.$store.state.alarm.alarmsDetail.procCd.substring(0, 1) == 'B'" class="popup-wrap">
      ...
      <div class="popup-contents">
        ...
        <div class="one-contents">
          ...
          <div class="big-contents">
            <div v-if="this.$store.state.alarm.alarmsDetail.procCd != 'B_PUMP'" class="contents-value">
              ...
              <div class="value-container">
                <div class="value-container__one">· 정수지#1 수위</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.h_location_le1 | numFormat('0.00') }}</div>
                <div class="value-container__three">m</div>
              </div>
              <div class="value-container">
                <div class="value-container__one">· 정수지#2 수위</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.h_location_le2 | numFormat('0.00') }}</div>
                <div class="value-container__three">m</div>
              </div>
              <div v-if="this.$store.state.alarm.alarmsDetail.procCd == 'B3'" class="value-container">
                <div class="value-container__one">· 정수지#3 수위</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.h_location_le3 | numFormat('0.00') }}</div>
                <div class="value-container__three">m</div>
              </div>
              <div v-if="this.$store.state.alarm.alarmsDetail.procCd == 'B3'" class="value-container">
                <div class="value-container__one">· 정수지#4 수위</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.h_location_le4 | numFormat('0.00') }}</div>
                <div class="value-container__three">m</div>
              </div>
              <div class="value-container">
                <div class="value-container__one">· 정수지 총 유출 유량</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_out_fri | numFormat('0,0') }}</div>
                <div class="value-container__three">m<sup>3</sup>/h</div>
              </div>
              <div v-if="this.$store.state.alarm.alarmsDetail.procCd == 'B2_IND'" class="value-container">
                <div class="value-container__one">· 배출수지 회수 유량</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_back_in_fr | numFormat('0,0') }}</div>
                <div class="value-container__three">m<sup>3</sup>/h</div>
              </div>
              <div v-if="this.$store.state.alarm.alarmsDetail.procCd == 'B2_IND'" class="value-container">
                <div class="value-container__one">· 배출수지 유출거수위#1</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_back_le1 | numFormat('0.00') }}</div>
                <div class="value-container__three">m</div>
              </div>
              <div v-if="this.$store.state.alarm.alarmsDetail.procCd == 'B2_IND'" class="value-container">
                <div class="value-container__one">· 배출수지 유출거수위#2</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_back_le2 | numFormat('0.00') }}</div>
                <div class="value-container__three">m</div>
              </div>
            </div>
            <div v-else class="contents-value">
              <div class="value-container">
                <div class="value-container__one">· 2단계공업 원수유입유량</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_fri_all_f1 | numFormat('0,0') }}</div>
                <div class="value-container__three">m<sup>3</sup>/h</div>
              </div>
              <div class="value-container">
                <div class="value-container__one">· 2단계생활 원수유입유량</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_fri_all_f2 | numFormat('0,0') }}</div>
                <div class="value-container__three">m<sup>3</sup>/h</div>
              </div>
              <div class="value-container">
                <div class="value-container__one">· 3단계 원수유입유량</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_fri_all_f3 | numFormat('0,0') }}</div>
                <div class="value-container__three">m<sup>3</sup>/h</div>
              </div>
              <div class="value-container">
                <div class="value-container__one">· 6누수 원수 관로유량</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_out_fri_tj | numFormat('0,0') }}</div>
                <div class="value-container__three">m<sup>3</sup>/h</div>
              </div>
              <div class="value-container">
                <div class="value-container__one">· 3단계 6누수 순시유량</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_out_fri_as | numFormat('0,0') }}</div>
                <div class="value-container__three">m<sup>3</sup>/h</div>
              </div>
            </div>
          </div>
...
export default {
  name: 'ReceivingHistoryDetailPopup',
  data() {
    return {
