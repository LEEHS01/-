  ...
  <div class="main">
    ...
    <div class="contents-img">
      ...
      <div class="select-box">
        <div v-for="index in [9,10]" :key="index" class="select-box__element" @click="$store.state.indMixing.selectedFCLocation = index" :class="{ 'select-box__element--focused': $store.state.indMixing.selectedFCLocation === index}"><span>{{ index }}지</span></div>
      </div>
      <div class="value-title first">#1</div>
      <div class="contents-img-box one">
        <div class="contents-img-box__num">{{ this.getFCLocationSpeed(this.$store.state.indMixing.selectedFCLocation).step1['1'] | numFormat('0') }}</div>
        <div class="contents-img-box__text">Hz</div>
      </div>
      <div class="value-title second">#4</div>
      <div class="contents-img-box two">
        <div class="contents-img-box__num">{{ this.getFCLocationSpeed(this.$store.state.indMixing.selectedFCLocation).step2['1'] | numFormat('0') }}</div>
        <div class="contents-img-box__text">Hz</div>
      </div>
    </div>
    <!-- 계열별 지 운영 상태 -->
    <div class="contents-container">
      ...
      <div class="box">
        ...
        <div class="box-title">
          ...
          <div class="box-title__text margin-side-19">#4</div>
        </div>
        <div v-for="index in [9,10]" :key="index" class="box-contents">
...
.btn-tab{
  ...
  .contents-img{
    width: 600px;
    height: 310px;
    background-image: url('../../assets/ca_images/sub_03.png');
