  ...
  <div class="main">
    <div class="top-contents">
      ...
      <div class="one-contents">
        <div class="one-contents__title">주요인자 3단계 후차염</div>
        <div class="big-contents">
          <div class="contents-value">
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.trdDisinfection.latest.h_in_fr | numFormat('0,0') }}</div>
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.trdDisinfection.latest.g_h_in_residual_cl | numFormat('0.00') }}</div>
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.trdDisinfection.latest.g_h_out_residual_cl | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 현재 주입률(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.trdDisinfection.latest.g_post_chol_rate | numFormat('0.00') }}</div>
      ...
      <div class="two-contents">
        ...
        <div class="small-contents">
          ...
          <div class="small-contents-value">
            ...
            <div class="value">
              <div class="value__num">{{ this.$store.state.trdDisinfection.latest.ai_g_correct_degree | numFormat('0.00') }}</div>
      ...
      <div class="three-contents">
        ...
        <div class="three-small-contents">
          ...
          <div class="real-box real-two">
            ...
            <div class="real-value">{{ this.$store.state.trdDisinfection.latest.g_post_chol_rate | numFormat('0.00') }}</div>
          </div> 
    ...
    <div class="bottom-contents">
      ...
      <div class="contents paddingleft">
        ...
        <div class="real-box real-three">
          ...
          <div class="real-value">{{ this.$store.state.trdDisinfection.latest.g_h_in_residual_cl | numFormat('0.00') }}</div>
          <div class="real-text__title">유출 : </div>
          <div class="real-value">{{ this.$store.state.trdDisinfection.latest.g_h_out_residual_cl | numFormat('0.00') }}</div>
        </div>        
        <div class="contents-gragh">
...
export default {
  ...
  computed: {
    ...
    ChartOptionCholRate: function () {
      ...
      chart.series = []
      if (this.$store.state.trdDisinfection.cholrateTrend !== null && Object.keys(this.$store.state.trdDisinfection.cholrateTrend).length > 0) {
        let dataSeries1 = []
        for (let key in this.$store.state.trdDisinfection.cholrateTrend) {
          dataSeries1.push([new Date(key).getTime(), this.$store.state.trdDisinfection.cholrateTrend[key]])
                  }
        chart.series.push({
          name: '주입률',
          data: dataSeries1,
    ...
    ChartOptionCl: function () {
      ...
      chart.series = []
      if (this.$store.state.trdClear.h_cl.in !== null && Object.keys(this.$store.state.trdClear.h_cl.in).length > 0) {
        let dataSeries = []
        for (let key in this.$store.state.trdClear.h_cl.in) {
          dataSeries.push([new Date(key).getTime(), this.$store.state.trdClear.h_cl.in[key]])
        }
        chart.series.push({
          name: '유입',
          data: dataSeries,
      ...
      if (this.$store.state.trdClear.h_cl.out !== null && Object.keys(this.$store.state.trdClear.h_cl.out).length > 0) {
        let dataSeries = []
        for (let key in this.$store.state.trdClear.h_cl.out) {
          dataSeries.push([new Date(key).getTime(), this.$store.state.trdClear.h_cl.out[key]])
        }
        chart.series.push({
          name: '유출',
          data: dataSeries,
