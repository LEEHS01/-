  ...
  <div class="main">
    <div class="top-contents">
      ...
      <div class="one-contents">
        <div class="one-contents__title">주요인자 2단계 전차염</div>
        <div class="big-contents">
          <div class="contents-value">
            <div class="value-container">
              <div class="value-container__one">· 기온(°C)</div>
              <div class="value-container__two">{{ this.$store.state.sndDisinfection.latest.g_tei | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.sndDisinfection.latest.b_in_fr | numFormat('0,0') }}</div>
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.sndDisinfection.latest.g_d_residual_cl | numFormat('0.00') }}</div>
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.sndDisinfection.latest.g_e_residual_cl | numFormat('0.00') }}</div>
              <!-- <div class="value-container__two">{{ this.$store.state.sndDisinfection.latest.d_ser_cl | numFormat('0.0') }}</div> -->
            </div>
            <div class="value-container">
              <div class="value-container__one">· 중차염 주입률(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.sndDisinfection.latest.g_peri_chol_rate | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 현재 주입률(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.sndDisinfection.latest.g_pre_chol_rate | numFormat('0.00') }}</div>
      ...
      <div class="two-contents">
        ...
        <div class="small-contents">
          <div class="little-title-one">생활차염 증발량 예측</div>
          ...
          <div class="small-contents-value">
            ...
            <div class="value">
              <div class="value__num">{{ this.$store.state.sndDisinfection.latest.ai_g_evap | numFormat('0.00') }}</div>
      ...
      <div class="three-contents">
        ...
        <div class="three-small-contents">
          ...
          <div class="real-box real-two">
            ...
            <div class="real-value">{{ this.$store.state.sndDisinfection.latest.g_pre_chol_rate | numFormat('0.00') }}</div>
          </div> 
    ...
    <div class="bottom-contents">
      <div class="contents">
        <div class="contents__title">생활차염 증발량 예측</div>
      ...
      <div class="contents paddingleft">
        ...
        <div class="real-box real-three">
          ...
          <div class="real-value">{{ this.$store.state.sndDisinfection.latest.g_e_residual_cl | numFormat('0.00') }}</div>
        </div>        
        <div class="contents-gragh">
...
export default {
  ...
  computed: {
    ...
    ChartOptionEvaporation: function () {
      ...
      chart.series = []
      if (this.$store.state.sndDisinfection.pre_evaporation['series' + this.selectedLine] !== null && Object.keys(this.$store.state.sndDisinfection.pre_evaporation['series' + this.selectedLine]).length > 0) {
        let yesterdayData = []
        let todayData = []
        ...
        for (let key in this.$store.state.sndDisinfection.pre_evaporation['series' + this.selectedLine]) {
          let _timestamp = new Date(key).getTime()
          if (_timestamp < todayTimestamp) {
            yesterdayData.push([_timestamp + this.$getMilliSecondFromHour(24), this.$store.state.sndDisinfection.pre_evaporation['series' + this.selectedLine][key]])
          } else {
            todayData.push([_timestamp, this.$store.state.sndDisinfection.pre_evaporation['series' + this.selectedLine][key]])
          }
        }
        chart.series.push({
          name: '어제',
