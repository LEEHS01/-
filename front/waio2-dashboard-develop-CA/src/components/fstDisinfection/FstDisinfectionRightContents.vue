<template>
  <div class="main">
    <div class="top-contents">
        ...
        <div class="big-contents">
          <div class="contents-value">
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.fstDisinfection.latest.g_tei | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 수온(°C)</div>
              <div class="value-container__two">{{ this.$store.state.fstDisinfection.latest.b_te | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 정수 탁도(NTU)</div>
              <div class="value-container__two">{{ this.$store.state.fstDisinfection.latest.h_tb | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 정수 pH</div>
              <div class="value-container__two">{{ this.$store.state.fstDisinfection.latest.h_ph | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 원수유입유량(m<sup>3</sup>/h)</div>
              <div class="value-container__two">{{ this.$store.state.fstDisinfection.latest.b_in_fr | numFormat('0,0') }}</div>
              <!-- <div class="value-container__two">{{ this.$store.state.fstDisinfection.latest.d_ser_in_fr | numFormat('0,0') }}</div> -->
            </div>
            <div class="value-container">
              <div class="value-container__one">· 정수지 잔류 염소(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.fstDisinfection.latest.g_h_residual_cl | numFormat('0.00') }}</div>
              <!-- <div class="value-container__two">{{ this.$store.state.fstDisinfection.latest.e_ser_cl | numFormat('0.00') }}</div> -->
            </div>
            <div class="value-container">
              <div class="value-container__one">· 현재 주입률(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.fstDisinfection.latest.g_pre_chol_rate | numFormat('0.00') }}</div>
              <!-- <div class="value-container__two">{{ this.$store.state.fstDisinfection.latest.g_pre2_chlorination | numFormat('0.00') }}</div> -->
            </div>
          </div>
        </div>
      </div>
      <div class="two-contents">
        ...
        <div class="small-contents">
          <div class="little-title-one">공업차염 증발량 예측</div>
          ...
          <div class="small-contents-value">
            ...
            <div class="value">
              <div class="value__num">{{ this.$store.state.fstDisinfection.latest.ai_g_evap | numFormat('0.00') }}</div>
      ...
      <div class="three-contents">
        <div class="three-contents__title">
          ...
          <div class="three-contents__timerbox-outter">
            <div class="timerbox">
              {{ this.$store.state.fstDisinfection.latest.upd_ti | moment('YYYY-MM-DD HH:mm:ss') }}
            </div>
          </div>
        </div>
        <div class="three-small-contents">
          ...
          <div class="real-box real-two">
            ...
            <div class="real-value">{{ this.$store.state.fstDisinfection.latest.g_pre_chol_rate | numFormat('0.00') }}</div>
          </div> 
          <div class="three-small-contents-value">
            <div class="three-small-contents-value__title">{{ getPumpRun }}</div>
            <div class="three-value">
              <div class="three-value__num">{{ this.$store.state.fstDisinfection.latest.ai_g_chol_rate | numFormat('0.00') }}</div>
    ...
    <div class="bottom-contents">
      <div class="contents">
        <div class="contents__title">공업차염 증발량 예측 비교</div>
      ...
      <div class="contents paddingleft">
        ...
        <div class="real-box real-three">
          ...
          <div class="real-value">{{ this.$store.state.fstDisinfection.latest.g_h_residual_cl | numFormat('0.00') }}</div>
        </div>        
        <div class="contents-gragh">
...
export default {
  ...
  computed: {
    getPumpRun: function() {
      let pumpRun = ''
      if(this.$store.state.fstDisinfection.latest.g_pump_1_run == 1) pumpRun += '1호기'
      if(this.$store.state.fstDisinfection.latest.g_pump_2_run == 1) pumpRun += '2호기'
      return pumpRun
    },
    ChartOptionEvaporation: function () {
      ...
      chart.series = []
      if (this.$store.state.fstDisinfection.pre_evaporation['series' + this.selectedLine] !== null && Object.keys(this.$store.state.fstDisinfection.pre_evaporation['series' + this.selectedLine]).length > 0) {
        let yesterdayData = []
        let todayData = []
        ...
        for (let key in this.$store.state.fstDisinfection.pre_evaporation['series' + this.selectedLine]) {
          let _timestamp = new Date(key).getTime()
          if (_timestamp < todayTimestamp) {
            yesterdayData.push([_timestamp + this.$getMilliSecondFromHour(24), this.$store.state.fstDisinfection.pre_evaporation['series' + this.selectedLine][key]])
          } else {
            todayData.push([_timestamp, this.$store.state.fstDisinfection.pre_evaporation['series' + this.selectedLine][key]])
          }
        }
        chart.series.push({
          name: '어제',
    ...
    ChartOptionCl: function () {
      ...
      chart.series = []
      if (this.$store.state.fstClear.h_cl.in !== null && Object.keys(this.$store.state.fstClear.h_cl.in).length > 0) {
        let dataSeries = []
        for (let key in this.$store.state.fstClear.h_cl.in) {
          dataSeries.push([new Date(key).getTime(), this.$store.state.fstClear.h_cl.in[key]])
        }
        chart.series.push({
          name: '잔류염소',
          data: dataSeries,
  ...
  methods: {
    downloadExcel: function() {
      const eva = this.$store.state.fstDisinfection.pre_evaporation
      ...
      XLSX.writeFile(wb, `${this.$moment().format('YYYYMMDDHHmmss')}_전염소 증발량 예측 비교.xlsx`);
    }
  },
