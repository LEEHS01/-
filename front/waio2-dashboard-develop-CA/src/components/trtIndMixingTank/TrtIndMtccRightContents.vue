<template>
  <div class="main">
            ...
            <div class="toggle-wrap">
              ...
              <div class="btn-contents" style="width: 60px;">
                <div class="btn-contents__btn">
                  <input type="checkbox" class="checkbox" @click="openPopup" :class="{ 'checked': this.$store.state.trtIndMixing.latest.d_g_value_ctr_flag == 1 }">
                </div>
              </div>
            </div>
            <div class="top-one-contents-value">
              <div class="top-one-contents-value__text">#1</div>
              <input ref="gValueInputBox" v-if="this.$store.state.trtIndMixing.isModifyMode && this.$store.state.trtIndMixing.latest.d_g_value_ctr_flag == 0" type="text" class="top-one-contents-value__input" :value="this.$store.state.trtIndMixing.latestModify.d_g_value1" v-on:input="updateInput($event, 'd_g_value1')"/>
              <span class="top-one-contents-value__span" v-else>{{ this.$store.state.trtIndMixing.latest.d_g_value_ctr_flag == 0 ? this.$store.state.trtIndMixing.latest.d_g_value1 : this.$store.state.trtIndMixing.latest.ai_d_g_value1 | numFormat('0.0')}}</span>
              <div class="top-one-contents-value__unit">sec<sup>-1</sup></div>
            </div>
            <div class="top-one-contents-value">
              <div class="top-one-contents-value__text">#2</div>
              <input v-if="this.$store.state.trtIndMixing.isModifyMode && this.$store.state.trtIndMixing.latest.d_g_value_ctr_flag == 0" type="text" class="top-one-contents-value__input" :value="this.$store.state.trtIndMixing.latestModify.d_g_value2" v-on:input="updateInput($event, 'd_g_value2')"/>
              <span class="top-one-contents-value__span" v-else>{{ this.$store.state.trtIndMixing.latest.d_g_value_ctr_flag == 0 ? this.$store.state.trtIndMixing.latest.d_g_value2 : this.$store.state.trtIndMixing.latest.ai_d_g_value2 | numFormat('0.0')}}</span>
              <div class="top-one-contents-value__unit">sec<sup>-1</sup></div>
            </div>
            <div class="top-one-contents-value">
              <div class="top-one-contents-value__text">#3</div>
              <input v-if="this.$store.state.trtIndMixing.isModifyMode && this.$store.state.trtIndMixing.latest.d_g_value_ctr_flag == 0" type="text" class="top-one-contents-value__input" :value="this.$store.state.trtIndMixing.latestModify.d_g_value3" v-on:input="updateInput($event, 'd_g_value3')"/>
              <span class="top-one-contents-value__span" v-else>{{ this.$store.state.trtIndMixing.latest.d_g_value_ctr_flag == 0 ? this.$store.state.trtIndMixing.latest.d_g_value3 : this.$store.state.trtIndMixing.latest.ai_d_g_value3 | numFormat('0.0') }}</span>
              <div class="top-one-contents-value__unit">sec<sup>-1</sup></div>
            </div>
            <div v-if="$store.state.login.user.tkn !== null && $store.state.trtIndMixing.latest.d_g_value_ctr_flag == 0" class="box-config--end">
              <div v-if="this.$store.state.trtIndMixing.isModifyMode" class="box-config--reset" @click="cancelControl"></div>
              <div v-if="this.$store.state.trtIndMixing.isModifyMode" class="box-config--confirm" @click="updateControl"><div class="box-config--check"></div><span>확인</span></div>
              <div v-else class="box-config--confirm" @click="checkControl"><span>설정</span></div>
            </div>
            <div class="auto-btn" v-show="$store.state.trtIndMixing.latest.d_g_value_ctr_flag == 1" ><button class="auto-btn__detail" @click="openAutoDetail()">자동모드 상세</button></div> 
          </div>
          <div class="top-two-contents-box">
            <div class="top-two-contents-value">
              <div class="top-two-contents-value__text">· 원수 수온</div>
              <div class="top-two-contents-value__value">{{ this.$store.state.trtIndMixing.latest.b_te | numFormat('0.00') }}</div>
            ...
            <div class="top-two-contents-value">
              ...
              <div class="top-two-contents-value__unit">m<sup>2</sup>/sec</div>
            </div>
            <div class="top-two-contents-value">
            ...
            <div class="top-two-contents-value">
              ...
              <div class="top-two-contents-value__value">{{ this.$store.state.trtIndMixing.latest.d_tb_e | numFormat('0.00') }}</div>
      ...
      <div class="top-two-contents-container">
        <div class="top-two-contents-container__title">
          ...
          <div class="top-two-contents-container__timerbox-outter">
            <!-- 예측 결과 시간 -->
            <div class="timerbox">
              {{ this.$store.state.trtIndMixing.latest.upd_ti | moment('YYYY-MM-DD HH:mm:ss') }}
            </div>
          </div>
        </div>
        <div class="top-container">
          <div class="top-container__real-box">
            ...
            <div class="top-container__real-value">{{ this.getFCLocationSpeed(this.$store.state.trtIndMixing.selectedFCLocation).step1['1'] | numFormat('0') }}</div>
            <div class="top-container__real-unit">Hz</div>
          </div>
          <div class="top-two-contents-value">
            <div class="top-two-contents-value__text">· #1</div>
            <div class="top-two-contents-value__value">{{ this.getAIFCLocationSpeed(this.$store.state.trtIndMixing.selectedFCLocation).step1['1'] | numFormat('0') }}</div>
          ...
          <div class="top-container__real-box">
            ...
            <div class="top-container__real-value">{{ this.getFCLocationSpeed(this.$store.state.trtIndMixing.selectedFCLocation).step2['1'] | numFormat('0') }}</div>
            <div class="top-container__real-unit">Hz</div>
          </div>          
          <div class="top-two-contents-value">
            <div class="top-two-contents-value__text">· #2</div>
            <div class="top-two-contents-value__value">{{ this.getAIFCLocationSpeed(this.$store.state.trtIndMixing.selectedFCLocation).step2['1'] | numFormat('0') }}</div>
            <div class="top-two-contents-value__unit">Hz</div>
          </div>
          <div class="contents-value-underbar"></div>
          <div class="top-container__real-box">
            <div class="top-container__real-text">#3 현재 응집기 속도</div>
            <div class="top-container__real-value">{{ this.getFCLocationSpeed(this.$store.state.trtIndMixing.selectedFCLocation).step3['1'] | numFormat('0') }}</div>
            <div class="top-container__real-unit">Hz</div>
          </div>
          <div class="top-two-contents-value">
            <div class="top-two-contents-value__text">· #3</div>
            <div class="top-two-contents-value__value">{{ this.getAIFCLocationSpeed(this.$store.state.trtIndMixing.selectedFCLocation).step3['1'] | numFormat('0') }}</div>
            <div class="top-two-contents-value__unit">Hz</div>
          </div>
        </div>
      </div>
    ...
    <div class="bottom-contents">
      ...
      <div class="bottom-chart-box">
        ...
        <div class="select-box">
          <div v-for="index in [1,2,3,4,5]" :key="index" class="select-box__element" @click="selectedLocation = index" :class="{ 'select-box__element--focused': selectedLocation === index}">{{ index }}지</div>
          </div>
        <div class="bottom-chart">
    ...
    <div v-if="this.$store.state.trtIndMixing.isPopupVisible" class="popup">
      <div class="popup__inner">
        ...
        <div class="popup__body">
          ...
          <span v-if="this.$store.state.trtIndMixing.latest.d_g_value_ctr_flag == 0" class="popup__body--large">자동모드로 변경하시겠습니까?</span>
          <span v-else-if="this.$store.state.trtIndMixing.latest.d_g_value_ctr_flag == 1" class="popup__body--large">수동모드로 변경하시겠습니까? <br> 교반강도(G)값을 입력 후 ‘확인'버튼을 클릭해주세요.</span>
        </div>
...
import { PUT_MIXING_CONTROL_AI } from '@/store/modules/trtIndMixing'
export default {
  name: 'TrtIndMtccRightContents',
  data: () => ({
    // d_g_value1: null,
  ...
  computed: {
    ...
    ChartDataAGSpeedByLocation: function () {
      return this.$store.state.trtIndMixing.fc_sp['location' + this.selectedLocation]
    },
    // 응집기 설정 속도 예측 차트 옵션
  ...
  methods: {
    ...
    getFCLocationSpeed: function (location) {
      return this.$store.state.trtIndMixing.latest['d_loc_fc_sp' + location]
    },
    getAIFCLocationSpeed: function(location) {
      return this.$store.state.trtIndMixing.latest['ai_d_loc_fc_sp' + location]
    },
    
    cancelControl: function() {
      this.$store.state.trtIndMixing.latestModify = Object.assign({}, this.$store.state.trtIndMixing.latest)
      this.$store.state.trtIndMixing.isModifyMode = !this.$store.state.trtIndMixing.isModifyMode
    },
    /**
     * 사용자 설정 업데이트 버튼 선택시 
    ...
    updateControl: function() {      
      let min = 0
      let max = 100
      if (this.$store.state.trtIndMixing.isModifyMode) {
        if (this.$store.state.trtIndMixing.latestModify.d_g_value1 === ''
          || this.$store.state.trtIndMixing.latestModify.d_g_value2 === ''
          || this.$store.state.trtIndMixing.latestModify.d_g_value3 === '') {
          this.$store.dispatch('alertDialog/OPEN_DIALOG', { title: '경고', text1: '값을 입력해주세요' })
        } else if (parseFloat(this.$store.state.trtIndMixing.latestModify.d_g_value1) <= min 
                  || parseFloat(this.$store.state.trtIndMixing.latestModify.d_g_value1) >= max
                  || parseFloat(this.$store.state.trtIndMixing.latestModify.d_g_value2) <= min
                  || parseFloat(this.$store.state.trtIndMixing.latestModify.d_g_value2) >= max
                  || parseFloat(this.$store.state.trtIndMixing.latestModify.d_g_value3) <= min
                  || parseFloat(this.$store.state.trtIndMixing.latestModify.d_g_value3) >= max) {
          this.$store.dispatch('alertDialog/OPEN_DIALOG', { title: '경고', text1: '설정 범위', text2: min + ' ~ ' + max })
        } else {
          let obj = {}
          obj.d_g_value_step1 = parseFloat(this.$store.state.trtIndMixing.latestModify.d_g_value1)
          obj.d_g_value_step2 = parseFloat(this.$store.state.trtIndMixing.latestModify.d_g_value2)
          obj.d_g_value_step3 = parseFloat(this.$store.state.trtIndMixing.latestModify.d_g_value3)
          obj.d_g_value_ctr_flag = this.$store.state.trtIndMixing.latest.d_g_value_ctr_flag
    ...
    openPopup: function(){
      if( this.$store.state.login.user.tkn !== null ) {
        this.$store.state.trtIndMixing.isPopupVisible = !this.$store.state.trtIndMixing.isPopupVisible
      }
    },
    closePopup: function(){
      this.$store.state.trtIndMixing.isPopupVisible = !this.$store.state.trtIndMixing.isPopupVisible
    ...
    changeGValue: function() {//d_g_value_ctr_flag 변경
      if(this.$store.state.trtIndMixing.latest.d_g_value_ctr_flag == 0){
        //수동(0)->자동(1) 변경 요청 : ctr_flag 변경 및 Control API호출.
        this.$store.state.trtIndMixing.latest.d_g_value_ctr_flag = 1;
        let obj = {}
        obj.d_g_value_ctr_flag = this.$store.state.trtIndMixing.latest.d_g_value_ctr_flag
        this.$store.dispatch(PUT_MIXING_CONTROL_AI, obj)
        this.closePopup();
        ...
        this.$store.state.trtIndMixing.latest.d_g_value_ctr_flag = 0;
        this.closePopup();
        this.$store.state.trtIndMixing.isModifyMode = true;
        this.$nextTick(() => {
    ...
    downloadExcel: function() {
      const speedPrediction = this.$store.state.trtIndMixing.fc_sp
    ...
    openAutoDetail: function() {
      if( this.$store.state.login.user.tkn !== null ) {
        this.$store.state.dialog.autoModeDetailPopup.mixingIndex = 3
  ...
  watch: {
    // 교반강도 #1
    '$store.state.trtIndMixing.latestModify.d_g_value1': function(newVal) {
      if (newVal === '') {
        this.$store.state.trtIndMixing.latestModify['d_g_value1'] = newVal
      } else {
        if (this.checkNumber(newVal)) {
          this.$store.state.trtIndMixing.latestModify['d_g_value1'] = newVal
        } 
        // else {
        //   this.$store.state.trtIndMixing.latestModify['d_g_value1'] = oldVal
        // }
      }
    },
    // 교반강도 #2
    '$store.state.trtIndMixing.latestModify.d_g_value2': function(newVal) {
      if (newVal === '') {
        this.$store.state.trtIndMixing.latestModify['d_g_value2'] = newVal
      } else {
        if (this.checkNumber(newVal)) {
          this.$store.state.trtIndMixing.latestModify['d_g_value2'] = newVal
        } 
        // else {
        //   this.$store.state.trtIndMixing.latestModify['d_g_value2'] = oldVal
        // }
      }
    },
    // 교반강도 #3
    '$store.state.trtIndMixing.latestModify.d_g_value3': function(newVal) {
      if (newVal === '') {
        this.$store.state.trtIndMixing.latestModify['d_g_value3'] = newVal
      } else {
        if (this.checkNumber(newVal)) {
          this.$store.state.trtIndMixing.latestModify['d_g_value3'] = newVal
        } 
        // else {
        //   this.$store.state.trtIndMixing.latestModify['d_g_value3'] = oldVal
        // }
      }
    },
  }
