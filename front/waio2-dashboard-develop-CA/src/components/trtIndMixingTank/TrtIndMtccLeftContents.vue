  ...
  <div class="main">
    ...
    <div class="contents-img">
      ...
      <div class="select-box">
        <div v-for="index in [1,2,3,4,5]" :key="index" class="select-box__element" @click="$store.state.trtIndMixing.selectedFCLocation = index" :class="{ 'select-box__element--focused': $store.state.trtIndMixing.selectedFCLocation === index}"><span>{{ index }}지</span></div>
      </div>
      <div class="value-title first">#1</div>
      <div class="contents-img-box one">
        <!-- <div class="contents-img-box__text">RPM</div> -->
        <div class="contents-img-box__num">{{ this.getFCLocationSpeed(this.$store.state.trtIndMixing.selectedFCLocation).step1['1'] | numFormat('0') }}</div>
        <div class="contents-img-box__text">Hz</div>
      </div>
      <div class="value-title second">#2</div>
      <div class="contents-img-box two">
        <!-- <div class="contents-img-box__text">RPM</div> -->
        <div class="contents-img-box__num">{{ this.getFCLocationSpeed(this.$store.state.trtIndMixing.selectedFCLocation).step2['1'] | numFormat('0') }}</div>
        <div class="contents-img-box__text">Hz</div>
      </div>
      <div class="value-title third">#3</div>
      <div class="contents-img-box three">
        <!-- <div class="contents-img-box__text">RPM</div> -->
        <div class="contents-img-box__num">{{ this.getFCLocationSpeed(this.$store.state.trtIndMixing.selectedFCLocation).step3['1'] | numFormat('0') }}</div>
        <div class="contents-img-box__text">Hz</div>
      </div>
    </div>
    <!-- 계열별 지 운영 상태 -->
    <div class="contents-container">
      ...
      <div class="box">
        ...
        <div v-for="index in [1, 2, 3, 4, 5]" :key="index" class="box-contents">
