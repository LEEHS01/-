    ...
    <div class="top-contents">
      ...
      <div class="two-contents">
        ...
        <div class="small-contents">
          ...
          <div class="real-box">
            ...
            <div class="real-value">{{ this.$store.state.indCoagulants.latest.c_cf | numFormat('0.00') }}</div>
          </div>
          <div class="small-contents-value">
            <div class="small-contents-value__title"><span>{{ getInjector }}</span> {{ this.$store.state.indCoagulants.latest.c1_cf_coagulant }}</div>
            <div class="value">
      ...
      <div class="three-contents">
        ...
        <div class="three-small-contents">
          <div class="three-small-contents-value">
            <div class="three-small-contents-value__title"><span>{{ getInjector }}</span> {{ this.$store.state.indCoagulants.latest.c1_cf_coagulant }}</div>
      ...
      <!-- <div class="three-contents">
        ...
        <div class="three-small-contents">
          ...
          <div class="three-small-contents-value">
            <div class="three-small-contents-value__title"><span>{{ getInjector }}</span> {{ this.$store.state.indCoagulants.latestModify.c1_cf_coagulant }}</div>
            <div class="three-value">
              <div class="three-value__num">{{ this.$store.state.indCoagulants.latest.ai_c_cf | numFormat('0.00') }}</div>
              <div class="three-value__unit">ppm</div>
            </div>
...
export default {
  ...
  computed: {
    getInjector() {
      let injector = ''
      if(this.$store.state.indCoagulants.latest.c_injector1 == 1) injector +=  '1호기'
      if(this.$store.state.indCoagulants.latest.c_injector2 == 1) injector += ' 2호기'
      return injector
    },
    // 클래스 설명
    ClassDescription() {
