...
export default {
  ...
  state: {
    ...
    latest: {
      ...
      e_operation_mode_9: null,
      e_operation_mode_10: null,
      e_sc1_f: null,
      e_sc1_b: null,
      e_sc1_schedule: {
        next: null,
      ...
      e_drawing_vv9_5: null,
      e_drawing_vv9_6: null,
      e_sc9_f: null,
      e_sc9_b: null,
      e_sc9_schedule: {
        next: null,
      ...
      e_drawing_vv10_1: null,
      e_drawing_vv10_2: null,
      e_drawing_vv10_3: null,
      e_drawing_vv10_4: null,
      e_drawing_vv10_5: null,
      e_drawing_vv10_6: null,
      e_sc10_f: null,
      e_sc10_b: null,
      e_sc10_schedule: {
        next: null,
  ...
  getters: {
    ...
    isOpenInBalValve9: function (state) {
      if (state.latest.e_drawing_vv9_1 === 1 || state.latest.e_drawing_vv9_2 === 1 || state.latest.e_drawing_vv9_3 === 1 || state.latest.e_drawing_vv9_4 === 1 || state.latest.e_drawing_vv9_5 || state.latest.e_drawing_vv9_6) {
        return true
      } else {
        return false
      }
    },
    isOpenInBalValve10: function (state) {
      if (state.latest.e_drawing_vv10_1 === 1 || state.latest.e_drawing_vv10_2 === 1 || state.latest.e_drawing_vv10_3 === 1 || state.latest.e_drawing_vv10_4 === 1 || state.latest.e_drawing_vv10_5 || state.latest.e_drawing_vv10_6) {
        return true
      } else {
        return false
      }
