<template>
  <div class="main">
        ...
        <div class="big-contents">
          <div class="contents-value">
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.indDisinfection.latest.h_tb | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
            ...
            <div class="value-container">
              <div class="value-container__one">· 원수 유입유량(m<sup>3</sup>/h)</div>
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.indDisinfection.latest.e1_cl | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 현재 주입률(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.indDisinfection.latest.g_pre1_chlorination | numFormat('0.00') }}</div>
            </div>
          </div>
        </div>
      </div>
      <div class="two-contents">
        ...
        <div class="small-contents">
          ...
          <div class="small-contents-value">
            ...
            <div class="value">
              <div class="value__num">{{ this.$store.state.indDisinfection.latest.ai_g_pre1_evaporation | numFormat('0.00') }}</div>
      ...
      <div class="three-contents">
        ...
        <div class="three-small-contents">
          ...
          <div class="real-box real-two">
            ...
            <div class="real-value">{{ this.$store.state.indDisinfection.latest.g_pre1_chlorination | numFormat('0.00') }}</div>
          </div> 
    ...
    <div class="bottom-contents">
      <div class="contents">
        <div class="contents__title">전차염 증발량 예측 비교</div>
      ...
      <div class="contents paddingleft">
        ...
        <div class="real-box real-three">
          ...
          <div class="real-value">{{ this.$store.state.indDisinfection.latest.e1_cl | numFormat('0.00') }}</div>
        </div>   
        <div class="contents-gragh">
...
export default {
  ...
  computed: {
    getPumpRun: function() {
      let pumpRun = ''
      if(this.$store.state.indDisinfection.latest.g_pump_1_run == 1) pumpRun += '펌프1'
      if(this.$store.state.indDisinfection.latest.g_pump_2_run == 1) pumpRun += '펌프2'
      return pumpRun
    },
    ChartOptionEvaporation: function () {
      ...
      //console.log(this.$store.state.indDisinfection.pre_evaporation)
      if (this.$store.state.indDisinfection.pre_evaporation['series' + this.selectedLine] !== null 
      && Object.keys(this.$store.state.indDisinfection.pre_evaporation['series' + this.selectedLine]).length > 0) {
        let yesterdayData = []
        let todayData = []
        ...
        for (let key in this.$store.state.indDisinfection.pre_evaporation['series' + this.selectedLine]) {
          let _timestamp = new Date(key).getTime()
          if (_timestamp < todayTimestamp) {
            yesterdayData.push([_timestamp + this.$getMilliSecondFromHour(24), this.$store.state.indDisinfection.pre_evaporation['series' + this.selectedLine][key]])
          } else {
            todayData.push([_timestamp, this.$store.state.indDisinfection.pre_evaporation['series' + this.selectedLine][key]])
          }
        }
        chart.series.push({
          name: '어제',
    ...
    ChartOptionCl: function () {
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_침전지 잔류염소'
      return chart
    }
  },
  ...
  methods: {
    downloadExcel: function() {
      ...
      XLSX.writeFile(wb, `${this.$moment().format('YYYYMMDDHHmmss')}_전차염 증발량 예측 비교.xlsx`);
    }
  }
}
</script>
