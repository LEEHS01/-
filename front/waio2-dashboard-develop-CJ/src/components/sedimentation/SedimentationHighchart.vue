...
export default {
  ...
  computed: {
    ...
    ChartSludgeByLocation: function(){
      ...
      for(let key in this.$store.state.sedimentation.latest.sludgeByLocation){
        data.push(this.$store.state.sedimentation.latest.sludgeByLocation[key])
        categories.push(key)
      }
      ...
      let elapsedTimeByLocation = this.$store.state.sedimentation.latest.elapsedTimeByLocation
