<template>
  <div class="main">
      ...
      <div class="one-contents">
        ...
        <div class="big-contents">
          <div class="contents-value">
            ...
            <div class="value-container">
              <div class="value-container__one">· 중염소 주입률(ppm)</div>
            ...
            <div class="value-container">
              <div class="value-container__one">· 여과지 유출 잔류 염소(ppm)</div>
    ...
    <div class="bottom-contents">
      <div class="contents">
        <div class="contents__title">중차염 주입률 예측 비교</div>
        <div class="contents-gragh">
          <highcharts :options="ChartOptionCholRate" style="height:100%;"/>
        </div>
      </div>
      <div class="contents paddingleft">
        <div class="contents__title">여과지 유출 잔류염소</div>
        <div class="real-box real-three">
          <div class="real-text">현재 잔류염소</div>
          <div class="real-text__title">1계열 : </div>
          <div class="real-value">{{ this.$store.state.disinfection.latest.g_f_out_1_residual_cl | numFormat('0.00') }}</div>
          <div class="real-text__title">2계열 : </div>
          <div class="real-value">{{ this.$store.state.disinfection.latest.g_f_out_2_residual_cl | numFormat('0.00') }}</div>
        </div>  
        <div class="contents-gragh">
...
export default {
  ...
  computed: {
    ...
    ChartOptionCl: function () {
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_여과지 유출 잔류염소'
      return chart
    }
  },
  methods: {
...
.top-contents{
  ...
  .three-contents{
    ...
    .three-small-contents{
      ...
      height: 356px;
      margin-top: 10px;
      background-image: url('../../assets/cj_images/three_background.png');
      .three-small-contents-value{
        ...
        .three-contents-value-underbar{
          width: 100%;
          height: 36px;
          background-image: url('../../assets/cj_images/contents_value_underbar.png');
