        ...
        <div class="chart-container">
          <div class="one-contents">
            ...
            <div class="big-contents">
              <div class="contents-value" v-if="this.$store.state.alarm.alarmsDetail.procCd !== 'B_PUMP'">
                ...
                <div class="value-container">
                  ...
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.h_out_fr | numFormat('0,0') }}</div>
                  <div class="value-container__three">m<sup>3</sup>/h</div>
                </div>
              </div>
              <div class="contents-value" v-else>
                <div class="value-container">
                  <div class="value-container__one">· 현도(취) 토출유량(#1~#10)</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_in_fr_sum | numFormat('0,0') }}</div>
                  <div class="value-container__three">m<sup>3</sup>/h</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 현도2(취) 토출유량</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_in_fr3 | numFormat('0,0') }}</div>
                  <div class="value-container__three">m<sup>3</sup>/h</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 원형수조 수위</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_lei | numFormat('0.00') }}</div>
                  <div class="value-container__three">m</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 정수지 총 유출 유량</div>
                ...
                <div class="value-container">
                  <div class="value-container__one">· 전동(가) 1단계 유입유량</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_in_fr4 | numFormat('0,0') }}</div>
                  <div class="value-container__three">m<sup>3</sup>/h</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 전동(가) 2단계 유입유량</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_in_fr5 | numFormat('0,0') }}</div>
                  <div class="value-container__three">m<sup>3</sup>/h</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 중부권유량</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_in_fr6 | numFormat('0,0') }}</div>
                  <div class="value-container__three">m<sup>3</sup>/h</div>
                </div>
              </div>
            </div>
