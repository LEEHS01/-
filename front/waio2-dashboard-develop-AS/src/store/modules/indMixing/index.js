...
export default {
  ...
  mutations: {
    [GET_LATEST]: function (state, data) {
      ...
      const fixed_d_g_step1_min = data.latest.d_g_step1_min.toFixed(1)
      const fixed_d_g_step1_max = data.latest.d_g_step1_max.toFixed(1)
      const fixed_d_g_step2_min = data.latest.d_g_step2_min.toFixed(1)
      const fixed_d_g_step2_max = data.latest.d_g_step2_max.toFixed(1)
      const fixed_d_g_step3_min = data.latest.d_g_step3_min.toFixed(1)
      const fixed_d_g_step3_max = data.latest.d_g_step3_max.toFixed(1)
      const Fixed = {
        d_g_step1_min: fixed_d_g_step1_min,
        d_g_step1_max: fixed_d_g_step1_max,
        d_g_step2_min: fixed_d_g_step2_min,
        d_g_step2_max: fixed_d_g_step2_max,
        d_g_step3_min: fixed_d_g_step3_min,
        d_g_step3_max: fixed_d_g_step3_max
      }
