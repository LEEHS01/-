...
export const GET_COAGULANT_LATEST = 'trtIndCoagulants/get'
...
export default {
  ...
  actions: {
    ...
    [PUT_CONTROL_AI]: async function ({ commit }, { c_cf_max, c_cf_min, c_cf_polymax_max, c_cf_polymax_min }) {
      await axios.put(`${DEV_SERVER}/`+'coagulant/control/ai/' + PROCESS_STEP, { c_cf_max, c_cf_min, c_cf_polymax_max, c_cf_polymax_min })
      .then((response) => {
        let _data = {
          visible: true,
          title: '설정 성공',
