...
export const PUT_TRTINDMIXING_CONTROL_AI = 'trtIndMixing/control/ai/put'
...
const PUT_CONTROL_AI = PUT_TRTINDMIXING_CONTROL_AI.substr(PUT_TRTINDMIXING_CONTROL_AI.indexOf('/') + 1)
...
export default {
  ...
  actions: {
    ...
    [PUT_CONTROL_AI]: async function ({ commit, state }, obj) {
      await axios.put(`${DEV_SERVER}/${URL.MIXING_CONTROL_AI}/` + state.processStep, obj)
      .then(() => {
