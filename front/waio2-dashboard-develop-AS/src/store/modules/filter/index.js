...
export default {
  ...
  state: {
    ...
    popup: {
      ...
      location: {
        ...
        f_time_per: null,
        ai_f_loc_ti: null,
        ai_f_bw_start_ti: null,
        // ai_f_loc_bw_wt_ti: null,
    ...
    schedule: {
      filter: {
        ...
        // location7: {'2013-09-04 09:00': 1, '2013-09-04 00:10': 2,'2013-09-04 00:20': 1, '2013-09-04 00:30': 2,'2013-09-04 00:40': 1, '2013-09-04 00:50': 2,'2013-09-04 01:00': 1, '2013-09-04 01:10': 2,'2013-09-04 01:20': 1, '2013-09-04 01:30': 2, '2013-09-04 01:40': 2, '2013-09-04 01:50': 2, '2013-09-04 02:00': 2, '2013-09-04 02:10': 2, '2013-09-04 02:20': 2, '2013-09-04 02:30': 2, '2013-09-04 02:40': 2, '2013-09-04 02:50': 2, '2013-09-04 03:00': 2,},
        // location8: {'2013-09-04 09:00': 1, '2013-09-04 00:10': 2,'2013-09-04 00:20': 1, '2013-09-04 00:30': 2,'2013-09-04 00:40': 1, '2013-09-04 00:50': 2,'2013-09-04 01:00': 1, '2013-09-04 01:10': 2,'2013-09-04 01:20': 1, '2013-09-04 01:30': 2, '2013-09-04 01:40': 2, '2013-09-04 01:50': 2, '2013-09-04 02:00': 2, '2013-09-04 02:10': 2, '2013-09-04 02:20': 2, '2013-09-04 02:30': 2, '2013-09-04 02:40': 2, '2013-09-04 02:50': 2, '2013-09-04 03:00': 2,},
        },
      gac: {
        location1: null,
        location2: null,
  ...
  getters: {
    ...
    getMinAiFLocationBwStartTi: function (state) {
      ...
      let isFirst = true
      for (let i = 1; i <= 8; i++) {
        if (state.latest.ai_f_bw_start_ti !== null) {
          let locationVal = state.latest.ai_f_bw_start_ti['location'+i]
          if (locationVal !== null) {
            if (isFirst) {
                if (locationVal > 0) {
                  minVal = locationVal
    ...
    getLocationState19: function (state) {
      if (state.latest.f_loc_stt && state.latest.f_loc_stt.location19) {
        return LOCATION_STATE[state.latest.f_loc_stt.location19]
      } else {
        return '--'
      }
    },
    getLocationState20: function (state) {
      if (state.latest.f_loc_stt && state.latest.f_loc_stt.location20) {
        return LOCATION_STATE[state.latest.f_loc_stt.location20]
      } else {
        return '--'
      }
    }
  ...
  mutations: {
    [GET_LATEST]: function (state, data) {
      ...
      const fixed_f_h_le1 = data.f_h_le1.toFixed(2)
      const fixed_f_h_le2 = data.f_h_le2.toFixed(2)
      const Fixed = {
        f_location_ti_set_max: data.f_location_ti_set_max,
        f_location_wl_max: fixed_f_location_wl_max,
        f_h_le1: fixed_f_h_le1,
        f_h_le2: fixed_f_h_le2,
      }
  ...
  actions: {
    ...
    [PUT_CONTROL_TI]: async function ({ commit }, { f_location_ti_set_max, f_location_wl_max, f_h_le1, f_h_le2 }) {
      await axios.put(`${DEV_SERVER}/${URL.FILTER_CONTROL_TI}`, { f_location_ti_set_max, f_location_wl_max, f_h_le1, f_h_le2 })
      .then(() => {
        commit('dialog/'+ CLOSE_AI_MODE_DIALOG, null, { root: true })
        let _data = {
          visible: true,
