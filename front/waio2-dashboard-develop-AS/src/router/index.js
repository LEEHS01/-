...
import DisinfectionPostAlgorithm from '@/components/disinfection/DisinfectionPostAlgorithm'
...
const routes = [
  ...
  { path: '/disinfectionPostAlgorithm', component: DisinfectionPostAlgorithm, name: 'DisinfectionPostAlgorithm' },
  { path: '/indReceivingAlgorithm', component: ReceivingAlgorithm, name: 'IndReceivingAlgorithm' },
  { path: '/trtIndReceivingAlgorithm', component: ReceivingAlgorithm, name: 'TrtIndReceivingAlgorithm'},
  { path: '/indDisinfectionAlgorithm', component: DisinfectionAlgorithm, name: 'IndDisinfectionAlgorithm' },
  { path: '/trtIndDisinfectionAlgorithm', component: DisinfectionAlgorithm, name: 'TrtIndDisinfectionAlgorithm' },
