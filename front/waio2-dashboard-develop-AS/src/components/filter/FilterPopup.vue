          ...
          <div class="information">
            ...
            <div class="contents-right">
              ...
              <div class="contents-text-box">
                ...
                <div class="contents-text-box__value">{{ this.$store.state.filter.popup.location.f_time_per / 60 | numFormat('0') }} / {{ this.$store.state.filter.popup.location.ai_f_loc_ti / 60 | numFormat('0') }}</div>
                <div class="contents-text-box__unit">시간</div>
              </div>
              <div class="contents-text-box">
                <div class="contents-text-box__title">· 역세 대기시간</div>
                <div class="contents-text-box__value">{{ this.$store.state.filter.popup.location.f_time_bw_per / 60 | numFormat('0') }}</div>
                <div class="contents-text-box__unit">시간</div>
              </div>
              <div class="contents-text-box">
    ...
    ChartMeter: function () {
      ...
      if (this.$store.state.filter.popup.location.ai_f_loc_le !== null && Object.keys(this.$store.state.filter.popup.location.ai_f_loc_le).length > 0) {
        ...
        for (let key in this.$store.state.filter.popup.location.ai_f_loc_le) {
          let value = this.$store.state.filter.popup.location.ai_f_loc_le[key] > 4.0 ? 4.0 : this.$store.state.filter.popup.location.ai_f_loc_le[key]
