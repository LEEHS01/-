      ...
      <div class="right">
          ...
          <div class="right-contents__leftCon">
            ...
            <div class="right-contents__wrap">
              ...
              <div class="right-contents__input-box">
                <input v-if="this.$store.state.filter.isModifyMode" type="text" :value="this.$store.state.filter.latestModify.f_location_ti_set_max" v-on:input="updateInput($event, 'f_location_ti_set_max')" maxlength="5"/><span v-else>{{ this.$store.state.filter.latest.f_location_ti_set_max | numFormat('0') }}</span>
              </div>
            </div>
            <div class="right-contents__wrap">
              <div class="right-contents__text-third">최대 한계 수위</div>
              <div class="right-contents__input-box">
                <input v-if="this.$store.state.filter.isModifyMode" type="text" :value="this.$store.state.filter.latestModify.f_location_wl_max" v-on:input="updateInput($event, 'f_location_wl_max')"/><span v-else>{{ this.$store.state.filter.latest.f_location_wl_max | numFormat('0.00') }}</span>
              </div>
            </div>
          </div>
          <div class="right-contents__rightCon">
            ...
            <div class="right-contents__wrap">
              ...
              <div class="right-contents__input-box">
                ...
                :value="this.$store.state.filter.latestModify.f_h_le1" v-on:input="updateInput($event, 'f_h_le1')"/>
                <span v-else>{{ this.$store.state.filter.latestModify.f_h_le1 | numFormat('0.00') }}</span>
              </div>
            </div>
            <div class="right-contents__wrap">
              ...
              <div class="right-contents__input-box">
                <input v-if="this.$store.state.filter.isModifyMode" type="text" 
                :value="this.$store.state.filter.latestModify.f_h_le2" v-on:input="updateInput($event, 'f_h_le2')"/>
                <span v-else>{{ this.$store.state.filter.latestModify.f_h_le2 | numFormat('0.00') }}</span>
              </div>
            </div>
          </div>
        ...
        <!-- <div class="right-contents" style="flex-direction: column; width: 220px;">
          ...
          <div class="right-contents__wrap">
            ...
            <div class="right-contents__input-box">
              <input v-if="this.$store.state.filter.isModifyMode" type="text" :value="this.$store.state.filter.latestModify.f_location_ti_set_max" v-on:input="updateInput($event, 'f_location_ti_set_max')"/><span v-else>{{ this.$store.state.filter.latest.f_location_ti_set_max | numFormat('0') }}</span>
            </div>
          </div>
...
import { PUT_FILTER_CONTROL_TI, GET_FILTER_SCHEDULE } from '@/store/modules/filter'
export default {
  name:'FbAlgorithm',
  data: () => ({
    isModifyMode: false,
  ...
  methods: {
    ...
    updateControl: function() {
      ...
      if (this.$store.state.filter.isModifyMode) {
        ...
        || this.$store.state.filter.latestModify.f_h_le1 === ''
        || this.$store.state.filter.latestModify.f_h_le2 === '') {
        ...
        } else if (parseFloat(this.$store.state.filter.latestModify.f_h_le1) < wl_min 
        || parseFloat(this.$store.state.filter.latestModify.f_h_le1) > wl_max
        || parseFloat(this.$store.state.filter.latestModify.f_h_le2) < wl_min 
        || parseFloat(this.$store.state.filter.latestModify.f_h_le2) > wl_max) {
          ...
          obj.f_h_le1 = parseFloat(this.$store.state.filter.latestModify.f_h_le1).toFixed(2)
          obj.f_h_le2 = parseFloat(this.$store.state.filter.latestModify.f_h_le2).toFixed(2)
          ...
          this.$store.state.filter.latest.f_h_le1 = parseFloat(this.$store.state.filter.latestModify.f_h_le1).toFixed(2)
          this.$store.state.filter.latest.f_h_le2 = parseFloat(this.$store.state.filter.latestModify.f_h_le2).toFixed(2)
        }
      } else {
        this.$store.state.filter.isModifyMode = !this.$store.state.filter.isModifyMode
      }
    ...
    cancelControl: function () {
      ...
      this.$store.state.filter.latestModify.f_h_le1 = this.$store.state.filter.latest.f_h_le1
      this.$store.state.filter.latestModify.f_h_le2 = this.$store.state.filter.latest.f_h_le2
      this.$store.state.filter.isModifyMode = !this.$store.state.filter.isModifyMode
    },
