    ...
    <div class="contents-container">
      ...
      <div class="contents-box paddingfix">
        <div class="box">
          ...
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$store.state.filter.latest.f_time_per.location1 / 60 | numFormat('0') }} / {{ this.$store.state.filter.latest.ai_f_loc_ti.location1 / 60 | numFormat('0') }}</div>
            <div class="box-value-contents__unit">시간</div>
          </div>
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$minusToZero(this.$store.state.filter.latest.ai_f_bw_start_ti.location1) / 60 | numFormat('0') }}</div>
        ...
        <div class="box bottom-contents">
          ...
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$store.state.filter.latest.f_time_per.location5 / 60 | numFormat('0') }} / {{ this.$store.state.filter.latest.ai_f_loc_ti.location5 / 60 | numFormat('0') }}</div>
            <div class="box-value-contents__unit">시간</div>
          </div>
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$minusToZero(this.$store.state.filter.latest.ai_f_bw_start_ti.location5) / 60 | numFormat('0') }}</div>
            <div class="box-value-contents__unit">시간 후</div>
          </div>
          <div class="box-contents-title img-position-bottom" :style="isRest(5)" :class="[ this.isFiltering(5) ? 'on' : 'off']" @click="openSbPopup(5)">5지 {{ this.$store.getters['filter/getLocationState5'] }}</div>
        </div>
      </div>
      <!-- 2지 6지 -->
      <div class="contents-box">        
        <div class="box">
          ...
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$store.state.filter.latest.f_time_per.location2 / 60 | numFormat('0') }} / {{ this.$store.state.filter.latest.ai_f_loc_ti.location2 / 60 | numFormat('0') }}</div>
            <div class="box-value-contents__unit">시간</div>
          </div>
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$minusToZero(this.$store.state.filter.latest.ai_f_bw_start_ti.location2) / 60 | numFormat('0') }}</div>
            <div class="box-value-contents__unit">시간 후</div>
          </div>
        </div>
        <div class="box bottom-contents">
          ...
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$store.state.filter.latest.f_time_per.location6 / 60 | numFormat('0') }} / {{ this.$store.state.filter.latest.ai_f_loc_ti.location6 / 60 | numFormat('0') }}</div>
            <div class="box-value-contents__unit">시간</div>
          </div>
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$minusToZero(this.$store.state.filter.latest.ai_f_bw_start_ti.location6) / 60 | numFormat('0') }}</div>
            <div class="box-value-contents__unit">시간 후</div>
          </div>
          <div class="box-contents-title img-position-bottom" :style="isRest(6)" :class="[ this.isFiltering(6) ? 'on' : 'off']" @click="openSbPopup(6)">6지 {{ this.$store.getters['filter/getLocationState6'] }}</div>
        </div>
      </div>
      <!-- 3지 7지 -->
      <div class="contents-box">        
        <div class="box">
          ...
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$store.state.filter.latest.f_time_per.location3 / 60 | numFormat('0') }} / {{ this.$store.state.filter.latest.ai_f_loc_ti.location3 / 60 | numFormat('0') }}</div>
            <div class="box-value-contents__unit">시간</div>
          </div>
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$minusToZero(this.$store.state.filter.latest.ai_f_bw_start_ti.location3) / 60 | numFormat('0') }}</div>
            <div class="box-value-contents__unit">시간 후</div>
          </div>
        </div>
        <div class="box bottom-contents">
          ...
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$store.state.filter.latest.f_time_per.location7 / 60 | numFormat('0') }} / {{ this.$store.state.filter.latest.ai_f_loc_ti.location7 / 60 | numFormat('0') }}</div>
            <div class="box-value-contents__unit">시간</div>
          </div>
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$minusToZero(this.$store.state.filter.latest.ai_f_bw_start_ti.location7) / 60 | numFormat('0') }}</div>
            <div class="box-value-contents__unit">시간 후</div>
          </div>
          <div class="box-contents-title img-position-bottom" :style="isRest(7)" :class="[ this.isFiltering(7) ? 'on' : 'off']" @click="openSbPopup(7)">7지 {{ this.$store.getters['filter/getLocationState7'] }}</div>
        </div>
      </div>
      <!--4지 8지 -->
      <div class="contents-box">        
        <div class="box">
          ...
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$store.state.filter.latest.f_time_per.location4 / 60 | numFormat('0') }} / {{ this.$store.state.filter.latest.ai_f_loc_ti.location4 / 60 | numFormat('0') }}</div>
            <div class="box-value-contents__unit">시간</div>
          </div>
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$minusToZero(this.$store.state.filter.latest.ai_f_bw_start_ti.location4) / 60 | numFormat('0') }}</div>
            <div class="box-value-contents__unit">시간 후</div>
          </div>
        </div>
        <div class="box bottom-contents">
          ...
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$store.state.filter.latest.f_time_per.location8 / 60 | numFormat('0') }} / {{ this.$store.state.filter.latest.ai_f_loc_ti.location8 / 60 | numFormat('0') }}</div>
            <div class="box-value-contents__unit">시간</div>
          </div>
          <div class="box-value-contents">
            <div class="box-value-contents__value">{{ this.$minusToZero(this.$store.state.filter.latest.ai_f_bw_start_ti.location8) / 60 | numFormat('0') }}</div>
            <div class="box-value-contents__unit">시간 후</div>
          </div>
...
.contents-container{
  ...
  width: 1602px;
  height: 369px;
  background-image: url('../../assets/as_images/asan_sub_08.png');
