<template>
  <div class="main">
    ...
    <div class="contents">
      <!-- 중앙 컨텐츠 -->
      <IndSedimentationContents/>
    </div>
    <div class="bottom">
      <!-- 하단 컨텐츠 -->
      <IndSedimentationHighchart/>
    </div>
  </div>  
</template>
<script>
import IndSedimentationContents from '@/components/indSedimentation/IndSedimentationContents' 
import IndSedimentationHighchart from '@/components/indSedimentation/IndSedimentationHighchart' 
...
export default {
  name:'IndSedimentationAlgorithm',
  data: () => ({
  ...
  mounted: function() {
    ...
    this.$store.state.selectedBuildingIndex = 21
