      ...
      <div class="two-contents">
        ...
        <div class="small-contents">
          ...
          <div class="real-box">
            ...
            <div class="real-value">{{ this.$store.state.coagulants.latest.c1_cf | numFormat('0.00') }}</div>
          </div>
...
export default {
  ...
  computed: {
    ...
    // 공업 침전지 탁도 정규 분포 차트 데이터
    ScatterData1() {
      if (this.$store.state.sedimentation.tbScatter.series1 != null && Object.keys(this.$store.state.sedimentation.tbScatter.series1).length > 0) {
        let ar = []
