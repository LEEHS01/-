<template>
  <div v-if="this.$store.state.trtIndCoagulants.popup.visible" class="main">
      ...
      <div class="popup-contents">
        ...
        <div class="record-table">
          <table class="search-table">
            ...
            <tbody>
              <template v-for="item in $store.state.trtIndCoagulants.popup.class_info">
...
export default {
  ...
  methods: {
    ...
    clickModifyBtn: function(class_index) {
      let elem = {}
      elem.class_index = this.$store.state.trtIndCoagulants.popup.class_info[class_index - 1].class_index
      elem.cu = this.$store.state.trtIndCoagulants.popup.class_info[class_index - 1].cu
      elem.description = this.$store.state.trtIndCoagulants.popup.class_info[class_index - 1].description
      elem.ph = this.$store.state.trtIndCoagulants.popup.class_info[class_index - 1].ph
      elem.tb = this.$store.state.trtIndCoagulants.popup.class_info[class_index - 1].tb
      elem.te = this.$store.state.trtIndCoagulants.popup.class_info[class_index - 1].te
      elem.isModify = true
      this.$store.state.trtIndCoagulants.popup.class_info[class_index - 1] = elem
      this.$store.state.trtIndCoagulants.popup.class_info = this.$store.state.trtIndCoagulants.popup.class_info.slice(0)
    },
    /**
     * 수정 완료 버튼 클릭시
    ...
    clickOkBtn: function(class_index) {
      this.$store.state.trtIndCoagulants.popup.class_info.map(it => {
        if (it.class_index === class_index) {
          it.isModify = false
        }
      })
      this.$store.state.trtIndCoagulants.class_info = this.$store.state.trtIndCoagulants.popup.class_info
      let elem = this.$store.state.trtIndCoagulants.class_info[class_index - 1]
