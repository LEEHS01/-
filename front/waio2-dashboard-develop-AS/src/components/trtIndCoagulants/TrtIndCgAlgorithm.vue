          ...
          <div class="apac">
            ...
            <div class="upper-limit">
              ...
              <div class="injection-rate__input-box" :class="{'': this.$store.state.coagulants.isModifyMode}">
                ...
                <span class="injection-rate__text--num" v-else>{{ this.$store.state.coagulants.latestModify.c_cf_max | numFormat('0.00') }}</span>
              </div>
            </div>
            <div class="lower-limit">
              ...
              <div class="injection-rate__input-box" :class="{'': this.$store.state.coagulants.isModifyMode}">
                ...
                <span class="injection-rate__text--num" v-else>{{ this.$store.state.coagulants.latestModify.c_cf_min | numFormat('0.00') }}</span>
              </div>
            </div>
          </div>
          <!-- 목표 침전지 탁도 -->
...
<script>
import CoagulantsLeftContents from '@/components/trtIndCoagulants/TrtIndCoagulantsLeftContents' 
import CoagulantsRightContents from '@/components/trtIndCoagulants/TrtIndCoagulantsRightContents'
...
export default {
    ...
    updateControl: function() {
      ...
      if (this.$store.state.coagulants.isModifyMode) {
        if (this.$store.state.coagulants.latestModify.c_cf_max === ''
          ...
          let obj = {}
          obj.c_cf_max = parseFloat(this.$store.state.coagulants.latestModify.c_cf_max).toFixed(2)
          obj.c_cf_min = parseFloat(this.$store.state.coagulants.latestModify.c_cf_min).toFixed(2)
          obj.c_user_tb_e = parseFloat(this.$store.state.coagulants.latestModify.c_user_tb_e).toFixed(2)
   ...
   */
  mounted: function () {
    this.$store.state.coagulants.processStep = 3
