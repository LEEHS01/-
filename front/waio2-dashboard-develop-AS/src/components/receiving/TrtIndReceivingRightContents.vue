<template>
  <div class="center-container">
    ...
    <div class="img-contents">
      <div class="btn-tab">
        <div class="box-center-margin" :class="[ this.$store.state.receiving.processStep === 2 ? 'btn-tab__box-abled' : 'btn-tab__box-disabled']" @click="$routingByIndex(22)">2단계생활</div>
        <div :class="[ this.$store.state.receiving.processStep === 3 ? 'btn-tab__box-abled' : 'btn-tab__box-disabled']" @click="$routingByIndex(23)">3단계공업</div>
        <div :class="[ this.$store.state.receiving.processStep === 1 ? 'btn-tab__box-abled' : 'btn-tab__box-disabled']" @click="$routingByIndex(1)" >펌프제어</div>
      </div>
      ...
      <div class="valve-box five-value-position">
        <div class="valve-box__text">정수지 유출 유량</div>
        <div class="box">
...
<script>
export default {
  name: 'TrtIndReceivingRightContents',
  data: () => ({
...
.center-container{
  ...
  .img-contents{
    width: 592px;
    height: 460px;
    background-image: url('../../assets/as_images/sub_01.png');
