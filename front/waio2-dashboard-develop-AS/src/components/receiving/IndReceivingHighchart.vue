  ...
  <div class="chart-container">
    ...
    <div class="chart-contents">
      <div class="chart-title">
        <div class="chart-title__text">필요원수 유입유량 예측</div>
      </div>
      <div class="chart">
...
export default {
  ...
  computed: {
    ...
    ChartReceivingWaterFlow: function () {
      ...
      if (this.$store.state.receiving.latest.ai_b_out_fr_rtd !== null) {
        ...
        for (let key in this.$store.state.receiving.latest.ai_b_out_fr_rtd) {
          dataSeries1.push([new Date(key).getTime(), parseInt(this.$store.state.receiving.latest.ai_b_out_fr_rtd[key])])
        }
        chart.series.push({
          name: '정수지 유출 유량 ',
          data: dataSeries1,
    ...
    ChartRawWaterFlow: function () {
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_필요원수 유입유량'
