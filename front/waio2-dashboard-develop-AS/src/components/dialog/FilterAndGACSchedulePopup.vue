          ...
          <div class="mid">
            <div class="table-schedule">
              ...
              <div class="table-schedule--th" style="margin-bottom: 10px;">
                <div class="table-schedule--ji" v-for="index in 8" :key="index">
                  <div>{{ index }}지</div>
                </div>
              </div>
              <div class="table-schedule--tbody">
                <div v-for="(item, index) in new Array(19)" :key="index" class="table-schedule--td">
                  <div :class="getClassByLoad(getFilterStatusByNumJiAndIndex(5, index).key).className">{{ getFilterStatusByNumJiAndIndex(1, index).key.split(' ')[1] }}</div>
...
.main-outter{
  ...
  .popup-main{
    ...
    .popup-contents{
      ...
      width: 870px;
      height: 1024px;
      background-image: url('../../assets/as_images/background_filter_schedule.png');
      ...
      .mid {
        ...
        .table-schedule {
          ...
          &--tbody {            
            ...
            width: 824px;
            height: 736px;
            background-image: url('../../assets/as_images/background_tbody.png');
            background-size: 100% 100%;
          }
          &--td {
            position: relative;
