<template>
  <div class="main">
    <div class="top-contents">
        ...
        <div class="big-contents">
          <div class="contents-value">
            ...
            <div class="value-container">
              ...
              <div class="value-container__title">후염소1</div>
              <div class="value-container__title">후염소2</div>
            </div>
            <div class="value-container">
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.d_ser_cl | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
              <div class="value-container__one">· 현재 주입률(ppm)</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_pre_chlorination | numFormat('0.00') }}</div>
      ...
      <div class="two-contents">
        ...
        <div class="small-contents">
          <div class="little-title-one">후염소 증발량 예측</div>
          <div class="small-contents-value">
            <div class="small-contents-value__title">후염소1</div>
            <div class="value">
            ...
            <div class="small-contents-value__title margintop">후염소2</div>
            <div class="value">
              <div class="value__num">{{ this.$store.state.disinfection.latest.g_ser_cl_eva | numFormat('0.00') }}</div>
              <div class="value__unit">ppm</div>
            </div>
            <div class="contents-value-underbar"></div>
          </div>
      ...
      <div class="three-contents">
        ...
        <div class="three-small-contents">
          ...
          <div class="three-small-contents-value">
            <div class="three-small-contents-value__title">후염소1</div>
            ...
            <div class="three-small-contents-value__title margintop">후염소2</div>
            <div class="three-value">
    ...
    <div class="bottom-contents">
      <div class="contents">
        <div class="contents__title">후염소 증발량 예측 비교</div>
