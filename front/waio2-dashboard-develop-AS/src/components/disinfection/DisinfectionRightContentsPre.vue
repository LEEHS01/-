<template>
  <div class="main">
    <div class="top-contents">
      ...
      <div class="arrow-animate-two" v-if="this.$store.state.disinfection.processStep == 2"></div>
        ...
        <div class="big-contents">
          <div class="contents-value">
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_tei | numFormat('0.00') }}</div>
            </div>
            <div class="value-container">
            ...
            <template v-if="this.$store.state.disinfection.processStep == 2">
              <div class="value-container">
      ...
      <!-- 2단계 생활 전차염 -->
      <div class="two-contents" v-if="this.$store.state.disinfection.processStep == 2">
        ...
        <div class="small-contents">
          ...
          <div class="small-contents-value">
            ...
            <div class="value">
              <div class="value__num">{{ this.$store.state.disinfection.latest.ai_g_pre_evaporation | numFormat('0.00') }}</div>
      ...
      <div class="three-contents-two" v-if="this.$store.state.disinfection.processStep == 2">
        <div class="three-contents-two__title-two">
          예측결과
          <div class="three-contents-two__timerbox-outter">
            <div class="timerbox">
              {{ this.$store.state.disinfection.latest.upd_ti | moment('YYYY-MM-DD HH:mm:ss') }}
            </div>
          </div>
        </div>
        <div class="three-small-contents-two">
          ...
          <div class="three-small-contents-value-two">
            <div class="three-small-contents-value-two__title">{{ getPumpRun }}</div> 
            ...
            <div class="three-contents-value-underbar-two"></div>
          </div>
        </div>
      </div>
      <!-- 1,3단계 공업 전차염 -->
      <div class="three-contents" v-if="this.$store.state.disinfection.processStep != 2">
    ...
    <div class="bottom-contents" v-show="this.$store.state.disinfection.processStep != 2">
      <div class="contents" style="width:100%"> 
        <div class="contents__title">전차염 주입률 예측 비교</div>
    ...
    <div class="bottom-contents" v-show="this.$store.state.disinfection.processStep == 2">
      ...
      <div class="contents paddingleft">
        ...
        <div class="real-box real-three">
          ...
          <div class="real-value">{{ this.$store.state.disinfection.latest.g_e_residual_cl | numFormat('0.00') }}</div>
        </div>            
        <div class="contents-gragh">
...
export default {
  ...
  computed: {
    getPumpRun: function() {
      let pumpRun = ''
      if(this.$store.state.disinfection.latest.g_pump_1_run == 1) pumpRun += '펌프1'
      if(this.$store.state.disinfection.latest.g_pump_2_run == 1) pumpRun += '펌프2'
      return pumpRun
    },
    ChartOptionCholRate: function () {
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_전차염 주입률 예측 비교'
      return chart
    },
  ...
  methods: {
    downloadExcel: function() {
      ...
      XLSX.writeFile(wb, `${this.$moment().format('YYYYMMDDHHmmss')}_전차염 주입률 예측 비교.xlsx`);
    }
  },
...
.top-contents{
  ...
  .three-contents{
    ...
    .three-small-contents{
      ...
      height: 356px;
      margin-top: 10px;
      background-image: url('../../assets/as_images/three_background.png');
      .three-small-contents-value{
        ...
        .three-contents-value-underbar{
          width: 100%;
          height: 36px;
          background-image: url('../../assets/as_images/contents_value_underbar.png');
    ...
    &__title{
      ...
      height: 53px;
      padding-left: 40px;
      background-image: url('../../assets/as_images/contents_right_title.png');
      text-shadow: 0 0 9px #5cafff;
      font-size: 18px;
      font-weight: normal;
      font-stretch: normal;
  ...
  .three-contents-two{
    ...
    .three-small-contents-two{
      ...
      .three-small-contents-value-two{
        ...
        // 숫자 아래 이미지
        .three-contents-value-underbar-two{
          width: 316px;
          height: 36px;
