<template>
  <div class="main">
    ...
    <div class="top">
      <div class="title">후차염<p>세부 현황</p></div>
      <div class="right">
    ...
    <div class="contents">
      <div class="contents__left">
        <DisinfectionLeftContentsAfter :processTitle = "this.processTitle" />
      </div>
      <div class="contents__right">
        <DisinfectionRightContentsAfter :processTitle = "this.processTitle" />
      </div>
    </div>
  </div>  
</template>
...
import { GET_DISINFECTION_LATEST, PUT_DISINFECTION_HISTORY_EVAPORATION, PUT_DISINFECTION_HISTORY_CHOL_RATE_POST } from '@/store/modules/disinfection'
  ...
  methods: {
    ...
    dataDetail: function() {
      ...
      Promise.all([
        ...
        this.$store.dispatch(PUT_DISINFECTION_HISTORY_CHOL_RATE_POST),
