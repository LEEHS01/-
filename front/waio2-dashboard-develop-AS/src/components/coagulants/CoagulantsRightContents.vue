      ...
      <div class="two-contents">
        ...
        <div class="small-contents">
          ...
          <div class="small-contents-value">
            <div class="small-contents-value__title"><span>{{ getNowInjector }}</span>{{ this.$store.state.coagulants.latest.c_cf_coagulant }}</div>
            <div class="value">
      ...
      <div class="three-contents">
        ...
        <div class="three-small-contents">
          <div class="three-small-contents-value">
            <div class="three-small-contents-value__title"><span>{{ getNowInjector }}</span> {{ this.$store.state.coagulants.latest.c_cf_coagulant }}</div>
...
export default {
  ...
  computed: {
    getNowInjector() {
      return this.$store.state.coagulants.latest.c_injector1 == 1 ? '1호기' : '2호기'
    },
    // 생활 침전지 탁도 정규 분포 차트 데이터
    ScatterData1() {
