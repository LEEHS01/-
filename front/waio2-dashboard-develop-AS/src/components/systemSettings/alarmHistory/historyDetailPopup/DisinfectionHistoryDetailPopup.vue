<template>
  <div v-if="this.$store.state.alarm.visible && this.$store.state.alarm.alarmsDetail.procCd.includes('G')" class="popup-wrap">
        ...
        <div class="one-contents">
          ...
          <div class="big-contents">
            <div class="contents-value" v-if="this.$store.state.alarm.selectedDisinfectionIndex == 1">
              ...
              <div v-if="this.$store.state.alarm.alarmsDetail.procCd == 'G2'" class="value-container">
            ...
            <div class="contents-value" v-if="this.$store.state.alarm.selectedDisinfectionIndex == 3">
              <div class="value-container">
