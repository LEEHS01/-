<template>
  <div v-if="this.$store.state.alarm.visible && this.$store.state.alarm.alarmsDetail.procCd.includes('B')" class="popup-wrap">
...
.popup-wrap {
  ...
  .popup-main{
    ...
    background-image: url('../../../../assets/as_images/popup_main.png');
