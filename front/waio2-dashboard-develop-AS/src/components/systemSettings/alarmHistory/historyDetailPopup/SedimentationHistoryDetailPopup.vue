<template>
  <div v-if="this.$store.state.alarm.visible && this.$store.state.alarm.alarmsDetail.procCd.includes('E')" class="popup-wrap">
          ...
          <div class="big-contents">
            <div class="contents-value">
              ...
              <div class="value-container">
                ...
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.mm_fr | numFormat('0.00') }}</div>
                <div class="value-container__three">ℓ/h</div>
              </div>
              <div v-if="this.$store.state.alarm.alarmsDetail.procCd == 'E1'" class="value-container">
                <div class="value-container__one">· 폴리아민 주입률</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.c_mm_fr_etc | numFormat('0.00') }}</div>
                <div class="value-container__three">ppm</div>
              </div>
              <div v-else-if="this.$store.state.alarm.alarmsDetail.procCd == 'E2'" class="value-container">
                <div class="value-container__one">· 활성탄 주입률</div>
...
export default {
  ...
  computed: {
    getCoagulantName() {
      return this.coagulantCodeMap[this.$store.state.alarm.alarmsDetail.factorMap.c_cf_coagulant]
    }
  },
  methods: {
