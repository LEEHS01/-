        ...
        <div class="popup-contents">
          ...
          <div class="contents">
            <div class="contents-value">
              ...
              <div class="contents-value__box">
                <div class="box-text width50">{{ this.$store.state.sedimentation.popup.location.mm_fr | numFormat('0.00') }}</div>
            ...
            <div class="contents-img">
              ...
              <div class="contents-img-box">
                <div class="contents-img-box__top" :style="{ marginLeft: (70 + (this.$store.state.sedimentation.popup.location.e_sc_f * this.popupScDividedValue)) + 'px' }"></div>
                <div class="contents-img-box__bottom" :style="{ marginLeft: (this.$store.state.sedimentation.popup.location.e_sc_b * this.popupScDividedValue) + 'px' }"></div>
              </div>
