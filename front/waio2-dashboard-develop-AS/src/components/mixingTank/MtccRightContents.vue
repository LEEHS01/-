        ...
        <div class="top-container">
          <div class="top-one-contents-box">
            ...
            <div class="top-one-contents-value">
              ...
              <span class="top-one-contents-value__span" v-else>{{ this.$store.state.mixing.latestModify.d_g_value1 | numFormat('0.0')}}</span>
            ...
            <div class="top-one-contents-value">
              ...
              <span class="top-one-contents-value__span" v-else>{{ this.$store.state.mixing.latestModify.d_g_value2 | numFormat('0.0')}}</span>
              <div class="top-one-contents-value__unit">sec<sup>-1</sup></div>
            </div>
            <div class="top-one-contents-value">
              ...
              <span class="top-one-contents-value__span" v-else>{{ this.$store.state.mixing.latestModify.d_g_value3 | numFormat('0.0') }}</span>
              <div class="top-one-contents-value__unit">sec<sup>-1</sup></div>
            </div>
...
export default {
  ...
  methods: {
    ...
    /**
     * 선택한 지의 power number 반환
     * 
     * @param location 지
     * @return power number
     */
    getLocationPowerNumber: function(location) {
      return this.$store.state.mixing.latest['d_pw' + location]
    },
    /**
     * 선택한 지의 임펠러 직경 반환
     * 
     ...
     * @return power number
     */
     getLocationDimd: function(location) {
      return this.$store.state.mixing.latest['d_im_d' + location]
    },
    ...
    onClickDetail: function() { 
      ...
      this.$store.state.dialog.autoModeCrt.processStep = this.$store.state.mixing.processStep
      this.$store.state.dialog.autoModeCrt.d_g_step1_crt = this.$store.state.mixing.latestModify.d_g_step1_crt.toFixed(2)
      this.$store.state.dialog.autoModeCrt.d_g_step2_crt = this.$store.state.mixing.latestModify.d_g_step2_crt.toFixed(2)
      this.$store.state.dialog.autoModeCrt.d_g_step3_crt = this.$store.state.mixing.latestModify.d_g_step3_crt.toFixed(2)
    }    
  },
  /**
   * 마운트 해제시 
