<template>
  <div class="main">
    <div class="btn-tab">
      ...
      <div class="btn-tab__box-disabled" @click="$routingByIndex(17)">3단계공업</div>
    </div>
    <!-- 혼화응집 공정 이미지 -->
    <div class="contents-img">
      ...
      <div class="select-box">
        <div v-for="index in [1,2,3,4]" :key="index" class="select-box__element" @click="$store.state.mixing.selectedFCLocation = index" :class="{ 'select-box__element--focused': $store.state.mixing.selectedFCLocation === index}"><span>{{ index }}지</span></div>
      </div>
