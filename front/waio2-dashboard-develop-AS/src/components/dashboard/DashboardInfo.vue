  ...
  <div class="dashboard-info-container">
    ...
    <div class="top-contents">
      ...
      <div class="left-contents">
        ...
        <!-- 전체 운영모드 변경 버튼 -->
        <div class="ai-btn-contents" v-if="this.$store.state.login.user.tkn !== null" >
        ...
        <div class="left-contents-scroll">
          <div class="part-contents__text">1단계공업</div>
          <!-- 착수 AI 모드 제어 -->
          <div class="btn-contents" :class="{selected: [0, 1, 9, 10, 22].includes(this.$store.state.selectedBuildingIndex)}">
            ...
            <div class="btn-contents__btn">
              <div class="control_box_operation">
                ...
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(1, 2, 1)">AI</div>
                ...
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(1, 0, 1)">AI분석</div>
              </div>
            </div>
          </div>
            <!-- 약품 AI 모드 제어 -->
            ...
            <div class="btn-contents" :class="{selected: this.$store.state.selectedBuildingIndex === 7}">
              ...
              <div class="btn-contents__btn">
                <div class="control_box_operation control_box_operation--disinfection">
                  ...
                  <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7.1, 2, 1, 'pre')">AI</div>
                  ...
                  <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7.1, 1, 1, 'pre')">AI추천</div>
                  ...
                  <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7.1, 0, 1, 'pre')">AI분석</div>
                </div>
              </div>
            </div>
          ...
          <div class="btn-contents" :class="{selected: [0, 1, 9, 10, 22].includes(this.$store.state.selectedBuildingIndex)}">
            ...
            <div class="btn-contents__btn">
              <div class="control_box_operation control_box_operation--disinfection">
                ...
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7.4, 2, 2, 'pre')">AI</div>
                ...
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7.4, 1, 2, 'pre')">AI추천</div>
                ...
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7.4, 0, 2, 'pre')">AI분석</div>
              </div>
              <div class="control_box_operation control_box_operation--disinfection">
                ...
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7.3, 2, 2, 'post')">AI</div>
                ...
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7.3, 1, 2, 'post')">AI추천</div>
                ...
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7.3, 0, 2, 'post')">AI분석</div>
              </div>
            </div>
            </div>
          <div class="part-contents__text">3단계공업</div>
          <!-- 착수 AI 모드 제어 -->
          <div class="btn-contents" :class="{selected: [0, 1, 9, 10, 22].includes(this.$store.state.selectedBuildingIndex)}">
            <div class="btn-contents__text">착수</div>
            <div class="btn-contents__btn">
              <div class="control_box_operation">
                ...
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(1, 2, 3)">AI</div>
                ...
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(1, 1, 3)">AI추천</div>
                ...
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(1, 0, 3)">AI분석</div>
              </div>
            </div>
          </div>
            <!-- 약품 AI 모드 제어 -->
            <div class="btn-contents" :class="{selected: this.$store.state.selectedBuildingIndex === 16}">
            <div class="btn-contents__text">약품</div>
            <div class="btn-contents__btn">
              <div class="control_box_operation">
                <div v-if="$store.state.dashboard.processStep3.coagulants === 2" class="control_box_operation__btn control_box_operation__btn--on">AI</div>
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(16, 2)">AI</div>
                <div v-if="$store.state.dashboard.processStep3.coagulants === 1" class="control_box_operation__btn control_box_operation__btn--on">AI추천</div>
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(16, 1)">AI추천</div>
                <div v-if="$store.state.dashboard.processStep3.coagulants === 0" class="control_box_operation__btn control_box_operation__btn--on">AI분석</div>
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(16, 0)">AI분석</div>
              </div>
            </div>
            </div>
            <!-- 혼화응집 AI 모드 제어 -->
            <div class="btn-contents" :class="{selected: this.$store.state.selectedBuildingIndex === 17}">
            <div class="btn-contents__text">혼화응집</div>
            <div class="btn-contents__btn">
              <div class="control_box_operation">
                <div v-if="$store.state.dashboard.processStep3.mixing === 2" class="control_box_operation__btn control_box_operation__btn--on">AI</div>
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(17, 2)">AI</div>
                <div v-if="$store.state.dashboard.processStep3.mixing === 1" class="control_box_operation__btn control_box_operation__btn--on">AI추천</div>
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(17, 1)">AI추천</div>
                <div v-if="$store.state.dashboard.processStep3.mixing === 0" class="control_box_operation__btn control_box_operation__btn--on">AI분석</div>
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(17, 0)">AI분석</div>
              </div>
            </div>
            </div>
            <!-- 침전 AI 모드 제어 -->
            <div class="btn-contents" :class="{selected: this.$store.state.selectedBuildingIndex === 18}">
            <div class="btn-contents__text">침전</div>
            <div class="btn-contents__btn">
              <div class="control_box_operation">
                <div v-if="$store.state.dashboard.processStep3.sedimentation === 2" class="control_box_operation__btn control_box_operation__btn--on">AI</div>
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(18, 2, 3)">AI</div>
                <div v-if="$store.state.dashboard.processStep3.sedimentation === 1" class="control_box_operation__btn control_box_operation__btn--on">AI추천</div>
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(18, 1, 3)">AI추천</div>
                <div v-if="$store.state.dashboard.processStep3.sedimentation === 0" class="control_box_operation__btn control_box_operation__btn--on">AI분석</div>
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(18, 0, 3)">AI분석</div>
              </div>
            </div>
            </div>
            <!-- 소독 AI 모드 제어 -->
            ...
            <div class="btn-contents__btn">
              <div class="control_box_operation control_box_operation--disinfection">
                <div v-if="$store.state.dashboard.processStep3.disinfectionPre === 2" class="control_box_operation__btn control_box_operation__btn--on">AI</div>
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7.5, 2, 3, 'pre')">AI</div>
                <div v-if="$store.state.dashboard.processStep3.disinfectionPre === 1" class="control_box_operation__btn control_box_operation__btn--on">AI추천</div>
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7.5, 1, 3, 'pre')">AI추천</div>
                <div v-if="$store.state.dashboard.processStep3.disinfectionPre === 0" class="control_box_operation__btn control_box_operation__btn--on">AI분석</div>
                <div v-else class="control_box_operation__btn control_box_operation__btn--off" @click="onClickAICheckbox(7.5, 0, 3, 'pre')">AI분석</div>
              </div>
            </div>
            </div>
        </div>
      ...
      <!-- 착수 예측 결과 -->
      <Result1 v-if="this.$store.state.selectedBuildingIndex === 0 || this.$store.state.selectedBuildingIndex === 1 || this.$store.state.selectedBuildingIndex === 22" :isAiOn="this.$store.state.dashboard.processStep2.receiving"/>
      <!-- 약품 예측 결과 -->
      <Result2 v-if="this.$store.state.selectedBuildingIndex === 2 || this.$store.state.selectedBuildingIndex === 16 || this.$store.state.selectedBuildingIndex === 19" :isAiOn="this.$store.state.dashboard[this.$store.state.dashboard.processStep].coagulants"/>
      <!-- 혼화응집 예측 결과 -->
      <Result3 v-if="this.$store.state.selectedBuildingIndex === 3 || this.$store.state.selectedBuildingIndex === 17 || this.$store.state.selectedBuildingIndex === 20" :isAiOn="this.$store.state.mixing"/>
      <!-- 침전 예측 결과 -->
      <Result4 v-if="this.$store.state.selectedBuildingIndex === 4 || this.$store.state.selectedBuildingIndex === 18 || this.$store.state.selectedBuildingIndex === 21" :isAiOn="this.$store.state.sedimentation"/>
      <!-- 여과 예측 결과 -->
      <Result5 v-if="this.$store.state.selectedBuildingIndex === 5" :isAiOn="this.$store.state.filter"/>
      <!-- 소독 예측 결과 -->
      <Result7 v-if="this.$store.state.selectedBuildingIndex === 7 || this.$store.state.selectedBuildingIndex === 7.1 || this.$store.state.selectedBuildingIndex === 7.3 || this.$store.state.selectedBuildingIndex === 7.4 || this.$store.state.selectedBuildingIndex === 7.5" :isAiOn="this.$store.getters['disinfection/isAiOperationMode']"/>
    </div>
        ...
        <div class="ems_content_container">
          ...
          <div v-if="this.selectedEmsIndex === 0">
            <div class="divider">
              <div class="dashboard-info-ems">
                <div class="dashboard-info-ems-title">
                  <div class="dashboard-info-ems-title__text">공업</div>
              ...
              <div class="ems_contents_info">
                ...
                <div class="ems_contents__td">
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h1_pm1 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.h1_pm_sp1 | numFormat('0.00') }}Hz</span>
                  </div>
              ...
              <div class="ems_contents_info">
                ...
                <div class="ems_contents__td">
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h1_pm1 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.ai_h1_pm_sp1 | numFormat('0.00') }}Hz</span>
                  </div>
            ...
            <div class="divider">
              <div class="dashboard-info-ems">
                <div class="dashboard-info-ems-title">
                  <div class="dashboard-info-ems-title__text">생활</div>
                  <div class="btn-contents ems-toggle">
              ...
              <div class="ems_contents_info">
                <div class="ems_contents_info__title">운영현황</div>
                <div class="ems_contents__td" style="gap: 65px;">
                  ...
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.h2_pm4 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.h2_pm_sp4 | numFormat('0.00') }}Hz</span>
                  </div>
                </div>
              </div>
              <!-- AI 분석 -->
              <div class="ems_contents_info">
                ...
                <div class="ems_contents__td" style="gap: 65px;">
                  ...
                  <div class="ems_contents__led" :class="[ this.$store.state.ems.latest.pump.ai_h2_pm4 === 1 ? 'ems_contents__led--on' : 'ems_contents__led--off' ]">
                      <span>{{ this.$store.state.ems.latest.pump.ai_h2_pm_sp4 | numFormat('0.00') }}Hz</span>
                  </div>
                </div>
              </div>
            </div>                
    ...
    <div class="dashboard_info_content_container-pms">
      ...
      <div class="dashboard_info_content_header_container-pms">
        ...
        <div class="dashboard_info_content_tab-pms" style="margin-right: 0px;">
          ...
          <div class="tab-pms" @click="$store.state.pms.selectedId = '07'" :class="{'selected_ems': this.$store.state.pms.selectedId === '07'}">#7</div>
        </div>
        <!-- 당진(가) #1, #2, #3, #4, #5 탭 -->
        <div class="dashboard_info_content_tab-pms">
          <div class="tab-pms-title">당진(가)</div>
          <div class="tab-pms" @click="$store.state.pms.selectedId = '08'" :class="{'selected_ems': this.$store.state.pms.selectedId === '08'}">#1</div>
          <div class="tab-pms" @click="$store.state.pms.selectedId = '09'" :class="{'selected_ems': this.$store.state.pms.selectedId === '09'}">#2</div>
          <div class="tab-pms" @click="$store.state.pms.selectedId = '10'" :class="{'selected_ems': this.$store.state.pms.selectedId === '10'}">#3</div>
          <div class="tab-pms" @click="$store.state.pms.selectedId = '11'" :class="{'selected_ems': this.$store.state.pms.selectedId === '11'}">#4</div>
          <div class="tab-pms" @click="$store.state.pms.selectedId = '12'" :class="{'selected_ems': this.$store.state.pms.selectedId === '12'}">#5</div>
        </div>
      </div>
      <!-- PMS Content -->
...
.part-contents {
  ...
  &__text{
    ...
    &::before {
      content: "";
      background-image: url('../../assets/as_images/ai_contents_line.png');
      width: 60px;
      height: 10px;
      display: block;
