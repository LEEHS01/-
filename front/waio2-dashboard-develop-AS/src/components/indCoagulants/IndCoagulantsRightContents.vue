      ...
      <div class="two-contents">
        ...
        <div class="small-contents">
          ...
          <div class="small-contents-value">
            <div class="small-contents-value__title"><span>{{ getInjector }}</span>{{ this.$store.state.coagulants.latest.c_cf_coagulant }}</div>
            <div class="value">
      ...
      <div class="three-contents">
        ...
        <div class="three-small-contents">       
          <div class="three-small-contents-value">
            <div class="three-small-contents-value__title"><span>{{ getInjector }}</span> {{ this.$store.state.coagulants.latest.c_cf_coagulant }}</div>
  ...
  computed: {
    getNowSum() {
      ...
      if (this.$store.state.coagulants.latest.c_injector1 == 1) {
        nowSum += this.$store.state.coagulants.latest.c1_cf
      }
      if (this.$store.state.coagulants.latest.c_injector2 == 1) {
        nowSum += this.$store.state.coagulants.latest.c2_cf
      }
      if (this.$store.state.coagulants.latest.c_injector3 == 1) {
        nowSum += this.$store.state.coagulants.latest.c3_cf
      }
      if (this.$store.state.coagulants.latest.c_injector4 == 1) {
        nowSum += this.$store.state.coagulants.latest.c4_cf
      }
      return nowSum
    },
    getInjector() {
      let injector = ''
      if(this.$store.state.coagulants.latest.c_injector1 == 1) injector  =  '펌프1'
      if(this.$store.state.coagulants.latest.c_injector2 == 1) injector += ' 펌프2'
      if(this.$store.state.coagulants.latest.c_injector3 == 1) injector += ' 밸브1'
      if(this.$store.state.coagulants.latest.c_injector4 == 1) injector += ' 밸브2'
      return injector
    },
    ...
    ChartTrend: function () {
      ...
      chart.yAxis.plotLines[0].value = this.$store.state.coagulants.latestModify.c_user_tb_e
      ...
      .small-contents-value{
        ...
        .user-value-wrap {
          ...
          .user-value {
            ...
            font-size: 14px;
            color: #fff;
            background-image: url('../../assets/as_images/user-value.png');
            margin-bottom: 10px;
          }
          .user-value-num 
            > span {
