    ...
    <div class="chart-contents chartwidth20" style="display: flex; flex-direction: column;">
      ...
      <div class="box-config">
        ...
        <div class="box-config--list">
          ...
          <div class="box-input" :class="{'box-input__active': this.$store.state.sedimentation.isModifyMode}">
            <div class="box-input--value">
              <input v-if="this.$store.state.sedimentation.isModifyMode" type="text" :value="this.$store.state.sedimentation.latestModify.e_sc_set_max_wait" v-on:input="updateInput($event, 'e_sc_set_max_wait')"/>
              <span v-else>{{ this.$store.state.sedimentation.latestModify.e_sc_set_max_wait }}</span></div>
        ...
        <div class="box-config--list">
          ...
          <div class="box-input" :class="{'box-input__active': this.$store.state.sedimentation.isModifyMode}">
            <div class="box-input--value">
              <input v-if="this.$store.state.sedimentation.isModifyMode" type="text" :value="this.$store.state.sedimentation.latestModify.e_low_hour" v-on:input="updateInput($event, 'e_low_hour')"/>
              <span v-else>{{ this.$store.state.sedimentation.latestModify.e_low_hour }}</span>
            </div>
  ...
  computed: {
    ...
    ChartSludgeAmount: function () {
      ...
      for (let i=0; i < this.location.length; i++) {
        ...
        let sludgeAmount = this.$store.state.sedimentation.latest[sludgeKey]
        // 슬러지 경과시간
        let sludgeElapsedTimeKey = 'e_location_sludge_elapsedTime_' + (i + 1)
        let sludgeElapsedTime = this.$store.state.sedimentation.latest[sludgeElapsedTimeKey]
        // 객체 형태로 데이터를 추가
        _series.data.push({
      ...
      chart.yAxis.plotLines[0].value = this.$store.state.sedimentation.latestModify.e_sc_set_sludge_q
      chart.yAxis.max = ( this.$store.state.sedimentation.latestModify.e_sc_set_sludge_q + 0.5 )
  ...
  methods: {
    ...
    updateControl: function() {      
      ...
      if (this.$store.state.sedimentation.isModifyMode) {
        if (
            this.$store.state.sedimentation.latestModify.e_sc_set_sludge_q === ''
            || this.$store.state.sedimentation.latestModify.e_sc_set_max_wait === ''
            || this.$store.state.sedimentation.latestModify.e_set_lt === ''
            || this.$store.state.sedimentation.latestModify.e_sc_set_ti === ''
            || this.$store.state.sedimentation.latestModify.e_low_hour === '') {
        ...
        } else if (parseFloat(this.$store.state.sedimentation.latestModify.e_sc_set_max_wait) <= day_min || parseFloat(this.$store.state.sedimentation.latestModify.e_sc_set_max_wait) >= day_max) {
          this.$store.dispatch('alertDialog/OPEN_DIALOG', { title: '경고', text1: '최대 대기일 설정 범위', text2: day_min + ' ~ ' + day_max })
        } else if (parseFloat(this.$store.state.sedimentation.latestModify.e_low_hour) < low_hour_min || parseFloat(this.$store.state.sedimentation.latestModify.e_low_hour) > low_hour_max) {
          ...
          obj.e_sc_set_max_wait = parseFloat(this.$store.state.sedimentation.latestModify.e_sc_set_max_wait)
          obj.e_set_lt = parseFloat(this.$store.state.sedimentation.latestModify.e_set_lt)
          obj.e_sc_set_ti = parseFloat(this.$store.state.sedimentation.latestModify.e_sc_set_ti)
          obj.e_low_hour = parseFloat(this.$store.state.sedimentation.latestModify.e_low_hour)
