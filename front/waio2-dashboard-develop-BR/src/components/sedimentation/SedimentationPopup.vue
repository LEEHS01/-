          ...
          <div class="contents">
            <div class="contents-value">
              ...
              <div class="contents-value__box">
                <div class="box-text">{{ this.$store.state.coagulants.latestModify.c_cf_coagulant }}</div>
              </div>
              <div class="contents-value__text">약품 사용량</div>
              <div class="contents-value__box">
                <div class="box-text width50">{{ this.$store.state.sedimentation.latest.mm_fr | numFormat('0.00') }}</div>
            ...
            <div class="contents-value">
              ...
              <div class="contents-value__box">
                ...
                <div class="box-text width50">{{ this.$store.state.sedimentation.latest.b_in_fr | numFormat('0,0') }}</div>
                <div class="box-unit">m<sup>3</sup>/h</div>
              </div>
              <div class="contents-value__text">원수 탁도</div>
              <div class="contents-value__box">
                <div class="box-text width50">{{ this.$store.state.sedimentation.latest.b_tb | numFormat('0.00') }}</div>
...
export default {
  ...
  data: () => ({
    ...
    scDividedValue: 5.98, // 대차 위치 계산 상수
    // 슬러지 발생량 예측 차트
    chartDataSludge: {
      chart: {
        type: 'spline',
  ...
  methods: {
    getFVal: function(){
      let calculate = (70 + (this.$store.state.sedimentation.popup.location.e_sc_f * this.scDividedValue))
      if(calculate > 500){
        calculate = 500
    ...
    getBVal: function(){
      let calculate = (this.$store.state.sedimentation.popup.location.e_sc_b * this.scDividedValue)
      if(calculate > 430){
        calculate = 430
      }else if(calculate < 0){
        calculate = 0
