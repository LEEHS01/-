    ...
    <div class="top-contents">
      ...
      <div class="one-contents">
        ...
        <div class="big-contents">
          <div class="contents-value">
            ...
            <div class="value-container">
              <div class="value-container__one">· 착수정 수온(°C)</div>
      ...
      <div class="two-contents">
        ...
        <div class="small-contents">
          <div class="little-title-one">침전지 염소 증발량 예측</div>
          ...
          <div class="small-contents-value">
            ...
            <div class="value">
              ...
              <div class="value__num">{{ this.$store.state.disinfection.latest.ai_g_pre_evap | numFormat('0.00') }}</div>
      ...
      <div class="three-contents">
        ...
        <div class="three-small-contents">
          <div class="little-title-two">AI 전차염 주입률 예측</div>
          ...
          <div class="three-small-contents-value">
            ...
            <div class="three-value">
              <div class="three-value__num">{{ this.$store.state.disinfection.latest.ai_g_pre_chol | numFormat('0.00') }}</div>
    ...
    <div class="bottom-contents">
      ...
      <div class="contents paddingleft">
        ...
        <div class="real-box real-three">
          ...
          <div class="real-value">{{ this.$store.state.disinfection.latest.e1_cl | numFormat('0.00') }}</div>
        </div>       
        <div class="contents-gragh">
...
export default {
  ...
  computed: {
    getPumpRun: function() {
      let pumpRun = ''
      if(this.$store.state.disinfection.latest.g_inj_a_run == 1) pumpRun += '차염A'
      if(this.$store.state.disinfection.latest.g_inj_d_run == 1) pumpRun += '차염D'
      return pumpRun
    },
    ...
    ChartOptionCl: function () {
      ...
      chart.exporting.filename = this.$moment().format('YYYYMMDDHHmmss') + '_잔류염소'
      return chart
    }
  },
  ...
  methods: {
    downloadExcel: function() {
      ...
      for (let eva_obj in eva['series1']) {
        const excelLogs = {
          DateTime: '', 
          증발량: '',
        };
        ...
        excelLogs.증발량 = eva['series1'][eva_obj]

        const eva_length = Object.keys(eva['series1']).length
