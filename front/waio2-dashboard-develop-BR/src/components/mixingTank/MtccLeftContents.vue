  ...
  <div class="main">
    ...
    <div class="contents-img">
      ...
      <div class="select-box">
        <div v-for="index in [1,2,3,4,5,6,7,8]" :key="index" class="select-box__element" @click="changeFCLocation(index)" :class="{ 'select-box__element--focused': $store.state.mixing.selectedFCLocation === index}"><span>{{ index }}지</span></div>
      </div>
      <div class="value-title first">#1</div>
      <div class="contents-img-box one">
        <div class="contents-img-box__num">{{ this.getFCLocationSpeed(this.$store.state.mixing.selectedFCLocation)['step1'] | numFormat('0.00') }}</div>
      ...
      <div class="contents-img-box two">
        <div class="contents-img-box__num">{{ this.getFCLocationSpeed(this.$store.state.mixing.selectedFCLocation)['step2'] | numFormat('0.00') }}</div>
      ...
      <div class="contents-img-box three">
        <div class="contents-img-box__num">{{ this.getFCLocationSpeed(this.$store.state.mixing.selectedFCLocation)['step3'] | numFormat('0.00') }}</div>
      ...
      <div class="box">
        ...
        <div v-for="index in [1, 2, 3, 4]" :key="index" class="box-contents">
          ...
          <div class="box-contents-led">
            <div :class="[ getFCLocationState(index).step1 ? 'box-contents-led__on' : 'box-contents-led__off']"></div>
          </div>
          <div class="box-contents-led">
            <div :class="[ getFCLocationState(index).step2 ? 'box-contents-led__on' : 'box-contents-led__off']"></div>
          </div>
          <div class="box-contents-led last-padding-left">
            <div :class="[ getFCLocationState(index).step3 ? 'box-contents-led__on' : 'box-contents-led__off']"></div>
          </div>
        </div>
      </div>
      <!-- 2계열 지별 상태 -->
...
export default {
  ...
  methods: {
    ...
    changeFCLocation: function(index) {
      this.$store.state.mixing.selectedFCLocation = index
    }
  }
}
</script>
...
.main{
  ...
  .contents-img{
    width: 600px;
    height: 308px;
    background-image: url('../../assets/br_images/sub_03.png');
