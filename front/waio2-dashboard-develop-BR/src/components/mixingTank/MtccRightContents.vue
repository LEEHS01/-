        ...
        <div class="top-container">
          ...
          <div class="top-two-contents-box">
            ...
            <div class="top-two-contents-value">
              ...
              <div class="top-two-contents-value__value">{{ this.$store.state.mixing.latest.d_ki_dv | numFormat('0.00000000') }}</div>
        ...
        <div class="top-two-contents-container__title">
          ...
          <div class="top-container">
            <div class="top-container__real-box">
              ...
              <div class="top-container__real-value">{{ this.getFCLocationSpeed(this.$store.state.mixing.selectedFCLocation)['step1'] | numFormat('0.00') }}</div>
            ...
            <div class="top-container__real-box">
              ...
              <div class="top-container__real-value">{{ this.getFCLocationSpeed(this.$store.state.mixing.selectedFCLocation)['step2'] | numFormat('0.00') }}</div>
              <div class="top-container__real-unit">RPM</div>
            </div>
            <div class="top-two-contents-value">
            ...
            <div class="top-container__real-box">
              ...
              <div class="top-container__real-value">{{ this.getFCLocationSpeed(this.$store.state.mixing.selectedFCLocation)['step3'] | numFormat('0.00') }}</div>
              <div class="top-container__real-unit">RPM</div>
            </div>
            <div class="top-two-contents-value">
...
export default {
  ...
  computed: {
    ...
    ChartAGSpeed: function () {
      ...
      let now = new Date()
      // let now = new Date("2023-11-27 20:00:00") // FIXME 현재 날짜 수정 
  ...
  .top-two-contents-container{
    ...
    .top-container{
      ...
      .contents-value-underbar {
        ...
        height: 6px;
       margin: 10px 0;
        background: url(../../assets/br_images/underbar.png) no-repeat;
      }
      &__real-box {
        display: flex;
        align-items: center;
