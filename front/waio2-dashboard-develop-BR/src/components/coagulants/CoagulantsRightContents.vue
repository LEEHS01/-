      ...
      <div class="one-contents">
        ...
        <div class="big-contents">
          <div class="contents-value">
            ...
            <div class="value-container">
              <div class="value-container__one">· 침전지 탁도</div>
              <div class="value-container__two">{{ this.$store.state.coagulants.latest.e1_tb_b | numFormat('0.00') }}</div>
              <div class="value-container__three">NTU</div>
            </div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...
    getInjector() {
      let injector = ''
      if(this.$store.state.coagulants.latest.c_injector1 == 1) injector  =  '1호기'
      if(this.$store.state.coagulants.latest.c_injector2 == 1) injector += ' 2호기'
      if(this.$store.state.coagulants.latest.c_injector3 == 1) injector += ' 3호기'
      return injector
    },
    // 침전지 탁도 정규 분포 차트 데이터
    ScatterData1() {
      ...
      .small-contents-value{
        ...
        .user-value-wrap {
          ...
          .user-value {
            ...
            font-size: 14px;
            color: #fff;
            background-image: url('../../assets/br_images/user-value.png');
            margin-bottom: 10px;
          }
          .user-value-num 
            > span {
