<template>
  <div v-if="this.$store.state.alarm.visible && this.$store.state.alarm.alarmsDetail.procCd == 'B'" class="popup-wrap">
        ...
        <div class="one-contents">
          ...
          <div class="big-contents">
            <div class="contents-value">
              ...
              <div class="value-container">
                <div class="value-container__one">· 원수 유입 압력</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b_in_pr | numFormat('0.00') }}</div>
                <div class="value-container__three">kgf/cm<sup>2</sup></div>
              </div>
              <div class="value-container">
              ...
              <div class="value-container">
                <div class="value-container__one">· 가이드 베인 개도</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b1_gv_vv_po | numFormat('0.00') }}</div>
                <div class="value-container__three">%</div>
              </div>
              <div class="value-container">
                <div class="value-container__one">· 바이패스 개도</div>
                <div class="value-container__two">{{ this.$store.state.alarm.alarmsDetail.factorMap.b1_vv_po | numFormat('0.00') }}</div>
                <div class="value-container__three">%</div>
              </div>
            </div>
          </div>
...
.popup-wrap {
  ...
  .popup-main{
    ...
    background-image: url('../../../../assets/br_images/popup_main.png');
      ...
      .table-contents-wrap {
        width: 60%;
          &__title {
            ...
            height: 53px;
            padding-left: 30px;
            background-image: url('../../../../assets/br_images/contents_right_title.png');
            text-shadow: 0 0 9px #5cafff;
            font-size: 18px;
            line-height: 2.8;
            text-align: left;
