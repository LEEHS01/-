<template>
  <div v-if="this.$store.state.alarm.visible && this.$store.state.alarm.alarmsDetail.procCd == 'E'" class="popup-wrap">
        ...
        <div class="one-contents">
          ...
          <div class="big-contents">
            <div class="contents-value">
              ...
              <div class="value-container">
                <div class="value-container__one">· 소석회 주입량</div>
...
export default {
  ...
  computed: {
    getCoagulantName() {
      let coagulantCode = 0;
      coagulantCode = this.$store.state.alarm.alarmsDetail.factorMap.c_cf_coagulant
