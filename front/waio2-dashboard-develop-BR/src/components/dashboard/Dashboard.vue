  ...
  <div class="dashboard-container">
    ...
    <div class="map-contents">
      ...
      <div class="map-contents__splashdown" :class="[this.$store.state.selectedBuildingIndex === 1 ? 'zIndex10': '', this.$store.state.selectedBuildingIndex > 0 && this.$store.state.selectedBuildingIndex !== 1 ? 'opacity50' : '']">
        ...
        <img class="down" :class="[this.$store.state.selectedBuildingIndex === 1 ? 'building-unvisible': 'building-visible']" src="../../assets/br_images/br_splashdown.png" usemap="#splashdown_map" alt="착수건물"/>
        <img class="up" :class="[this.$store.state.selectedBuildingIndex === 1 ? 'building-visible': 'building-unvisible']" src="../../assets/br_images/br_over_splashdown.png" usemap="#over_splashdown_map" alt="착수건물"/>
      ...
      <div class="cube splashdown_cube" :class="[this.$store.state.selectedBuildingIndex > 0 ? 'building-unvisible': 'building-visible']">
        <div class="cube__inner">
          ...
          <div :class="[this.$store.state.receiving.latest.ai_opr ? 'cube__front_logo--on' : 'cube__front_logo--off']"></div>
      ...
      <div class="map-contents__drug" :class="[this.$store.state.selectedBuildingIndex === 2 ? 'zIndex10': '', this.$store.state.selectedBuildingIndex > 0 && this.$store.state.selectedBuildingIndex !== 2 ? 'opacity50' : '']">
        ...
        <img class="down" :class="[this.$store.state.selectedBuildingIndex === 2 ? 'building-unvisible': 'building-visible']" src="../../assets/br_images/br_drug.png" usemap="#drug_map" alt="약품건물"/>
        <img class="up" :class="[this.$store.state.selectedBuildingIndex === 2 ? 'building-visible': 'building-unvisible']" src="../../assets/br_images/br_over_drug.png" usemap="#over_drug_map" alt="약품건물"/>
      ...
      <div class="map-contents__sedimentation-mix" :class="[this.$store.state.selectedBuildingIndex === 3 || this.$store.state.selectedBuildingIndex === 4 ? 'zIndex10': '', this.$store.state.selectedBuildingIndex > 0 && this.$store.state.selectedBuildingIndex !== 3 && this.$store.state.selectedBuildingIndex !== 4 ? 'opacity50' : '']">
        ...
        <img class="down" :class="[this.$store.state.selectedBuildingIndex === 3 || this.$store.state.selectedBuildingIndex === 4 ? 'building-unvisible': 'building-visible']" src="../../assets/br_images/br_sedimentation.png" alt="침전&혼화응집건물"/>
        <img class="up" :class="[this.$store.state.selectedBuildingIndex === 3 || this.$store.state.selectedBuildingIndex === 4 ? 'building-visible': 'building-unvisible']" src="../../assets/br_images/br_over_sedimentation.png" alt="침전&혼화응집건물"/>
      ...
      <div class="map-contents__percolation" :class="[this.$store.state.selectedBuildingIndex === 5 ? 'zIndex10': '', this.$store.state.selectedBuildingIndex > 0 && this.$store.state.selectedBuildingIndex !== 5 ? 'opacity50' : '']">
        ...
        <img class="down" :class="[this.$store.state.selectedBuildingIndex === 5 ? 'building-unvisible': 'building-visible']" src="../../assets/br_images/br_percolation.png" usemap="#percolation_map" alt="여과건물"/>
        <img class="up" :class="[this.$store.state.selectedBuildingIndex === 5 ? 'building-visible': 'building-unvisible']" src="../../assets/br_images/br_over_percolation.png" usemap="#percolation_over_map" alt="여과건물"/>
      ...
      <div class="map-contents__disinfection" :class="[this.$store.state.selectedBuildingIndex === 7 ? 'zIndex10': '', this.$store.state.selectedBuildingIndex > 0 && this.$store.state.selectedBuildingIndex !== 7 ? 'opacity50' : '']">
        ...
        <img class="down" :class="[this.$store.state.selectedBuildingIndex === 7 ? 'building-unvisible': 'building-visible']" src="../../assets/br_images/br_disinfection.png" usemap="#disinfection_map" alt="소독건물"/>
        <img class="up" :class="[this.$store.state.selectedBuildingIndex === 7 ? 'building-visible': 'building-unvisible']" src="../../assets/br_images/br_over_disinfection.png" usemap="#over_disinfection_map" alt="소독건물"/>
    ...
    <!-- 소독 팝업 -->
    <Popup7 v-if="this.$store.state.selectedBuildingIndex === 7 || this.$store.state.selectedBuildingIndex === 8 || this.$store.state.selectedBuildingIndex === 9"/>
    <!-- 운영 이력 팝업-->
    <AIOprHistoryPopup/>
  </div>
</template>
...
import { GET_MIDDISINFECTION_LATEST, PUT_MIDDISINFECTION_HISTORY_CHOL_RATE_TREND } from '@/store/modules/midDisinfection'
import { GET_POSTDISINFECTION_LATEST, PUT_POSTDISINFECTION_H_RESIDUAL_CL, PUT_POSTDISINFECTION_HISTORY_CHOL_RATE_TREND} from '@/store/modules/postDisinfection'
...
export default {
  ...
  mounted: function() {
    ...
    Promise.all([
      this.$store.dispatch(GET_RECEIVING_LATEST, { processStep : this.$store.state.receiving.processStep }),
      ...
      this.$store.dispatch(GET_MIDDISINFECTION_LATEST, {selectedDisinfectionIndex : this.$store.state.midDisinfection.selectedDisinfectionIndex}),
      this.$store.dispatch(GET_POSTDISINFECTION_LATEST, {selectedDisinfectionIndex : this.$store.state.postDisinfection.selectedDisinfectionIndex}),
      this.$store.dispatch(PUT_MIDDISINFECTION_HISTORY_CHOL_RATE_TREND, {selectedDisinfectionIndex : this.$store.state.midDisinfection.selectedDisinfectionIndex}),
      this.$store.dispatch(PUT_POSTDISINFECTION_H_RESIDUAL_CL, {selectedDisinfectionIndex : this.$store.state.postDisinfection.selectedDisinfectionIndex}),
      this.$store.dispatch(PUT_POSTDISINFECTION_HISTORY_CHOL_RATE_TREND, {selectedDisinfectionIndex : this.$store.state.postDisinfection.selectedDisinfectionIndex}),
    ...
    this.timer = setInterval(() => {
      ...
      this.$store.dispatch(GET_COAGULANT_LATEST),
      this.$store.dispatch(GET_MIXING_LATEST),
      this.$store.dispatch(GET_SEDIMENTATION_LATEST, {selectedDisinfectionIndex : this.$store.state.disinfection.selectedDisinfectionIndex}),
      this.$store.dispatch(GET_FILTER_LATEST),
      this.$store.dispatch(GET_DISINFECTION_LATEST, {selectedDisinfectionIndex : this.$store.state.disinfection.selectedDisinfectionIndex}),
      this.$store.dispatch(GET_MIDDISINFECTION_LATEST, {selectedDisinfectionIndex : this.$store.state.midDisinfection.selectedDisinfectionIndex}),
      this.$store.dispatch(GET_POSTDISINFECTION_LATEST, {selectedDisinfectionIndex : this.$store.state.postDisinfection.selectedDisinfectionIndex}),
...
// 대시보드 사이즈 및 배경
.dashboard-container {
  background-image: url('../../assets/br_images/main_bg.png');
