...
const routes = [
  ...
  { path: '/indReceivingAlgorithm', component: ReceivingAlgorithm, name: 'IndReceivingAlgorithm' },
  ...
  { path: '/indCgAlgorithm', component: IndCgAlgorithm, name: 'IndCgAlgorithm' }, // 공업 약품
  { path: '/indMtccAlgorithm', component: IndMtccAlgorithm, name: 'IndMtccAlgorithm' }, // 공업 혼화/응집
  { path: '/indSedimentationAlgorithm', component: IndSedimentationAlgorithm, name: 'IndSedimentationAlgorithm' }, // 공업 침전
  { path: '/indDisinfectionAlgorithm', component: IndDisinfectionAlgorithm, name: 'indDisinfectionAlgorithm' }, // 공업 소독
  { path: '/preDisinfectionAlgorithm', component: DisinfectionAlgorithm, name: 'PreDisinfectionAlgorithm' }, // 생활 소독 전차염
  { path: '/periDisinfectionAlgorithm', component: DisinfectionAlgorithm, name: 'PeriDisinfectionAlgorithm' }, // 생활 소독 중차염
  { path: '/postDisinfectionAlgorithm', component: DisinfectionAlgorithm, name: 'PostDisinfectionAlgorithm' }, // 생활 소독 후차염
