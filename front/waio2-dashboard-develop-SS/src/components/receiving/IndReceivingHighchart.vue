...
export default {
  ...
  computed: {
    ...
    ChartReceivingWaterFlow: function () {
      ...
      chart.series = []
      if (this.$store.state.receiving.latest.ai_b_out_fr_rtd !== null && Object.keys(this.$store.state.receiving.latest.ai_b_out_fr_rtd).length > 0) {
        let dataSeries1 = []
    ...
    ChartDataClearLevelFromLocation: function () {
      let data = []
      console.log(this.$store.state.clear.le['location' + this.selectedLocation])
