          ...
          <div class="one-contents">
            ...
            <div class="big-contents">
              <div class="contents-value">
                ...
                <div class="value-container">
                  <div class="value-container__one">· 약품 사용량</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.mm_fr | numFormat('0.00') }}</div>
...
methods: {
  getCoagulantName(){
    let coagulantCode = 0;
    if(this.$store.state.alarm.alarmDetail.procCd == 'E_LIV'){
      coagulantCode = this.$store.state.alarm.alarmDetail.factorMap.ai_c1_cf_coagulant
    }else{
      coagulantCode = this.$store.state.alarm.alarmDetail.factorMap.ai_c2_cf_coagulant
    }
    return coagulantCodeMap[coagulantCode]
  },
