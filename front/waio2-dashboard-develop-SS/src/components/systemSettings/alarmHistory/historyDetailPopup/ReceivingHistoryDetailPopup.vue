        ...
        <div class="chart-container">
          <div class="one-contents">
            ...
            <div class="big-contents">
              <div class="contents-value" v-if="this.$store.state.alarm.alarmDetail.procCd == 'B_LIV'">
                ...
                <div class="value-container">
                  ...
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.b_in_pr | numFormat('0.00') }} </div>
                  <div class="value-container__three">kgf/cm<sup>2</sup></div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 정수지 #1 수위</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.h_location_le1 | numFormat('0.00') }}</div>
                  <div class="value-container__three">m</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 정수지 #2 수위</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.h_location_le2 | numFormat('0.00') }}</div>
                  <div class="value-container__three">m</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 정수지 #3 수위</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.h_location_le3 | numFormat('0.00') }}</div>
                  <div class="value-container__three">m</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 정수지 총 유출 유량</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.b_out_fri | numFormat('0,0') }}</div>
                  <div class="value-container__three">m<sup>3</sup>/h</div>
                </div>
              </div>
              <div class="contents-value" v-else>
                ...
                <div class="value-container">
                  <div class="value-container__one">· 회수조 유출유량</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.b_rtrn_in_fr | numFormat('0,0') }} </div>
                  <div class="value-container__three">m<sup>3</sup>/h</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 원수 유입 압력</div>
                ...
                <div class="value-container">
                  ...
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.h_location_le4 | numFormat('0.00') }}</div>
                  <div class="value-container__three">m</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 정수지 총 유출 유량</div>
...
.popup-wrap {
  ...
  .popup-main{
    ...
    justify-content: center;
    align-items: center;
    background-image: url('../../../../assets/ss_images/popup_main.png');
