            ...
            <div class="big-contents">
              <div class="contents-value" v-if="this.$store.state.alarm.alarmDetail.factorMap.disinfection_index == 1">
                <div class="value-container">
                  ...
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.g_tei | numFormat('0.00') }}</div>
                </div>
                <div class="value-container">
                ...
                <div class="value-container" v-if="this.$store.state.alarm.alarmDetail.procCd == 'G_IND'">
                ...
                <div class="value-container" >
                  ...
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.g_e_residual_cl | numFormat('0.00') }}</div>
                </div>
                <div class="value-container">
                ...
                <div class="value-container" v-if="this.$store.state.alarm.alarmDetail.procCd == 'G_LIV'">
                  <div class="value-container__one">· 중염소 주입률</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.g_peri_chol_rate | numFormat('0.00') }}</div>
                </div>
              </div>
              <div class="contents-value" v-if="this.$store.state.alarm.alarmDetail.factorMap.disinfection_index == 2">
                <div class="value-container" >
                  <div class="value-container__one">· 침전지 잔류 염소</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.g_e_residual_cl | numFormat('0.00') }}</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 여과수 통합 잔류염소</div>
