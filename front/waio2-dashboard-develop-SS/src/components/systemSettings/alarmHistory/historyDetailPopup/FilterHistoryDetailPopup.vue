            ...
            <div class="big-contents">
              <div class="contents-value">
                ...
                <div class="value-container">
                  ...
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.e1_tb_b  | numFormat('0.00') }}</div>
                  <div class="value-container__three">NTU</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 여과 속도</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.f_speed | numFormat('0.00')}}</div>
                  <div class="value-container__three">m/day</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 여과 유출 유량</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.f_out_fr | numFormat('0,0') }}</div>
                  <div class="value-container__three">m<sup>3</sup>/h</div>
                </div>
              </div>
            </div>
