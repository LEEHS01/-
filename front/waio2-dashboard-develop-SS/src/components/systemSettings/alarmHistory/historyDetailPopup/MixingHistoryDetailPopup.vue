        ...
        <div class="chart-container">
          <div class="one-contents">
            ...
            <div class="big-contents">
              <div class="contents-value" v-if="this.$store.state.alarm.alarmDetail.procCd == 'D_LIV'">
                ...
                <div class="value-container">
                  ...
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.d_tb_e | numFormat('0.00') }} </div>
                  <div class="value-container__three">NTU</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 응집지 #1 수온</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.b_te_loc1 | numFormat('0.00') }} </div>
                  <div class="value-container__three">℃</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 응집지 #2 수온</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.b_te_loc2 | numFormat('0.00') }} </div>
                  <div class="value-container__three">℃</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 응집지 #3 수온</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.b_te_loc3 | numFormat('0.00') }} </div>
                  <div class="value-container__three">℃</div>
                </div>
                <div class="value-container">
                  <div class="value-container__one">· 응집지 #4 수온</div>
                  <div class="value-container__two">{{ this.$store.state.alarm.alarmDetail.factorMap.b_te_loc4 | numFormat('0.00') }} </div>
                  <div class="value-container__three">℃</div>
                </div>
              </div>
