  ...
  <div class="dashboard-container">
    ...
    <div class="map-contents">
      ...
      <div class="map-contents__splashdown" :class="[this.$store.state.selectedBuildingIndex === 1 ? 'zIndex10': '', this.$store.state.selectedBuildingIndex > 0 && this.$store.state.selectedBuildingIndex !== 1 ? 'opacity50' : '']">
        ...
        <img class="down" :class="[this.$store.state.selectedBuildingIndex === 1 ? 'building-unvisible': 'building-visible']" src="../../assets/ss_images/ss_box_01.png" usemap="#splashdown_map" alt="착수건물"/>
        <img class="up" :class="[this.$store.state.selectedBuildingIndex === 1 ? 'building-visible': 'building-unvisible']" src="../../assets/ss_images/ss_box_01_up.png" usemap="#over_splashdown_map" alt="착수건물"/>
        <img class="aurora_splashdown" :class="[this.$store.state.selectedBuildingIndex === 1 ? 'building-unvisible': 'building-visible']" src="../../assets/dashboard_icons/bottom-aurora.png" alt="착수텍스트빛효과"/>
      </div>
      <!-- 착수 회전 아이콘 -->
      ...
      <div class="map-contents__drug" :class="[this.$store.state.selectedBuildingIndex === 2 ? 'zIndex10': '', this.$store.state.selectedBuildingIndex > 0 && this.$store.state.selectedBuildingIndex !== 2? 'opacity50' : '']">
        <div class="drug-text" @mouseover="onBuildingMouseover(2)" @mouseout="this.onBuildingMouseout" @click="$routingByIndex(2)">생활약품</div>
        <img class="down" :class="[this.$store.state.selectedBuildingIndex === 2 ? 'building-unvisible': 'building-visible']" src="../../assets/ss_images/ss_box_02.png" usemap="#drug_map" alt="생활약품건물"/>
        <img class="up" :class="[this.$store.state.selectedBuildingIndex === 2 ? 'building-visible': 'building-unvisible']" src="../../assets/ss_images/ss_box_02_up.png" usemap="#over_drug_map" alt="생활약품건물"/>
        <img class="aurora_drug" :class="[this.$store.state.selectedBuildingIndex === 2? 'building-unvisible': 'building-visible']" src="../../assets/dashboard_icons/bottom-aurora.png" alt="생활약품텍스트빛효과"/>
      </div>
      <!-- 생활약품 회전 아이콘 -->
      ...
      <div class="map-contents__drug2" :class="[this.$store.state.selectedBuildingIndex === 19 ? 'zIndex10': '', this.$store.state.selectedBuildingIndex > 0 && this.$store.state.selectedBuildingIndex !== 19 ? 'opacity50' : '']">
        <div class="drug2-text" @mouseover="onBuildingMouseover(19)" @mouseout="this.onBuildingMouseout" @click="$routingByIndex(19)">공업약품</div>
        <img class="down" :class="[this.$store.state.selectedBuildingIndex === 19 ? 'building-unvisible': 'building-visible']" src="../../assets/ss_images/ss_box_02.png" usemap="#drug_map" alt="공업약품건물"/>
        <img class="up" :class="[this.$store.state.selectedBuildingIndex === 19 ? 'building-visible': 'building-unvisible']" src="../../assets/ss_images/ss_box_02_up.png" usemap="#over_drug_map" alt="공업약품건물"/>
        <img class="aurora_drug2" :class="[this.$store.state.selectedBuildingIndex === 19 ? 'building-unvisible': 'building-visible']" src="../../assets/dashboard_icons/bottom-aurora.png" alt="공업약품텍스트빛효과"/>
      </div>
      <!-- 공업약품 회전 아이콘 -->
      <div class="cube drug2_cube" :class="[this.$store.state.selectedBuildingIndex > 0 ? 'building-unvisible': 'building-visible']">
        <div class="cube__inner">
          <div class="cube__noimg">
          <div :class="[this.$store.state.indCoagulants.latest.ai_opr ? 'cube__front_logo--on' : 'cube__front_logo--off']"></div>
          <div class="cube__back_logo back_drug"></div>
          </div>
        </div>
      </div>
      ...
      <div class="map-contents__sedimentation-mix" :class="[this.$store.state.selectedBuildingIndex === 3 || this.$store.state.selectedBuildingIndex === 4 ? 'zIndex10': '', this.$store.state.selectedBuildingIndex > 0 && this.$store.state.selectedBuildingIndex !== 3 && this.$store.state.selectedBuildingIndex !== 4 ? 'opacity50' : '']">
        <div class="sedimentation-text" :class="[this.$store.state.selectedBuildingIndex === 3 ? 'opacity50': '']" @mouseover="onBuildingMouseover(4)" @mouseout="this.onBuildingMouseout" @click="$routingByIndex(4)">생활침전</div>
        <div class="mix-text" :class="[this.$store.state.selectedBuildingIndex === 4 ? 'opacity50': '']" @mouseover="onBuildingMouseover(3)" @mouseout="this.onBuildingMouseout" @click="$routingByIndex(3)">생활혼화응집</div>
        <img class="down" :class="[this.$store.state.selectedBuildingIndex === 3 || this.$store.state.selectedBuildingIndex === 4 ? 'building-unvisible': 'building-visible']" src="../../assets/ss_images/ss_box_03.png" alt="생활침전&혼화응집건물"/>
        <img class="up" :class="[this.$store.state.selectedBuildingIndex === 3 || this.$store.state.selectedBuildingIndex === 4 ? 'building-visible': 'building-unvisible']" src="../../assets/ss_images/ss_box_03_up.png" alt="생활침전&혼화응집건물"/>
        <img class="aurora_sedimentation" :class="[this.$store.state.selectedBuildingIndex === 4 ? 'building-unvisible': 'building-visible', this.$store.state.selectedBuildingIndex === 4 ? 'opacity0' : '']" src="../../assets/dashboard_icons/bottom-aurora.png" alt="생활침전텍스트빛효과"/>
        <img class="aurora_mix" :class="[this.$store.state.selectedBuildingIndex === 3 ? 'building-unvisible': 'building-visible', this.$store.state.selectedBuildingIndex === 3 ? 'opacity0' : '']" src="../../assets/dashboard_icons/bottom-aurora.png" alt="생활혼화응집텍스트빛효과"/>
      </div>
      <!--  생활침전 회전 아이콘 -->
      ...
      <!-- 공업침전&혼화응집 건물 -->
      <div class="map-contents__sedimentation2-mix2" :class="[this.$store.state.selectedBuildingIndex === 20 || this.$store.state.selectedBuildingIndex === 21 ? 'zIndex10': '', this.$store.state.selectedBuildingIndex > 0 && this.$store.state.selectedBuildingIndex !== 20 && this.$store.state.selectedBuildingIndex !== 21 ? 'opacity50' : '']">
        <div class="sedimentation2-text" :class="[this.$store.state.selectedBuildingIndex === 21 ? 'opacity50': '']" @mouseover="onBuildingMouseover(21)" @mouseout="this.onBuildingMouseout" @click="$routingByIndex(21)">공업침전</div>
        <div class="mix2-text" :class="[this.$store.state.selectedBuildingIndex === 20 ? 'opacity50': '']" @mouseover="onBuildingMouseover(20)" @mouseout="this.onBuildingMouseout" @click="$routingByIndex(20)">공업혼화응집</div>
        <img class="down" :class="[this.$store.state.selectedBuildingIndex === 20 || this.$store.state.selectedBuildingIndex === 21 ? 'building-unvisible': 'building-visible']" src="../../assets/ss_images/ss_box_04.png" alt="공업침전&혼화응집건물"/>
        <img class="up" :class="[this.$store.state.selectedBuildingIndex === 20 || this.$store.state.selectedBuildingIndex === 21 ? 'building-visible': 'building-unvisible']" src="../../assets/ss_images/ss_box_04_up.png" alt="공업침전&혼화응집건물"/>
        <img class="aurora_sedimentation2" :class="[this.$store.state.selectedBuildingIndex === 21 ? 'building-unvisible': 'building-visible', this.$store.state.selectedBuildingIndex === 20 ? 'opacity0' : '']" src="../../assets/dashboard_icons/bottom-aurora.png" alt="공업침전텍스트빛효과"/>
        <img class="aurora_mix2" :class="[this.$store.state.selectedBuildingIndex === 20 ? 'building-unvisible': 'building-visible', this.$store.state.selectedBuildingIndex === 21 ? 'opacity0' : '']" src="../../assets/dashboard_icons/bottom-aurora.png" alt="공업혼화응집텍스트빛효과"/>
      </div>
      <!-- 공업혼화응집 회전 아이콘 -->
      <div class="cube mix2_cube" :class="[this.$store.state.selectedBuildingIndex > 0 ? 'building-unvisible': 'building-visible']">
        <div class="cube__inner">
          <div class="cube__noimg">
          <div :class="[this.$store.state.indMixing.latest.ai_opr ? 'cube__front_logo--on' : 'cube__front_logo--off']"></div>
          <div class="cube__back_logo back_mix"></div>
          </div>
        </div>
      </div>
      ...
      <div class="cube sedimentation2_cube" :class="[this.$store.state.selectedBuildingIndex > 0 ? 'building-unvisible': 'building-visible']">
        <div class="cube__inner">
          <div class="cube__noimg">
          <div :class="[this.$store.state.indSedimentation.latest.ai_opr ? 'cube__front_logo--on' : 'cube__front_logo--off']"></div>
          <div class="cube__back_logo back_sedimentation"></div>
          </div>
        </div>
      </div>
      ...
      <div class="map-contents__percolation" :class="[this.$store.state.selectedBuildingIndex === 5 ? 'zIndex10': '', this.$store.state.selectedBuildingIndex > 0 && this.$store.state.selectedBuildingIndex !== 5 ? 'opacity50' : '']">
        <div class="percolation-text" @mouseover="onBuildingMouseover(5)" @mouseout="this.onBuildingMouseout" @click="$routingByIndex(5)">생활여과</div>
        <img class="down" :class="[this.$store.state.selectedBuildingIndex === 5 ? 'building-unvisible': 'building-visible']" src="../../assets/ss_images/ss_box_05.png" usemap="#percolation_map" alt="생활여과건물"/>
        <img class="up" :class="[this.$store.state.selectedBuildingIndex === 5 ? 'building-visible': 'building-unvisible']" src="../../assets/ss_images/ss_box_05_up.png" usemap="#percolation_over_map" alt="생활여과건물"/>
        <img class="aurora_percolation" :class="[this.$store.state.selectedBuildingIndex === 5 ? 'building-unvisible': 'building-visible']" src="../../assets/dashboard_icons/bottom-aurora.png" alt="생활여과텍스트빛효과"/>
      </div>
      <!-- 생활여과 회전 아이콘 -->
    ...
    <Popup2_1 v-if="this.$store.state.selectedBuildingIndex === 19"/>
    <!-- 혼화응집 팝업 -->
    <Popup3 v-if="this.$store.state.selectedBuildingIndex === 3"/>
    <Popup3_1 v-if="this.$store.state.selectedBuildingIndex === 20"/>
    <!-- 침전 팝업 -->
    <Popup4 v-if="this.$store.state.selectedBuildingIndex === 4"/>
    <Popup4_1 v-if="this.$store.state.selectedBuildingIndex === 21"/>
    <!-- 여과 팝업 -->
    <Popup5 v-if="this.$store.state.selectedBuildingIndex === 5"/>
    <!-- GAC여과 팝업 -->
    <Popup6 v-if="this.$store.state.selectedBuildingIndex === 6"/>
    <!-- 소독 팝업 -->
    <Popup7 v-if="[7.1, 7.2, 7.3, 7.4].includes(this.$store.state.selectedBuildingIndex)"/>
    <!-- 송수 팝업 -->
...
import Popup2_1 from '@/components/dashboard/popup/Popup2_1'
import Popup3 from '@/components/dashboard/popup/Popup3'
import Popup3_1 from '@/components/dashboard/popup/Popup3_1'
import Popup4 from '@/components/dashboard/popup/Popup4'
import Popup4_1 from '@/components/dashboard/popup/Popup4_1'
...
import { GET_LIV_RECEIVING_LATEST } from '@/store/modules/receiving' 
...
import { GET_INDDISINFECTION_LATEST } from '@/store/modules/indDisinfection'
...
export default {
  ...
  mounted: function() {
    ...
    Promise.all([
      ...
      this.$store.dispatch(GET_INDDISINFECTION_LATEST),
