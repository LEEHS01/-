<template>
  <div class="main">
      ...
      <div class="top-contents-container">
        ...
        <div class="top-container">
          <div class="top-one-contents-box">
            <div class="toggle-wrap">
              ...
              <div class="btn-contents" style="width: 60px;">
                <div class="btn-contents__btn">
                  <input id="authchk" type="checkbox" :disabled="$store.state.login.user.tkn === null" class="checkbox" @click="openPopup" :class="{ 'checked': this.$store.state.indMixing.latest.d_g_value_ctr_flag == 1 }">
            ...
            <div class="ji-contents-wrap">
              ...
              <div class="top-one-contents-value">
                ...
                <input ref="gValueInputBox" v-if="this.$store.state.indMixing.isModifyMode && this.$store.state.indMixing.latest.d_g_value_ctr_flag == 0" type="text" class="top-one-contents-value__input" :value="getLatestModifyGValueByJiAndStep(1)" v-on:input="updateInput($event, getGValueKeyByJiAndStep(1))"/>
                <span class="top-one-contents-value__span" v-else>{{ this.$store.state.indMixing.latest.d_g_value_ctr_flag == 0 ? getLatestGValueByJiAndStep(1) : this.$store.state.indMixing.latest.ai_d_g_value1 | numFormat('0.0')}}</span>
                <div class="top-one-contents-value__unit">sec<sup>-1</sup></div>
              </div>
              <div class="top-one-contents-value">
                <div class="top-one-contents-value__text">#2</div>
                <input v-if="this.$store.state.indMixing.isModifyMode && this.$store.state.indMixing.latest.d_g_value_ctr_flag == 0" type="text" class="top-one-contents-value__input" :value="getLatestModifyGValueByJiAndStep(2)" v-on:input="updateInput($event, getGValueKeyByJiAndStep(2))"/>
                <span class="top-one-contents-value__span" v-else>{{ this.$store.state.indMixing.latest.d_g_value_ctr_flag == 0 ? getLatestGValueByJiAndStep(2) : this.$store.state.indMixing.latest.ai_d_g_value2 | numFormat('0.0')}}</span>
                <div class="top-one-contents-value__unit">sec<sup>-1</sup></div>
              </div>
              <div class="top-one-contents-value">
                <div class="top-one-contents-value__text">#3</div>
                <input v-if="this.$store.state.indMixing.isModifyMode && this.$store.state.indMixing.latest.d_g_value_ctr_flag == 0" type="text" class="top-one-contents-value__input" :value="getLatestModifyGValueByJiAndStep(3)" v-on:input="updateInput($event, getGValueKeyByJiAndStep(3))"/>
                <span class="top-one-contents-value__span" v-else>{{ this.$store.state.indMixing.latest.d_g_value_ctr_flag == 0 ?getLatestGValueByJiAndStep(3) : this.$store.state.indMixing.latest.ai_d_g_value3 | numFormat('0.0') }}</span>
                <div class="top-one-contents-value__unit">sec<sup>-1</sup></div>
              </div>
              <div v-if="$store.state.login.user.tkn !== null && $store.state.indMixing.latest.d_g_value_ctr_flag == 0" class="box-config--end">
              ...
              <div class="auto-btn" v-show="$store.state.login.user.tkn !== null && $store.state.indMixing.latest.d_g_value_ctr_flag == 1" ><button class="auto-btn__detail" @click="openAutoDetail()">자동모드 상세</button></div> 
            </div>
          </div>
          <div class="top-two-contents-box">
            ...
            <div class="top-two-contents-value">
              <div class="top-two-contents-value__text" style="width:150px;">· 동점성 계수</div>
              <div class="top-two-contents-value__value" style="width:132px;">{{ this.$store.state.indMixing.latest.d_ki_dv }}</div>
        ...
        <div class="top-container">
          <div class="top-container__wrap">
            <div class="G-Value-contents">
              ...
              <div class="top-two-contents-value__G-Value">{{ this.getLocationG(this.$store.state.indMixing.selectedFCLocation).step1['1'] | numFormat('0') }}</div>
              <div class="top-two-contents-value__G-unit">S<sup>-1</sup></div>
            </div>
          <div class="top-two-contents-value">
            <div class="top-two-contents-value__text">· #1</div>
                <div class="top-two-contents-value__value">{{ this.getAIFCLocationG(this.$store.state.indMixing.selectedFCLocation).step1 | numFormat('0') }}</div>
                <div class="top-two-contents-value__unit">S<sup>-1</sup></div>
              </div>
              <div class="contents-value-underbar"></div>
              <div class="G-Value-contents">
                <div class="top-two-contents-value__G-text">현재G값</div>
                <div class="top-two-contents-value__G-Value">{{ this.getLocationG(this.$store.state.indMixing.selectedFCLocation).step2['1'] | numFormat('0') }}</div>
                <div class="top-two-contents-value__G-unit">S<sup>-1</sup></div>
              </div>            
              <div class="top-two-contents-value">
                <div class="top-two-contents-value__text">· #2</div>
                <div class="top-two-contents-value__value">{{ this.getAIFCLocationG(this.$store.state.indMixing.selectedFCLocation).step2 | numFormat('0') }}</div>
                <div class="top-two-contents-value__unit">S<sup>-1</sup></div>
             </div>
              <div class="contents-value-underbar"></div>
              <div class="G-Value-contents">
                <div class="top-two-contents-value__G-text">현재G값</div>
                <div class="top-two-contents-value__G-Value">{{ this.getLocationG(this.$store.state.indMixing.selectedFCLocation).step3['1'] | numFormat('0') }}</div>
                <div class="top-two-contents-value__G-unit">S<sup>-1</sup></div>
              </div>            
              <div class="top-two-contents-value">
                <div class="top-two-contents-value__text">· #3</div>
                <div class="top-two-contents-value__value">{{ this.getAIFCLocationG(this.$store.state.indMixing.selectedFCLocation).step3 | numFormat('0') }}</div>
                <div class="top-two-contents-value__unit">S<sup>-1</sup></div>
              </div>
            </div>
            <div class="top-container__wrap">
    ...
    <div class="bottom-contents">
      ...
      <div class="bottom-chart-box">
        ...
        <div class="select-box">
          <div v-for="index in [1,2,3,4]" :key="index" class="select-box__element" @click="selectedLocation = index" :class="{ 'select-box__element--focused': selectedLocation === index}">{{ index }}지</div>
          </div>
        <div class="bottom-chart">
    ...
    <div v-if="this.$store.state.indMixing.isPopupVisible" class="popup">
      <div class="popup__inner">
        ...
        <div class="popup__body">
          ...
          <span v-if="this.$store.state.indMixing.latest.d_g_value_ctr_flag == 0" class="popup__body--large">자동모드로 변경하시겠습니까?</span>
          <span v-else-if="this.$store.state.indMixing.latest.d_g_value_ctr_flag == 1" class="popup__body--large">수동모드로 변경하시겠습니까? <br> 교반강도(G)값을 입력 후 ‘확인'버튼을 클릭해주세요.</span>
        </div>
...
import { PUT_MIXING_CONTROL_AI } from '@/store/modules/indMixing'
...
export default {
  ...
  computed: {
    ...
    ChartAGSpeed: function () {
      ...
      let now = new Date 
      // let now = new Date("2023-08-21 10:00:00") // FIXME 추후 삭제 
  ...
  methods: {
    /**
     * 선택된 지,열에 따른 교반강도 값 리턴 (latest)
     */
     getLatestGValueByJiAndStep: function(step){
      const ji = this.$store.state.indMixing.selectedFCLocation
      return this.$store.state.indMixing.latest['d_g_value_step'+ji+'_'+step]
    },
    /**
     * 선택된 지,열에 따른 교반강도 값 리턴 (latestModify)
     */
     getLatestModifyGValueByJiAndStep: function(step){
      const ji = this.$store.state.indMixing.selectedFCLocation
      return this.$store.state.indMixing.latestModify['d_g_value_step'+ji+'_'+step]
    },
    /**
     * 선택된 지,열에 따른 교반강도 변수 리턴
     */
    getGValueKeyByJiAndStep: function(step){
      const ji = this.$store.state.indMixing.selectedFCLocation
      return `d_g_value_step${ji}_${step}`
    },
    /**
     * 숫자 양의 정수 체크 함수
     * 
     ...
     */
     getAIFCLocationG: function(location) {
      return this.$store.state.indMixing.latest['ai_d_loc_fc_g' + location]
    },
    /**
     * 선택한 지의 현재 교반강도값 반환
     * 
     ...
     * @return 현재 속도
     */
    getLocationG: function(location) {
      return this.$store.state.indMixing.latest['d_loc_fc_g' + location]
    },
    ...
    updateControl: function() {      
      ...
      if (this.$store.state.indMixing.isModifyMode) {
        if (this.getLatestModifyGValueByJiAndStep(1) === ''
          || this.getLatestModifyGValueByJiAndStep(2) === ''
          || this.getLatestModifyGValueByJiAndStep(3) === '') {
          this.$store.dispatch('alertDialog/OPEN_DIALOG', { title: '경고', text1: '값을 입력해주세요' })
        } else if (parseFloat(this.getLatestModifyGValueByJiAndStep(1)) <= min 
                  || parseFloat(this.getLatestModifyGValueByJiAndStep(1)) >= max
                  || parseFloat(this.getLatestModifyGValueByJiAndStep(2)) <= min
                  || parseFloat(this.getLatestModifyGValueByJiAndStep(2)) >= max
                  || parseFloat(this.getLatestModifyGValueByJiAndStep(3)) <= min
                  || parseFloat(this.getLatestModifyGValueByJiAndStep(3)) >= max) {
          this.$store.dispatch('alertDialog/OPEN_DIALOG', { title: '경고', text1: '설정 범위', text2: min + ' ~ ' + max })
        } else {
          let obj = {}
          obj[this.getGValueKeyByJiAndStep(1)] = parseFloat(this.getLatestModifyGValueByJiAndStep(1))
          obj[this.getGValueKeyByJiAndStep(2)] = parseFloat(this.getLatestModifyGValueByJiAndStep(2))
          obj[this.getGValueKeyByJiAndStep(3)] = parseFloat(this.getLatestModifyGValueByJiAndStep(3))
          obj.d_g_value_ctr_flag = this.$store.state.indMixing.latest.d_g_value_ctr_flag
    ...
    openPopup: function(){
      this.$store.state.indMixing.isPopupVisible = !this.$store.state.indMixing.isPopupVisible
    },
    closePopup: function(){
      this.$store.state.indMixing.isPopupVisible = !this.$store.state.indMixing.isPopupVisible
    },
    changeGValue: function() {//d_g_value_ctr_flag 변경
      if(this.$store.state.indMixing.latest.d_g_value_ctr_flag == 0){
        //수동(0)->자동(1) 변경 요청 : ctr_flag 변경 및 Control API호출.
        this.$store.state.indMixing.latest.d_g_value_ctr_flag = 1;
        let obj = {}
        obj.d_g_value_ctr_flag = this.$store.state.indMixing.latest.d_g_value_ctr_flag
        this.$store.dispatch(PUT_MIXING_CONTROL_AI, obj)
        this.closePopup();
        ...
        this.$store.state.indMixing.latest.d_g_value_ctr_flag = 0;
        this.closePopup();
        this.$store.state.indMixing.isModifyMode = true;
        this.$nextTick(() => {
  ...
  .top-two-contents-container{
    ...
    .top-container{
      ...
      .contents-value-underbar {
        ...
        height: 6px;
        margin: 10px 0;
        background: url(../../assets/ss_images/g-value.png);
      }
      &__real-box {
        display: flex;
        align-items: center;
...
.ji-contents-wrap {
  width: 202px;
  height: 100%;
  background-image: url(../../assets/ss_images/ji_box.png);
  padding-top: 15px;
  margin-top: 12px;
  &__title {
    text-shadow: 0 0 9px #5cafff;
    ...
    text-align: center;
    color: #fff;
    background-image: url(../../assets/ss_images/ji_title.png);
