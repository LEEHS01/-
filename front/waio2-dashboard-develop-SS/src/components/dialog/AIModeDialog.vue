...
import { PUT_DISINFECTION_CONTROL_OPERATION_PERI } from '@/store/modules/disinfection'
import { PUT_DISINFECTION_CONTROL_OPERATION_POST } from '@/store/modules/disinfection'
import { PUT_INDDISINFECTION_CONTROL_OPERATION_PRE} from '@/store/modules/indDisinfection'
