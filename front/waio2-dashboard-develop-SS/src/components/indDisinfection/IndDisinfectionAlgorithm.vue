<template>
  <div class="main">
    ...
    <div class="top">
      <div class="title">공업소독<p> 세부 현황</p></div>
      <div class="right">
        <div class="right-contents">
          <div class="right-contents__text-first">AI 운전 모드<br>(공업)</div>
    ...
    <div class="contents">
      <div class="contents__left">
        <IndDisinfectionLeftContents/>
      </div>
      <div class="contents__right">
        <IndDisinfectionRightContents/>
      </div>
    </div>
  </div>  
</template>
<script>
import IndDisinfectionLeftContents from '@/components/indDisinfection/IndDisinfectionLeftContents' 
import IndDisinfectionRightContents from '@/components/indDisinfection/IndDisinfectionRightContents'
import { SET_OVERLAY } from '@/store'
import { GET_INDDISINFECTION_LATEST, PUT_DISINFECTION_HISTORY_EVAPORATION, PUT_DISINFECTION_HISTORY_CHOLRATE } from '@/store/modules/indDisinfection'
import { PUT_SEDIMENTATION_HISTORY_CL } from '@/store/modules/indSedimentation'
