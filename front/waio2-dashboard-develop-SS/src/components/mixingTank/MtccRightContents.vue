      ...
      <div class="top-contents-container">
        ...
        <div class="top-container">
          <div class="top-one-contents-box">
            ...
            <div class="ji-contents-wrap">
              ...
              <div class="top-one-contents-value">
                ...
                <input ref="gValueInputBox" v-if="this.$store.state.mixing.isModifyMode && this.$store.state.mixing.latest.d_g_value_ctr_flag == 0" type="text" class="top-one-contents-value__input" :value="getLatestModifyGValueByJiAndStep(1)" v-on:input="updateInput($event, getGValueKeyByJiAndStep(1))"/>
                <span class="top-one-contents-value__span" v-else>{{ this.$store.state.mixing.latest.d_g_value_ctr_flag == 0 ? getLatestGValueByJiAndStep(1) : this.$store.state.mixing.latest.ai_d_g_value1 | numFormat('0.0')}}</span>
                <div class="top-one-contents-value__unit">sec<sup>-1</sup></div>
              </div>
              <div class="top-one-contents-value">
                <div class="top-one-contents-value__text">#2</div>
                <input v-if="this.$store.state.mixing.isModifyMode && this.$store.state.mixing.latest.d_g_value_ctr_flag == 0" type="text" class="top-one-contents-value__input" :value="getLatestModifyGValueByJiAndStep(2)" v-on:input="updateInput($event, getGValueKeyByJiAndStep(2))"/>
                <span class="top-one-contents-value__span" v-else>{{ this.$store.state.mixing.latest.d_g_value_ctr_flag == 0 ? getLatestGValueByJiAndStep(2): this.$store.state.mixing.latest.ai_d_g_value2 | numFormat('0.0')}}</span>
                <div class="top-one-contents-value__unit">sec<sup>-1</sup></div>
              </div>
              <div class="top-one-contents-value">
                <div class="top-one-contents-value__text">#3</div>
                <input v-if="this.$store.state.mixing.isModifyMode && this.$store.state.mixing.latest.d_g_value_ctr_flag == 0" type="text" class="top-one-contents-value__input" :value="getLatestModifyGValueByJiAndStep(3)" v-on:input="updateInput($event, getGValueKeyByJiAndStep(3))"/>
                <span class="top-one-contents-value__span" v-else>{{ this.$store.state.mixing.latest.d_g_value_ctr_flag == 0 ? getLatestGValueByJiAndStep(3) : this.$store.state.mixing.latest.ai_d_g_value3 | numFormat('0.0') }}</span>
                <div class="top-one-contents-value__unit">sec<sup>-1</sup></div>
              </div>
          ...
          <div class="top-two-contents-box">
            ...
            <div class="top-two-contents-value">
              <div class="top-two-contents-value__text">· 점성 계수</div>
            ...
            <div class="top-two-contents-value">
              ...
              <div class="top-two-contents-value__unit"><span>NTU</span></div>
            </div>
            <div class="top-two-contents-value">
              <div class="top-two-contents-value__text">· 응집지 #{{ this.$store.state.mixing.selectedFCLocation }} 수온</div>
              <div class="top-two-contents-value__value">{{ LocTe | numFormat('0.00') }}</div>
              <div class="top-two-contents-value__unit">℃</div>
            </div>
        ...
        <div class="top-container">
          <div class="top-container__wrap">
            <div class="G-Value-contents">
              ...
              <div class="top-two-contents-value__G-Value">{{ this.getLocationG(this.$store.state.mixing.selectedFCLocation).step1['1'] | numFormat('0') }}</div>
              <div class="top-two-contents-value__G-unit">S<sup>-1</sup></div>
            </div>
            <div class="top-two-contents-value">
              <div class="top-two-contents-value__text">· #1</div>
              <div class="top-two-contents-value__value">{{ this.getAIFCLocationG(this.$store.state.mixing.selectedFCLocation).step1 | numFormat('0') }}</div>
              <div class="top-two-contents-value__unit">S<sup>-1</sup></div>
            </div>
            <div class="contents-value-underbar"></div>
            <div class="G-Value-contents">
              <div class="top-two-contents-value__G-text">현재G값</div>
              <div class="top-two-contents-value__G-Value">{{ this.getLocationG(this.$store.state.mixing.selectedFCLocation).step2['1'] | numFormat('0') }}</div>
              <div class="top-two-contents-value__G-unit">S<sup>-1</sup></div>
            </div>            
            <div class="top-two-contents-value">
              <div class="top-two-contents-value__text">· #2</div>
              <div class="top-two-contents-value__value">{{ this.getAIFCLocationG(this.$store.state.mixing.selectedFCLocation).step2 | numFormat('0') }}</div>
              <div class="top-two-contents-value__unit">S<sup>-1</sup></div>
            </div>
            <div class="contents-value-underbar"></div>
            <div class="G-Value-contents">
              <div class="top-two-contents-value__G-text">현재G값</div>
              <div class="top-two-contents-value__G-Value">{{ this.getLocationG(this.$store.state.mixing.selectedFCLocation).step3['1'] | numFormat('0') }}</div>
              <div class="top-two-contents-value__G-unit">S<sup>-1</sup></div>
            </div>            
            <div class="top-two-contents-value">
              <div class="top-two-contents-value__text">· #3</div>
              <div class="top-two-contents-value__value">{{ this.getAIFCLocationG(this.$store.state.mixing.selectedFCLocation).step3 | numFormat('0') }}</div>
              <div class="top-two-contents-value__unit">S<sup>-1</sup></div>
            </div>
          </div>
          <div class="top-container__wrap">
...
export default {
  ...
  computed: {
    ...
    ChartAGSpeed: function () {
      ...
      let now = new Date 
      // let now = new Date("2022-12-15 10:00:00")  // FIXME 추후 삭제 
    ...
    LocTe:function(){
      const ji = this.$store.state.mixing.selectedFCLocation
      return this.$store.state.mixing.latest['b_te_loc'+ji]
    }
  },
  ...
  methods: {
    ...
    getLatestGValueByJiAndStep: function(step){
      const ji = this.$store.state.mixing.selectedFCLocation
      return this.$store.state.mixing.latest['d_g_value_step'+ji+'_'+step]
    },
    /**
    ...
    getLatestModifyGValueByJiAndStep: function(step){
      const ji = this.$store.state.mixing.selectedFCLocation
      return this.$store.state.mixing.latestModify['d_g_value_step'+ji+'_'+step]
    },
    /**
