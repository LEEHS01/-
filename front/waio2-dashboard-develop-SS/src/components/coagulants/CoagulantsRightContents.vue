...
export default {
  ...
  methods: {
    ...
    //     let angle = this.theta * this.$store.state.coagulants.latest.ai_clst_id * -1
    //     if (angle === 0) {
    //       angle = -360
    //     }
    //     console.log('this.$store.state.coagulants.latest.ai_clst_id: ', this.$store.state.coagulants.latest.ai_clst_id, 'angle: ', angle)
