        ...
        <div class="popup-contents">
          ...
          <div class="contents">
            ...
            <div class="contents-value">
              ...
              <div class="contents-value__box">
                <div class="box-text width50" v-html="this.$getNumeralWithCommaAndFontFamily(this.$store.state.sedimentation.latest.b_in_fr)"></div>
...
export default {
  ...
  data: () => ({
    ...
    scDividedValue: 6.3, // 대차 위치 계산 상수
    // 슬러지 발생량 예측 차트
    chartDataSludge: {
      chart: {
        type: 'spline',
