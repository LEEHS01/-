  ...
  methods: {
    ...
    updateControl: function() {      
      ...
      if (this.$store.state.sedimentation.isModifyMode) {
        ...
        } else if (parseFloat(this.$store.state.sedimentation.latestModify.e_low_hour) < hour_min || parseFloat(this.$store.state.sedimentation.latestModify.e_low_hour) > hour_max) {
