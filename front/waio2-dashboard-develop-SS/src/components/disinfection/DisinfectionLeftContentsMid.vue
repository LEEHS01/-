<template>
  <div class="main">
    ...
    <div class="contents-img">
      ...
      <div :style="{display : this.getDisplayStylePump1}">
      ...
      <!-- 2호기 -->
      <div :style="{display : this.getDisplayStylePump2}">
    ...
    <div class="contents-wrap">
      ...
      <div class="contents-value-icon">
        <div class="custom-icon" @click="updateControl" v-if="$store.state.login.user.tkn !== null">
...
.contents-wrap {
  ...
  .contents-img{
    width: 584px;
    height: 527px;
    background-image: url('../../assets/ss_images/sub_02.png');
