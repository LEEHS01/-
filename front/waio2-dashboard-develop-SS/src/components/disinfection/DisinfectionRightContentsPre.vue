      ...
      <div class="two-contents">
        ...
        <div class="small-contents">
          ...
          <div class="small-contents-value">
            ...
            <div class="value">
              <div class="value__num">{{ this.$store.state.disinfection.latest.ai_g_evap | numFormat('0.00') }}</div>
...
export default {
  ...
  computed: {
    ChartOptionGEvap: function () {
      ...
      chart.series = []
      if (this.$store.state.disinfection.pre_evaporation !== null && Object.keys(this.$store.state.disinfection.pre_evaporation).length > 0) {
        let yesterdayData = []
        let todayData = []
        ...
        for (let key in this.$store.state.disinfection.pre_evaporation){
          let _timestamp = new Date(key).getTime()
          if(_timestamp < todayTimestamp) {
            yesterdayData.push([_timestamp + this.$getMilliSecondFromHour(24), this.$store.state.disinfection.pre_evaporation[key]])
          }else{
            todayData.push([_timestamp, this.$store.state.disinfection.pre_evaporation[key]])
          }
        }
        ...
        // let dataSeries1 = []
        // for (let key in this.$store.state.disinfection.pre_evaporation) {
        //   dataSeries1.push([new Date(key).getTime(), this.$store.state.disinfection.pre_evaporation[key]])
        // }
        // chart.series.push({
        //   name: '증발량',
        //   data: dataSeries1,
