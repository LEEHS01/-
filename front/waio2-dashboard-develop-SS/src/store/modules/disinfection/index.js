...
const URL = {
  ...
  DISINFECTION_CORRECT_DEGREE: 'disinfection/correct/degree',
...
export const PUT_DISINFECTION_CORRECT_DEGREE = URL.DISINFECTION_CORRECT_DEGREE + '/put'
...
const PUT_CORRECT_DEGREE = PUT_DISINFECTION_CORRECT_DEGREE.substr(PUT_DISINFECTION_CORRECT_DEGREE.indexOf('/') + 1)
...
export default {
  ...
  mutations: {
    ...
    [PUT_CORRECT_DEGREE]: function (state, data) {
      state.correctDegree = data
    },
    [PUT_CONTROL_PRE]: function (state, { g_pre_set_max, g_pre_set_min, g_pre_chg_limit_for_onetime, g_pre_calib_cycle, g_e_obj_residual_cl }){
    ...
    [PUT_CONTROL_PERI]: function (state, { g_peri_set_max, g_peri_set_min, g_peri_chg_limit_for_onetime, g_peri_calib_cycle, g_f_out_obj_residual_cl, g_f_out_residual_cl_holding }){
    ...
    [PUT_CONTROL_POST]: function (state, { g_post_set_max, g_post_set_min, g_post_chg_limit_for_onetime, g_post_calib_cycle, g_h_in_obj_residual_cl, g_post_calib_num, g_h_in_residual_cl_holding }) {
  ...
  actions: {
    ...
    [PUT_HISTORY_EVAPORATION]: async function ({ commit }) {
      ...
      let disinfectionStep = 1; // 증발량은 전차염만 계산
      // FIXME 현재 날짜 수정
    ...
    [PUT_HISTORY_CHOLRATE]: async function ({ state, commit }) {
      ...
      // await axios.put(`${DEV_SERVER}/${URL.DISINFECTION_HISTORY_CHOLRATE}/${PROCESS_STEP}/${state.disinfectionStep}`, { 'start_time': new Date('2023-8-21 00:00:00.000').toISOString(), 'end_time': new Date('2023-8-21 23:59:10.000').toISOString() })
        .then(({ data }) => {
    ...
    [PUT_CONTROL_PRE]: async function ({ commit }, { g_pre_set_max, g_pre_set_min, g_pre_chg_limit_for_onetime, g_pre_calib_cycle, g_e_obj_residual_cl}) { // eslint-disable-line no-unused-vars
      await axios.put(`${DEV_SERVER}/${URL.DISINFECTION_CONTROL_PRE}/${PROCESS_STEP}`, { g_pre_set_max, g_pre_set_min, g_pre_chg_limit_for_onetime, g_pre_calib_cycle, g_e_obj_residual_cl })
      .then(() => {
        let _data = {
          visible: true,
          title: '설정 성공',
        ...
        commit(PUT_CONTROL_PRE, { g_pre_set_max, g_pre_set_min, g_pre_chg_limit_for_onetime, g_pre_calib_cycle, g_e_obj_residual_cl})
        commit('alertDialog/OPEN_DIALOG', _data, { root: true })
      })
      .catch(error => {
        util.printError(error)
    ...
    [PUT_CONTROL_PERI]: async function ({ commit }, { g_peri_set_max, g_peri_set_min, g_peri_chg_limit_for_onetime, g_peri_calib_cycle, g_f_out_obj_residual_cl, g_f_out_residual_cl_holding }) { // eslint-disable-line no-unused-vars
      await axios.put(`${DEV_SERVER}/${URL.DISINFECTION_CONTROL_RERI}/${PROCESS_STEP}`, { g_peri_set_max, g_peri_set_min, g_peri_chg_limit_for_onetime, g_peri_calib_cycle, g_f_out_obj_residual_cl, g_f_out_residual_cl_holding })
      .then(() => {
        let _data = {
          visible: true,
          title: '설정 성공',
        ...
        commit(PUT_CONTROL_PERI,  { g_peri_set_max, g_peri_set_min, g_peri_chg_limit_for_onetime, g_peri_calib_cycle, g_f_out_obj_residual_cl, g_f_out_residual_cl_holding })
        commit('alertDialog/OPEN_DIALOG', _data, { root: true })
      })
      .catch(error => {
        util.printError(error)
    ...
    [PUT_CONTROL_POST]: async function ({ commit }, { g_post_set_max, g_post_set_min, g_post_chg_limit_for_onetime, g_post_calib_cycle, g_h_in_obj_residual_cl, g_post_calib_num, g_h_in_residual_cl_holding }) { // eslint-disable-line no-unused-vars
      await axios.put(`${DEV_SERVER}/${URL.DISINFECTION_CONTROL_POST}/${PROCESS_STEP}`, { g_post_set_max, g_post_set_min, g_post_chg_limit_for_onetime, g_post_calib_cycle, g_h_in_obj_residual_cl, g_post_calib_num, g_h_in_residual_cl_holding })
      .then(() => {
        let _data = {
          visible: true,
          title: '설정 성공',
        ...
        commit(PUT_CONTROL_POST, { g_post_set_max, g_post_set_min, g_post_chg_limit_for_onetime, g_post_calib_cycle, g_h_in_obj_residual_cl, g_post_calib_num, g_h_in_residual_cl_holding })
        commit('alertDialog/OPEN_DIALOG', _data, { root: true })
      })
      .catch(error => {
        util.printError(error)
    ...
    [PUT_CORRECT_DEGREE]: async function ({ commit }){
      //FIXME 현재 날짜 수정
      let nowTimestamp = Date.now();
      let oneDayTimestamp = 1000 * 60 * 60 * 24
      await axios.put(`${DEV_SERVER}/${URL.DISINFECTION_CORRECT_DEGREE}/${PROCESS_STEP}`, { 'start_time': new Date(nowTimestamp - oneDayTimestamp).toISOString(), 'end_time': new Date(nowTimestamp).toISOString() })
      // await axios.put(`${DEV_SERVER}/${URL.DISINFECTION_CORRECT_DEGREE}/${PROCESS_STEP}`, { 'start_time': new Date('2012-12-17 00:00:00.000').toISOString(), 'end_time': new Date('2012-12-18 00:00:00.000').toISOString() })
      .then(({ data }) => {
        commit(PUT_CORRECT_DEGREE, data.correctDegree)
      })
      .catch(error => {
        util.printError(error)
      })
