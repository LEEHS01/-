...
export const PUT_DISINFECTION_HISTORY_CHOLRATE = 'indDisinfection/history/cholrate' + '/put'
export const PUT_INDDISINFECTION_CONTROL_OPERATION_PRE = 'indDisinfection/control/operation/pre' + '/put'
export const PUT_DISINFECTION_CONTROL_OPERATION_PERI = 'indDisinfection/control/operation/peri' + '/put'
export const PUT_DISINFECTION_CONTROL_OPERATION_POST = 'indDisinfection/control/operation/post' + '/put'
export const PUT_DISINFECTION_CONTROL_PRE = 'indDisinfection/control/pre' + '/put'
export const PUT_DISINFECTION_CONTROL_PERI = 'indDisinfection/control/peri' + '/put'
export const PUT_DISINFECTION_CONTROL_POST = 'indDisinfection/control/post' + '/put'
...
export default {
  ...
  mutations: {
    ...
    [PUT_CONTROL_PRE]: function (state, { g_pre_set_max, g_pre_set_min, g_pre_chg_limit_for_onetime, g_pre_calib_cycle, g_e_obj_residual_cl, g_e_residual_cl_holding}) {
  ...
  actions: {
    ...
    [PUT_HISTORY_EVAPORATION]: async function ({state, commit }) {
      ...
      // await axios.put(`${DEV_SERVER}/${URL.DISINFECTION_HISTORY_EVAPORATION}/${PROCESS_STEP}/${state.disinfectionStep}`, { 'start_time': new Date(2023, 7, 21, 23, 0, 0).toISOString(), 'end_time': new Date(2023, 7, 22, 23, 0, 0).toISOString() })
        .then(({ data }) => {
    ...
    [PUT_CONTROL_PRE]: async function ({ commit }, { g_pre_set_max, g_pre_set_min, g_pre_chg_limit_for_onetime, g_pre_calib_cycle, g_e_obj_residual_cl, g_e_residual_cl_holding}) { // eslint-disable-line no-unused-vars
      await axios.put(`${DEV_SERVER}/${URL.DISINFECTION_CONTROL_PRE}/${PROCESS_STEP}`, { g_pre_set_max, g_pre_set_min, g_pre_chg_limit_for_onetime, g_pre_calib_cycle, g_e_obj_residual_cl, g_e_residual_cl_holding})
      .then(() => {
        let _data = {
          visible: true,
          title: '설정 성공',
        ...
        commit(PUT_CONTROL_PRE, { g_pre_set_max, g_pre_set_min, g_pre_chg_limit_for_onetime, g_pre_calib_cycle, g_e_obj_residual_cl, g_e_residual_cl_holding})
        commit('alertDialog/OPEN_DIALOG', _data, { root: true })
      })
      .catch(error => {
        util.printError(error)
    ...
    [PUT_CONTROL_PERI]: async function ({ commit }, { g_peri1_set_max, g_peri1_set_min, g_peri1_chg_limit_for_onetime, d1_target_cl, e1_target_cl, g_peri2_set_max, g_peri2_set_min, g_peri2_chg_limit_for_onetime, d2_target_cl, e2_target_cl }) { // eslint-disable-line no-unused-vars
      await axios.put(`${DEV_SERVER}/${URL.DISINFECTION_CONTROL_RERI}/${PROCESS_STEP}`, { g_peri1_set_max, g_peri1_set_min, g_peri1_chg_limit_for_onetime, d1_target_cl, e1_target_cl, g_peri2_set_max, g_peri2_set_min, g_peri2_chg_limit_for_onetime, d2_target_cl, e2_target_cl })
      .then(() => {
        let _data = {
          visible: true,
          title: '설정 성공',
    ...
    [PUT_CONTROL_POST]: async function ({ commit }, { g_post_set_max, g_post_set_min, g_post_chg_limit_for_onetime, g_ser_trg_cl }) { // eslint-disable-line no-unused-vars
      await axios.put(`${DEV_SERVER}/${URL.DISINFECTION_CONTROL_POST}/${PROCESS_STEP}`, { g_post_set_max, g_post_set_min, g_post_chg_limit_for_onetime, g_ser_trg_cl })
      .then(() => {
        let _data = {
          visible: true,
          title: '설정 성공',
