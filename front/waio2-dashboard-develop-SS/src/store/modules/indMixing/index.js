...
export const PUT_MIXING_CONTROL_AI = 'indMixing/control/ai' + '/put'
...
export default {
  ...
  state: {
    ...
    latest: {
      ...
      d_rq: null,
      d_pn: null,
      d_g_value_step1_1: null,
      d_g_value_step1_2: null,
      d_g_value_step1_3: null,
      d_g_value_step2_1: null,
      d_g_value_step2_2: null,
      d_g_value_step2_3: null,
      d_g_value_step3_1: null,
      d_g_value_step3_2: null,
      d_g_value_step3_3: null,
      d_g_value_step4_1: null,
      d_g_value_step4_2: null,
      d_g_value_step4_3: null,
  ...
  mutations: {
    ...
    [PUT_CONTROL_AI]: function(state, obj) {
      const ji = state.selectedFCLocation; //선택한 지
      state.latest['d_g_value_step'+ji+'_1'] = obj['d_g_value_step'+ji+'_1']
      state.latest['d_g_value_step'+ji+'_2'] = obj['d_g_value_step'+ji+'_2']
      state.latest['d_g_value_step'+ji+'_3'] = obj['d_g_value_step'+ji+'_3']
  ...
  actions: {
    ...
    [PUT_HISTORY_FC_SP]: async function ({ commit }) {
      ...
      // nowTimestamp = Date.parse("2023-08-21 10:00:00"); // FIXME 추후 삭제
    ...
    [PUT_CONTROL_AI]: async function ({ commit, state }, obj) {
      const ji = state.selectedFCLocation;//선택한 지
      await axios.put(`${DEV_SERVER}/${URL.MIXING_CONTROL_AI}/` + PROCESS_STEP + "/" + ji, obj)
      .then(() => {
