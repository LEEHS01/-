...
export default {
  ...
  getters: {
    ...
    isOpenInBalValve1: function (state) {
      if (state.latest.e_drawing_vv1_1 === 1 || state.latest.e_drawing_vv1_2 === 1 || state.latest.e_drawing_vv1_3 === 1 || state.latest.e_drawing_vv1_4 === 1 || state.latest.e_drawing_vv1_5 === 1 || state.latest.e_drawing_vv1_6 === 1 ) {
        return true
      } else {
        return false
      }
    ...
    isOpenInBalValve2: function (state) {
      if (state.latest.e_drawing_vv2_1 === 1 || state.latest.e_drawing_vv2_2 === 1 || state.latest.e_drawing_vv2_3 === 1 || state.latest.e_drawing_vv2_4 === 1 || state.latest.e_drawing_vv2_5 === 1 || state.latest.e_drawing_vv2_6 === 1) {
        return true
      } else {
        return false
      }
    ...
    isOpenInBalValve3: function (state) {
      if (state.latest.e_drawing_vv3_1 === 1 || state.latest.e_drawing_vv3_2 === 1 || state.latest.e_drawing_vv3_3 === 1 || state.latest.e_drawing_vv3_4 === 1 || state.latest.e_drawing_vv3_5 === 1 || state.latest.e_drawing_vv3_6 === 1) {
        return true
      } else {
        return false
      }
    ...
    isOpenInBalValve4: function (state) {
      if (state.latest.e_drawing_vv4_1 === 1 || state.latest.e_drawing_vv4_2 === 1 || state.latest.e_drawing_vv4_3 === 1 || state.latest.e_drawing_vv4_4 === 1 || state.latest.e_drawing_vv4_5 === 1 || state.latest.e_drawing_vv4_6 === 1) {
        return true
      } else {
        return false
      }
  ...
  actions: {
    ...
    [PUT_HISTORY_TB]: async function ({ commit }) {
      // TODO 추후 현재시간으로 수정
      let nowTimestamp = Date.now()
      // let nowTimestamp = Date.parse("2022-12-01 13:00:00")
      let oneDayTimestamp = 1000 * 60 * 60 * 24
