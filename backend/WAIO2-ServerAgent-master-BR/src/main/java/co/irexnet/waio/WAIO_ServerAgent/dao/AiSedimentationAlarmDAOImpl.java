...
public class AiSedimentationAlarmDAOImpl implements IAiProcessAlarmDAO
{
    ...
    {
        String strQuery = "SELECT * FROM TB_AI_E_ALM WHERE alm_ti>=? AND kfk_flg=? ORDER BY alm_ti ASC";
    ...
    {
        String strQuery = "UPDATE TB_AI_E_ALM SET kfk_flg=? WHERE alm_id=? AND alm_ti=?";
