...
public class EmsController
{
    ...
    private Object parseValue(String itm, String tagVal) {
    	if (itm != null && tagVal != null) {
    		try {
    			if (itm.startsWith("h1_pm") || itm.startsWith("h2_pm") 
    				|| itm.startsWith("h3_pm") || itm.startsWith("h4_pm")
    				|| itm.startsWith("h5_pm") || itm.startsWith("h6_pm")
    				|| itm.startsWith("ai_h1_pm") || itm.startsWith("ai_h2_pm")
    				|| itm.startsWith("ai_h3_pm") || itm.startsWith("ai_h4_pm")
    				|| itm.startsWith("ai_h5_pm") || itm.startsWith("ai_h6_pm")) {
    				return Float.parseFloat(tagVal);
    			} else if (itm.startsWith("h1_pm_sp") || itm.startsWith("h2_pm_sp")
    						|| itm.startsWith("h3_pm_sp") || itm.startsWith("h4_pm_sp")
    						|| itm.startsWith("h5_pm_sp") || itm.startsWith("h6_pm_sp")
    						|| itm.startsWith("ai_h1_pm_sp") || itm.startsWith("ai_h2_pm_sp")
    						|| itm.startsWith("ai_h3_pm_sp") || itm.startsWith("ai_h4_pm_sp")
    						|| itm.startsWith("ai_h5_pm_sp") || itm.startsWith("ai_h6_pm_sp")) {
    				return Float.parseFloat(tagVal);
    						...
    						|| itm.equalsIgnoreCase("h5_operation_mode") || itm.equalsIgnoreCase("h6_operation_mode")) {
    				return Float.parseFloat(tagVal);
    			}
