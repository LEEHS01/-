...
public interface IAiDisinfectionProcessAlarmDAO {
    ...
    List<AiProcessAlarmDTO> select(Date alarm_time, int kafka_flag, int disinfectionStep);
    int updateKafkaFlag(int alarm_id, Date alarm_time, int kafka_flag, int disinfectionStep);
