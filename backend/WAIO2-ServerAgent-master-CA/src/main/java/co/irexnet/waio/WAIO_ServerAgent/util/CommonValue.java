...
public class CommonValue
{
    ...
    // Alarm ID
    // 금강북부는 시스템 모니터링 없으므로 모듈 에러 주석 처리
    public static int ALARM_RECEIVING_AI_CONTROL_2IND   			= 131101;
    public static int ALARM_RECEIVING_AI_CONTROL_2LIV   			= 131201;
    public static int ALARM_RECEIVING_AI_CONTROL_3      			= 131301;
//    public static int ALARM_RECEIVING_AI_MODULE_ERROR_2IND   		= 131100;
//    public static int ALARM_RECEIVING_AI_MODULE_ERROR_2LIV   		= 131100;
//    public static int ALARM_RECEIVING_AI_MODULE_ERROR_3   			= 131100;
    public static int ALARM_COAGULANT_AI_CONTROL_2IND        		= 132101;
    public static int ALARM_COAGULANT_AI_CONTROL_2LIV        		= 132201;
    public static int ALARM_COAGULANT_AI_CONTROL_3        			= 132301;
//    public static int ALARM_COAGULANT_AI_MODULE_ERROR_2IND   		= 132100;
//    public static int ALARM_COAGULANT_AI_MODULE_ERROR_2LIV   		= 132100;
//    public static int ALARM_COAGULANT_AI_MODULE_ERROR_3   			= 132100;
    public static int ALARM_MIXING_AI_CONTROL_2IND           		= 133101;
    public static int ALARM_MIXING_AI_CONTROL_2LIV           		= 133201;
    public static int ALARM_MIXING_AI_CONTROL_3           			= 133301;
//    public static int ALARM_MIXING_AI_MODULE_ERROR_2IND      		= 133100;
//    public static int ALARM_MIXING_AI_MODULE_ERROR_2LIV     		= 133100;
//    public static int ALARM_MIXING_AI_MODULE_ERROR_3      			= 133100;
    public static int ALARM_SEDIMENTATION_AI_CONTROL_2IND    		= 134101;
    public static int ALARM_SEDIMENTATION_AI_CONTROL_2LIV   		= 134201;
    public static int ALARM_SEDIMENTATION_AI_CONTROL_3    			= 134301;
//    public static int ALARM_SEDIMENTATION_AI_MODULE_ERROR_2IND 		= 134100;
//    public static int ALARM_SEDIMENTATION_AI_MODULE_ERROR_2LIV 		= 134100;
//    public static int ALARM_SEDIMENTATION_AI_MODULE_ERROR_3 		= 134100;
    public static int ALARM_FILTER_AI_CONTROL_2LIV           		= 135201;
    public static int ALARM_FILTER_AI_CONTROL_3           			= 135301;
//    public static int ALARM_FILTER_AI_MODULE_ERROR_2LIV      		= 135100;
//    public static int ALARM_FILTER_AI_MODULE_ERROR_3      			= 135100;
//    public static int ALARM_GAC_AI_CONTROL              = 136000;
//    public static int ALARM_GAC_AI_MODULE_ERROR         = 136100;
    public static int ALARM_DISINFECTION_AI_CONTROL_2IND_PRE     	= 137101;
    public static int ALARM_DISINFECTION_AI_CONTROL_2LIV_PRE     	= 137211;
    public static int ALARM_DISINFECTION_AI_CONTROL_2LIV_PERI     	= 137221;
    public static int ALARM_DISINFECTION_AI_CONTROL_2LIV_POST     	= 137231;
    public static int ALARM_DISINFECTION_AI_CONTROL_3_PRE     		= 137311;
    public static int ALARM_DISINFECTION_AI_CONTROL_3_PERI     		= 137321;
    public static int ALARM_DISINFECTION_AI_CONTROL_3_POST     		= 137331;
//    public static int ALARM_DISINFECTION_AI_MODULE_ERROR_2IND 	= 137100;
//    public static int ALARM_DISINFECTION_AI_MODULE_ERROR_2LIV 	= 137100;
//    public static int ALARM_DISINFECTION_AI_MODULE_ERROR_3 		= 137100;
...
//    public static int ALARM_OZONE_AI_MODULE_ERROR       = 138100;
    ...
    public static final String ALARM_CODE_CONNECTION_ERROR = "connection_error"; // 통신연결 이상
    ...
    public static final String DISINFECTION_PERI = "PERI";
    public static final String DISINFECTION_POST = "POST";

    // Filter State
//    public static int FILTER_STATE_NONE                 = 0;
//    public static int FILTER_STATE_FILTER               = 1;	// 여과중
//    public static int FILTER_STATE_RELAX                = 2;	// 휴지중
//    public static int FILTER_STATE_BW                   = 3;	// 역세중
//    public static int FILTER_STATE_BW_RELAX             = 4;	// 역세 후 휴지중
//    public static int FILTER_STATE_CIRCULATION          = 5;	// 순환중
//    public static int FILTER_STATE_CIRCULATION_RELAX    = 6;	// 순환 후 휴지중
//    public static int FILTER_STATE_CIRCULATION_STANDBY  = 7;	// 순환 후 대기중
    ...
    public static int[] DISINFECTION_STEP_ARRAY = {1, 2, 3};
    public static int[] PROCESS_STEP_ARRAY_FILTER = {2, 3};
    public static int[] PROCESS_STEP_ARRAY_RECEIVING = {1, 2, 3, 4};
