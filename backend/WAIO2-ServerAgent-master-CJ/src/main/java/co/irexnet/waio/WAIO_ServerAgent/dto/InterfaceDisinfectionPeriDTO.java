...
{
    private float g_peri_set_max;                  // 중염소 1계열 주입률 최대값
    private float g_peri_set_min;                  // 중염소 1계열 주입률 최소값
    private float g_peri_chg_limit_for_onetime;    // 중염소 1계열 1회 변경 한계치
    ...
    private int g_peri_calib_cycle;                 // 중차염 보정주기
    private float g_f_out_obj_residual_cl;          // 여과지 유출 목표 잔류염소
    private float g_f_out_residual_cl_holding; 		// 여과지 유출 잔류염소 홀딩 범위
