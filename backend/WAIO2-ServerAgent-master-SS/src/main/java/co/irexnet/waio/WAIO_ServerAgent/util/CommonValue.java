...
//    public static int FILTER_STATE_ETC					= 8;	// 예외상황
    ...
    public static int[] PROCESS_STEP_ARRAY = {1, 2};
    public static int[] PROCESS_STEP_ARRAY_FILTER = {1};
    
    // 소독 전차염 단계
    public static final int DISINFECTION_PRE_STEP = 1;
    // 소독 중차염 단계
    public static final int DISINFECTION_PERI_STEP = 2;
    // 소독 후차염 단계
    public static final int DISINFECTION_POST_STEP = 3;
