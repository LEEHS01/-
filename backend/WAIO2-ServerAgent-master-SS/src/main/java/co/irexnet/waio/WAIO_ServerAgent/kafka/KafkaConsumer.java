...
//                );
                    ...
                    if(tagManage.getAi_cd().equalsIgnoreCase(CommonValue.PROCESS_RECEIVING) == true && CommonValue.B_OPERATION_MODE.equalsIgnoreCase(tagManage.getItm()) == true) {
                        if(tagManage.getTag_sn().equalsIgnoreCase(realtime.getTag_sn()) == true &&
                            ...
                            nReceivingUpdateCount +=
                                    databaseService.modAiReceivingInit(tagManage.getItm(), Float.parseFloat(realtime.getTag_val()), tagManage.getProcessStep());
                        }
                        ...
                        if(tagManage.getTag_sn().equalsIgnoreCase(realtime.getTag_sn()) == true &&
                            ...
                            nCoagulantUpdateCount +=
                                    databaseService.modAiCoagulantInit(tagManage.getItm(), Float.parseFloat(realtime.getTag_val()), tagManage.getProcessStep());
                        }
                        ...
                        if(tagManage.getTag_sn().equalsIgnoreCase(realtime.getTag_sn()) == true &&
                                Conversion.isNumber(realtime.getTag_val()) == true) {
                            nMixingUpdateCount +=
                                    databaseService.modAiMixingInit(tagManage.getItm(), Float.parseFloat(realtime.getTag_val()), tagManage.getProcessStep());
                        }
                        ...
                        if(tagManage.getTag_sn().equalsIgnoreCase(realtime.getTag_sn()) == true &&
                            ...
                            nSedimentationUpdateCount +=
                                    databaseService.modAiSedimentationInit(tagManage.getItm(), Float.parseFloat(realtime.getTag_val()), tagManage.getProcessStep());
                        }
                        ...
                        if(tagManage.getTag_sn().equalsIgnoreCase(realtime.getTag_sn()) == true &&
                                Conversion.isNumber(realtime.getTag_val()) == true) {
                            nFilterUpdateCount +=
                                    databaseService.modAiFilterInit(tagManage.getItm(), Float.parseFloat(realtime.getTag_val()), tagManage.getProcessStep());
                        }
                    }
                        ...
                        if(tagManage.getTag_sn().equalsIgnoreCase(realtime.getTag_sn()) == true &&
                        		...
                        		if(CommonValue.G_PRE_OPERATION_MODE.equalsIgnoreCase(tagManage.getItm())== true) {
                        			nDisinfectionUpdateCount +=
                        				databaseService.modAiDisinfectionInit(tagManage.getItm(), Float.parseFloat(realtime.getTag_val()), tagManage.getProcessStep(), CommonValue.DISINFECTION_PRE_STEP); // 전차염                        			
                        		}
                        		if(tagManage.getProcessStep() == 1) {
                            		if(CommonValue.G_PERI_OPERATION_MODE.equalsIgnoreCase(tagManage.getItm())== true) {
	                                	nDisinfectionUpdateCount +=
	                                		databaseService.modAiDisinfectionInit(tagManage.getItm(), Float.parseFloat(realtime.getTag_val()), tagManage.getProcessStep(), CommonValue.DISINFECTION_PERI_STEP); // 중차염
                            		}else if(CommonValue.G_POST_OPERATION_MODE.equalsIgnoreCase(tagManage.getItm())== true) {
	                                	nDisinfectionUpdateCount +=
	                                		databaseService.modAiDisinfectionInit(tagManage.getItm(), Float.parseFloat(realtime.getTag_val()), tagManage.getProcessStep(), CommonValue.DISINFECTION_POST_STEP); // 후차염                            	                                
                            		}
                            	}
                            }
                        }
    ...
    private void loadTagData(List<ProcessRealtimeDTO> kafkaRealtimeValue, List<TagManageDTO> tagManageList)
    {
        ...
        for(ProcessRealtimeDTO realtime: kafkaRealtimeValue)
        {
            // log.debug("[KTTEST_kafkaRealtimeValue] " + realtime.toString());
